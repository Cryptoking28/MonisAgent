...
* Assign all attributes on internal spans to segment ([#3000](https://github.com/Cryptoking28/monisagent/pull/3000)) ([5403018](https://github.com/Cryptoking28/monisagent/commit/54030185ba5630099b76182a52c629276af4d93e))

#### Bug fixes

* Fixed `tracer.transactionNestProxy` to create a new transaction if there is no transaction or transaction is not active ([#3007](https://github.com/Cryptoking28/monisagent/pull/3007)) ([ced9e22](https://github.com/Cryptoking28/monisagent/commit/ced9e22a23ddeed860c1fd88f0afb10bb94343cb))

#### Documentation

* Updated compatibility report ([#2993](https://github.com/Cryptoking28/monisagent/pull/2993)) ([cdfa042](https://github.com/Cryptoking28/monisagent/commit/cdfa042325a7636e84a7b19a34874b20915dac63))

#### Tests

* Fixed handling require esm for >20.19.0+ ([#3002](https://github.com/Cryptoking28/monisagent/pull/3002)) ([b808e00](https://github.com/Cryptoking28/monisagent/commit/b808e00c399d3c924eeeb19f9c6b9fba4695a720))

### v12.16.0 (2025-03-17)

#### Features

* Added support for response streaming Lambda functions ([#2981](https://github.com/Cryptoking28/monisagent/pull/2981)) ([61dbbf9](https://github.com/Cryptoking28/monisagent/commit/61dbbf9b4a6cf69f5378387fc9c17c31671e9da4))
* Added AWS entity linking segment attributes for otel bridge ([#2978](https://github.com/Cryptoking28/monisagent/pull/2978)) ([6bf1ccc](https://github.com/Cryptoking28/monisagent/commit/6bf1ccc657a955b4064a7a3a473bf24948d4ff56))
* Added error handling on transactions for otel spans ([#2985](https://github.com/Cryptoking28/monisagent/pull/2985)) ([4e61e09](https://github.com/Cryptoking28/monisagent/commit/4e61e0935394744345c39f6b581ee86e66d0f82c))

#### Code refactoring

* Updated span event generation to assign the appropriate `span.kind` based on the segment name ([#2976](https://github.com/Cryptoking28/monisagent/pull/2976)) ([697b17e](https://github.com/Cryptoking28/monisagent/commit/697b17e0553111aa494d08bc33eb7043cdfa8ca6))

#### Documentation

* Updated compatibility report ([#2988](https://github.com/Cryptoking28/monisagent/pull/2988)) ([ed17a6d](https://github.com/Cryptoking28/monisagent/commit/ed17a6df1152a8e54cb8c8570fec0015990a4247)

#### Miscellaneous chores

* Clarified supported next.js middleware versions in docs ([#2984](https://github.com/Cryptoking28/monisagent/pull/2984)) ([15cb454](https://github.com/Cryptoking28/monisagent/commit/15cb454f9cc38ccc22089d62aaeea54713159aa7))
* Clarified system metrics sampler naming ([#2987](https://github.com/Cryptoking28/monisagent/pull/2987)) ([8647d43](https://github.com/Cryptoking28/monisagent/commit/8647d43f097d6d3d68a372824d9feb325604be96))
* Refactored loops to be simpler ([#2990](https://github.com/Cryptoking28/monisagent/pull/2990)) ([79fb8e9](https://github.com/Cryptoking28/monisagent/commit/79fb8e90802954b617c1c00aecc866aa065aee12))
* Removed unused transaction method ([#2986](https://github.com/Cryptoking28/monisagent/pull/2986)) ([cb4e2f7](https://github.com/Cryptoking28/monisagent/commit/cb4e2f7a8b84adb6d744a2083b083c92e306fbd5))
* Reverted restriction in NestJS versioned tests ([#2979](https://github.com/Cryptoking28/monisagent/pull/2979)) ([ffddcab](https://github.com/Cryptoking28/monisagent/commit/ffddcab6d77bfc10c0df9cbfa724bc1c8f5fb251))

#### Tests

* Fixed fastify assertions around span kind while running security agent ([#2983](https://github.com/Cryptoking28/monisagent/pull/2983)) ([c641645](https://github.com/Cryptoking28/monisagent/commit/c6416451f1fa6126b7dfd59f6b9267f9d2188ad0))

### v12.15.0 (2025-03-03)

#### Features

* Allowed undici error reporting to be disabled with feature flag `undici_error_tracking` ([#2956](https://github.com/Cryptoking28/monisagent/pull/2956)) ([6278107](https://github.com/Cryptoking28/monisagent/commit/6278107727678c8b45769190c6972c33057067e5))
     * Thanks for your contribution @Voziv :tada:
* Added ability to propagate traceparent and tracestate on incoming server/consumer spans and outgoing client http and producer spans ([#2958](https://github.com/Cryptoking28/monisagent/pull/2958)) ([258ad7d](https://github.com/Cryptoking28/monisagent/commit/258ad7de7751df59cf6d68334e342f751bb3a934))
* Added server span transaction naming fallback to the url.path ([#2966](https://github.com/Cryptoking28/monisagent/pull/2966)) ([770bf6f](https://github.com/Cryptoking28/monisagent/commit/770bf6fd6ce26642e3fe08b2c1557dd826270516))
* Updated Context class to ensure bi-directional context propagation with opentelemetry bridge ([#2962](https://github.com/Cryptoking28/monisagent/pull/2962)) ([dfeec5a](https://github.com/Cryptoking28/monisagent/commit/dfeec5a0443723e7f799db4b9ea7bf4aed5b3bcc))

#### Code refactoring

* Separated context classes for agent in standard and opentelemetry bridge mode ([#2967](https://github.com/Cryptoking28/monisagent/pull/2967)) ([d11c071](https://github.com/Cryptoking28/monisagent/commit/d11c071be2504ef442e5aa19fed769ca7a20ceb5))

#### Documentation

* Updated compatibility report ([#2973](https://github.com/Cryptoking28/monisagent/pull/2973)) ([7106c81](https://github.com/Cryptoking28/monisagent/commit/7106c818b7add3220d256646cd816dee64efb80a))

#### Miscellaneous chores

* Added consumer attribute reconciliation ([#2957](https://github.com/Cryptoking28/monisagent/pull/2957)) ([8943672](https://github.com/Cryptoking28/monisagent/commit/894367239e5e8050da0a38347b81d7186cac0a1f))
* Added http external span attributes ([#2955](https://github.com/Cryptoking28/monisagent/pull/2955)) ([ef697a5](https://github.com/Cryptoking28/monisagent/commit/ef697a505ee23f5c2fb2bbe306e90561e66d75c1))
* Limit nestjs to enable successful CI ([#2972](https://github.com/Cryptoking28/monisagent/pull/2972)) ([e9699cf](https://github.com/Cryptoking28/monisagent/commit/e9699cf31ff758ff79f44c470bc5f11630117f1c))
* Refactored otel attribute reconciling ([#2964](https://github.com/Cryptoking28/monisagent/pull/2964)) ([1b5ed2c](https://github.com/Cryptoking28/monisagent/commit/1b5ed2c2f7c78cb413603124757b9b1c3412ab0a))

### v12.14.0 (2025-02-18)

#### Features

* Added support for region-prefixed Bedrock models ([#2947](https://github.com/Cryptoking28/monisagent/pull/2947)) ([6acf535](https://github.com/Cryptoking28/monisagent/commit/6acf5354d1e7f6786da88c0078699e82a714551d))
* Added attribute reconciliation for message producer spans ([#2942](https://github.com/Cryptoking28/monisagent/pull/2942)) ([a9ba396](https://github.com/Cryptoking28/monisagent/commit/a9ba39613c78b89c047ca35a218c2eedbb01e3d2))
* Added timeslice metrics for synthesized consumer segments ([#2938](https://github.com/Cryptoking28/monisagent/pull/2938)) ([acfe953](https://github.com/Cryptoking28/monisagent/commit/acfe953cf7a656fafb69104384c72f94ddc13000))

#### Bug fixes

* Fixed queueing of logs from child loggers ([#2945](https://github.com/Cryptoking28/monisagent/pull/2945)) ([888cfe8](https://github.com/Cryptoking28/monisagent/commit/888cfe84a1ffaf0287682cc9099a2fa762f7a37f))
* Fixed undici/fetch instrumentation to properly assign the parent-id portion of the `traceparent` header on outgoing requests to the active http external span id ([#2951](https://github.com/Cryptoking28/monisagent/pull/2951)) ([bc714cf](https://github.com/Cryptoking28/monisagent/commit/bc714cfa8fe6754abf25eb556b8f804c9982f986))
* Updated `api.recordLogEvent` to no longer truncate the message key in log event ([#2949](https://github.com/Cryptoking28/monisagent/pull/2949)) ([8dd557b](https://github.com/Cryptoking28/monisagent/commit/8dd557b4dfca2505b7e9f7f030ab094a6ae8019a))
    * Thanks for your contribution @rChaoz 🎉 

#### Documentation

* Updated compatibility report ([#2948](https://github.com/Cryptoking28/monisagent/pull/2948)) ([8e32ed7](https://github.com/Cryptoking28/monisagent/commit/8e32ed7d7bc456a0693485e7bdef955c25ead29a))

### v12.13.0 (2025-02-12)

#### Features

* Added timeslice metrics for synthesized server segments ([#2924](https://github.com/Cryptoking28/monisagent/pull/2924)) ([f404585](https://github.com/Cryptoking28/monisagent/commit/f4045855a1cdbfb74e3217daf8bfa125aa6fe2e4))
* Added timeslice metrics for synthesized producer segments ([#2939](https://github.com/Cryptoking28/monisagent/pull/2939)) ([6832637](https://github.com/Cryptoking28/monisagent/commit/68326377dcd23b574abae7c323ff93bc05c525ed))
* Added timeslice metrics for synthesized database segments ([#2922](https://github.com/Cryptoking28/monisagent/pull/2922)) ([8606f78](https://github.com/Cryptoking28/monisagent/commit/8606f789772b7651d0c46ad50dad3a1da74e5e9c))
* Propagate agent root context when opentelemetry `ROOT_CONTEXT` is passed in to trace propagator.([#2940](https://github.com/Cryptoking28/monisagent/pull/2940)) ([b85111c](https://github.com/Cryptoking28/monisagent/commit/b85111c46797dfbf399faf973e7a3e0ea6bbdc28)) 
  * Added logic to handle properly naming and ending transactions for server spans. 
* Provided ability to disable instrumentation for core Node.js libraries ([#2927](https://github.com/Cryptoking28/monisagent/pull/2927)) ([2d232f1](https://github.com/Cryptoking28/monisagent/commit/2d232f16c167e5f84b7b7898a6c5410d9cece55e))

#### Bug fixes

* Fixed `api.getTraceMetadata` to handle when there is an active transaction but not active segment ([#2944](https://github.com/Cryptoking28/monisagent/pull/2944)) ([6db3b4d](https://github.com/Cryptoking28/monisagent/commit/6db3b4d53a077a9738dd72d46e1ba1cee0d6af3f))

#### Documentation

* Updated compatibility report ([#2920](https://github.com/Cryptoking28/monisagent/pull/2920)) ([c7ae8be](https://github.com/Cryptoking28/monisagent/commit/c7ae8befafa4c91fab6804cd95e20f5a93546ea4))

#### Miscellaneous chores

* Localized OTEL attribute constants ([#2928](https://github.com/Cryptoking28/monisagent/pull/2928)) ([965c41b](https://github.com/Cryptoking28/monisagent/commit/965c41b3e64805ac14ae4dd36120b018ec5899f4))
* Updated import-in-the-middle version ([#2923](https://github.com/Cryptoking28/monisagent/pull/2923)) ([aa2781f](https://github.com/Cryptoking28/monisagent/commit/aa2781fd9c7bed08d590e33682729a92f21f43a5))

### v12.12.0 (2025-02-05)

#### Features

* Added health check support for upcoming feature ([#2841](https://github.com/Cryptoking28/monisagent/pull/2841)) ([4c8bf13](https://github.com/Cryptoking28/monisagent/commit/4c8bf13f124ea09fac750d7368c78a4c9cdc760e))
* Added opentelemetry bridge instrumentation that adds a context manager, and processor to handle synthesizing segments and time slice metrics. ([#2906](https://github.com/Cryptoking28/monisagent/pull/2906)) ([d2e8a9e](https://github.com/Cryptoking28/monisagent/commit/d2e8a9e369d91494fdcbc14f06916a88e4801ae1))

#### Bug fixes

* Updated default config to accept `undefined` as default value ([#2917](https://github.com/Cryptoking28/monisagent/pull/2917)) ([e049442](https://github.com/Cryptoking28/monisagent/commit/e04944207956fd02ea161ab8c46ea96761160bd0))

#### Documentation

* Updated compatibility report ([#2914](https://github.com/Cryptoking28/monisagent/pull/2914)) ([acd0c90](https://github.com/Cryptoking28/monisagent/commit/acd0c904adb9a69928ed1a6513a67bb297dba8ee))

#### Miscellaneous chores

* Added regex note to sql obfuscator ([#2911](https://github.com/Cryptoking28/monisagent/pull/2911)) ([1533111](https://github.com/Cryptoking28/monisagent/commit/1533111e416c50b0c61ad086d3d86ae30f70532a))
* **deps:** Updated @monisagent/security-agent to v2.3.0 ([#2918](https://github.com/Cryptoking28/monisagent/pull/2918)) ([ed89f38](https://github.com/Cryptoking28/monisagent/commit/ed89f387efe2c5c3175250684bf4987ed29d7747))

#### Continuous integration

* Optimized the lambda layers and k8s init containers post release workflow ([#2915](https://github.com/Cryptoking28/monisagent/pull/2915)) ([4be1099](https://github.com/Cryptoking28/monisagent/commit/4be10997d9059daeb626cf6ba9ebf954fb1fe500))

### v12.11.3 (2025-01-29)

#### Bug fixes

* Fixed issue with `bluebird` and `when` instrumentation where checking active context crashed when transaction prematurely ends ([#2909](https://github.com/Cryptoking28/monisagent/pull/2909)) ([4a30d5c](https://github.com/Cryptoking28/monisagent/commit/4a30d5c5082e963cca3664f2ed152017f6360d21))
* Fixed transaction-shim to properly create new transactions when the existing transaction is not active ([#2912](https://github.com/Cryptoking28/monisagent/pull/2912)) ([3ad8c59](https://github.com/Cryptoking28/monisagent/commit/3ad8c59e15e037a366ddf6803729b61ecfa701f3))

#### Documentation

* Updated compatibility report ([#2902](https://github.com/Cryptoking28/monisagent/pull/2902)) ([cb16516](https://github.com/Cryptoking28/monisagent/commit/cb16516e90a3dc2cefb98e6131a7243412aefbfc))

#### Miscellaneous chores

* Updated lint rule suppression comment ([#2895](https://github.com/Cryptoking28/monisagent/pull/2895)) ([559dc98](https://github.com/Cryptoking28/monisagent/commit/559dc98e18c8ba8280b73779780f3efc1c946ed7))

#### Continuous integration

* Move init container release from lambda to GHA ([#2848](https://github.com/Cryptoking28/monisagent/pull/2848)) ([8d8608d](https://github.com/Cryptoking28/monisagent/commit/8d8608d1089cafaeb8c17354034c96fe1b49597a))

### v12.11.2 (2025-01-23)

#### Features

* Added support for Claude 3+ Chat API in Bedrock ([#2870](https://github.com/Cryptoking28/monisagent/pull/2870)) ([6a83abf](https://github.com/Cryptoking28/monisagent/commit/6a83abf8b1a0cb0f993e9d9285566a09677d7d2e))

#### Bug fixes

* Added defensive code in shim to prevent crashing when checking parent segment ([#2898](https://github.com/Cryptoking28/monisagent/pull/2898)) ([751eb96](https://github.com/Cryptoking28/monisagent/commit/751eb9608d7401d1123a0e810eac9dc554127e4e))

#### Documentation

* Updated compatibility report ([#2888](https://github.com/Cryptoking28/monisagent/pull/2888)) ([dce9deb](https://github.com/Cryptoking28/monisagent/commit/dce9debeda6c5ed30c0ed6dbc00f73cf11c8f40f))

#### Miscellaneous chores

* Replaced backtracking regex with new algorithm ([#2887](https://github.com/Cryptoking28/monisagent/pull/2887)) ([46462d0](https://github.com/Cryptoking28/monisagent/commit/46462d00b68c4a4cedd60d46d531b2f31800df98))

#### Tests

* Improved test coverage of normalizing claude 3 messages ([#2893](https://github.com/Cryptoking28/monisagent/pull/2893)) ([cc65763](https://github.com/Cryptoking28/monisagent/commit/cc657633b81daf4b372e5715e696ed3c23ecb678))
...
* Removed transaction from segment. Introduced a new `enterSegment` and `enterTransaction` to make context propagation more clear ([#2646](https://github.com/Cryptoking28/monisagent/pull/2646)) ([d84531a](https://github.com/Cryptoking28/monisagent/commit/d84531a9035387b997cb2b3c6bc7895e232f87e2))
* Removed children from segments. ([#2689](https://github.com/Cryptoking28/monisagent/pull/2689)) ([66f140f](https://github.com/Cryptoking28/monisagent/commit/66f140f36b0cf5ed1028a4cbda672bc603573ae7))
* Added segment tree to transaction trace ([#2717](https://github.com/Cryptoking28/monisagent/pull/2717)) ([8fcc239](https://github.com/Cryptoking28/monisagent/commit/8fcc239b37d7ece569de0bd19406e4d62904bcd3))
* Added segment synthesizer and provided ability to convert http client otel spans to external http trace segments ([#2745](https://github.com/Cryptoking28/monisagent/pull/2745)) ([c42f8e6](https://github.com/Cryptoking28/monisagent/commit/c42f8e646acaf50d5878a891f7b062ea46094091))
* Added otel consumer span processing ([#2854](https://github.com/Cryptoking28/monisagent/pull/2854)) ([82fe9d5](https://github.com/Cryptoking28/monisagent/commit/82fe9d5017d042234472c5d05c2c9c05d8a45091))
* Added segment and transaction synthesis for http server spans ([#2833](https://github.com/Cryptoking28/monisagent/pull/2833)) ([8fa4d05](https://github.com/Cryptoking28/monisagent/commit/8fa4d055b27a0494d7021bc3a284f4c4752a3cee)) 
* Added segment synthesis for db client otel spans to db trace ([#2820](https://github.com/Cryptoking28/monisagent/pull/2820)) ([1ad1858](https://github.com/Cryptoking28/monisagent/commit/1ad1858dcec71fa13065c2c80000055e206cb53a))
* Added segment synthesis for internal spans ([#2840](https://github.com/Cryptoking28/monisagent/pull/2840)) ([436c63d](https://github.com/Cryptoking28/monisagent/commit/436c63d0447bce6ddae77eaf032a4ddb65c7e07f))
* Added segment synthesis for otel producer spans ([#2839](https://github.com/Cryptoking28/monisagent/pull/2839)) ([30f4995](https://github.com/Cryptoking28/monisagent/commit/30f49955aa60fe4ef87c1bc82fe7faec3d756ccd)) 

#### Bug fixes

* Updated `shim.createSegment` and `shim.handleMqTracingHeaders` to be backwards compatible with the changes to context manager ([#2844](https://github.com/Cryptoking28/monisagent/pull/2844)) ([554b4bf](https://github.com/Cryptoking28/monisagent/commit/554b4bf0ae77dfa1e5a324f17622bc1c49b5f4f7))

#### Code refactoring

* Removed class construction on the segment synthesis and instrumentation ([#2837](https://github.com/Cryptoking28/monisagent/pull/2837)) ([4b7ec0f](https://github.com/Cryptoking28/monisagent/commit/4b7ec0f669cd936e86816bc24768727ba5067c88))

#### Documentation

* Updated compatibility report ([#2869](https://github.com/Cryptoking28/monisagent/pull/2869)) ([4bde427](https://github.com/Cryptoking28/monisagent/commit/4bde427f67aa1e1699e7ab12c4f96e83f70850a6))

#### Miscellaneous chores

* Added rules engine to match OTEL spans ([#2694](https://github.com/Cryptoking28/monisagent/pull/2694)) ([2c93c68](https://github.com/Cryptoking28/monisagent/commit/2c93c68b8563a07c450b8bd84d442c5ac18df3d8))
* Updated rules engine to account for fallbacks ([#2831](https://github.com/Cryptoking28/monisagent/pull/2831)) ([19fbdfb](https://github.com/Cryptoking28/monisagent/commit/19fbdfb4ec71fc5f6041d4ac8435d69a5f88ae9a))
* Updated versioned tests docs ([#2874](https://github.com/Cryptoking28/monisagent/pull/2874)) ([73a84d7](https://github.com/Cryptoking28/monisagent/commit/73a84d76be655a8cca88a47de177f1dfa4faa6e7))

#### Tests

* Updated a langchain test to be less rigid on asserting the tracking metric by `@langchain/core` version ([#2876](https://github.com/Cryptoking28/monisagent/pull/2876)) ([73985ea](https://github.com/Cryptoking28/monisagent/commit/73985ea45634478133a0ac6437b16758cfd775b2))

### v12.10.0 (2025-01-09)

#### Features

* Added instrumentation for `@opensearch-projects/opensearch` v2.1.0+ ([#2850](https://github.com/Cryptoking28/monisagent/pull/2850)) ([763c0e6](https://github.com/Cryptoking28/monisagent/commit/763c0e6ad50f15677b5f535999f93f122c84b583))

#### Bug fixes

* Fixed event matcher to use properties specific to web requests (v1/ALB and v2) ([#2863](https://github.com/Cryptoking28/monisagent/pull/2863)) ([a93fe6e](https://github.com/Cryptoking28/monisagent/commit/a93fe6e68e5b8047cc7c3bca8b9f50a0a7ffddd6))

#### Miscellaneous chores

* Fixed mysql2 tests for new mysql2 version ([#2853](https://github.com/Cryptoking28/monisagent/pull/2853)) ([30a6de0](https://github.com/Cryptoking28/monisagent/commit/30a6de00d22b92332009d7127bf52fbd10310214))
* Updated eslint configuration ([#2851](https://github.com/Cryptoking28/monisagent/pull/2851)) ([d2fba9d](https://github.com/Cryptoking28/monisagent/commit/d2fba9da8b9ba28d94e50c24fa494a35c442f0a5))
* Utilize updated @monisagent/eslint-config ([#2865](https://github.com/Cryptoking28/monisagent/pull/2865)) ([f53d4fc](https://github.com/Cryptoking28/monisagent/commit/f53d4fc8d911a998759cae90a9cd0bf09ff17828))

#### Tests

* Removed `t.diagnostic` from tests ([#2858](https://github.com/Cryptoking28/monisagent/pull/2858)) ([23ca237](https://github.com/Cryptoking28/monisagent/commit/23ca237731d4fd94b13d03eab9feb645aabe36d0))

#### Continuous integration

* Updated codecov-action to latest released version sha ([#2866](https://github.com/Cryptoking28/monisagent/pull/2866)) ([75f8902](https://github.com/Cryptoking28/monisagent/commit/75f8902e2dd9e1946666db6b1cf8617a5360d757))

### v12.9.0 (2024-12-18)

#### Features

* Added entity linking attributes to aws-sdk v3 Lambda segments ([#2845](https://github.com/Cryptoking28/monisagent/pull/2845)) ([8820265](https://github.com/Cryptoking28/monisagent/commit/882026502dbc12b700b893485458176bcd03f68e))
* Provided ability to define monisagent config as `monisagent.mjs` ([#2836](https://github.com/Cryptoking28/monisagent/pull/2836)) ([972b59d](https://github.com/Cryptoking28/monisagent/commit/972b59d4c4bd5f212d5fd695ce1007802354b7a0))

#### Documentation

* Updated compatibility report ([#2828](https://github.com/Cryptoking28/monisagent/pull/2828)) ([d5fe8e3](https://github.com/Cryptoking28/monisagent/commit/d5fe8e323c34464e8cc10be3f5c968a96357b6f6))

#### Miscellaneous chores

* **deps:** Updated @monisagent/security-agent to v2.2.0 ([#2842](https://github.com/Cryptoking28/monisagent/pull/2842)) ([170941e](https://github.com/Cryptoking28/monisagent/commit/170941e2f16d7e84edabfff40fd31906612b393e))
* Updated borp configs to target tests correctly ([#2835](https://github.com/Cryptoking28/monisagent/pull/2835)) ([66ae59d](https://github.com/Cryptoking28/monisagent/commit/66ae59d1e047dead092b3fa681017e3d42ce9474))

#### Tests

* Removed `tap` and cleaned up left over tap helpers ([#2804](https://github.com/Cryptoking28/monisagent/pull/2804)) ([37407b6](https://github.com/Cryptoking28/monisagent/commit/37407b6d14c2bd6a1c577cce811277753eb8069e))
* Updated `match` to fail if you pass in an object that lacks the expected keys ([#2843](https://github.com/Cryptoking28/monisagent/pull/2843)) ([a3db8bd](https://github.com/Cryptoking28/monisagent/commit/a3db8bd993d82a3c1c8873f9e552ba5fdf7cb5f4))

### v12.8.2 (2024-12-09)

#### Bug fixes

* Fixed `mysql2` promise instrumentation to properly handle `createPool` and `createPoolCluster` ([#2823](https://github.com/Cryptoking28/monisagent/pull/2823)) ([a679872](https://github.com/Cryptoking28/monisagent/commit/a6798723b7d282d56a01f7ad9f7c8deb70ca525d))
* Fixed matching for Lambda events containing resource but which aren't API Gateway ([#2825](https://github.com/Cryptoking28/monisagent/pull/2825)) ([64d2042](https://github.com/Cryptoking28/monisagent/commit/64d2042e673aae9ea65ecca3b6d122d0a303ad0f))

#### Documentation

* Updated compatibility report ([#2814](https://github.com/Cryptoking28/monisagent/pull/2814)) ([580a27f](https://github.com/Cryptoking28/monisagent/commit/580a27fb7bda92b55748a0dc54baf07dd91aecb6))

#### Miscellaneous chores

* Improved documentation for `assertSegments` ([#2819](https://github.com/Cryptoking28/monisagent/pull/2819)) ([298473c](https://github.com/Cryptoking28/monisagent/commit/298473ca4a3c3219dba9d007bbcb0287ca60e264))

#### Tests

* Added `test/custom-assertions.js` to the apollo-server external versioned tests config ([#2817](https://github.com/Cryptoking28/monisagent/pull/2817)) ([568525a](https://github.com/Cryptoking28/monisagent/commit/568525ae174f02365b9868a1fe3c7fb0dac3977f))
* Fixed flakey `when` versioned test ([#2821](https://github.com/Cryptoking28/monisagent/pull/2821)) ([54f034b](https://github.com/Cryptoking28/monisagent/commit/54f034bbf6918420874f10ed87656dcd0171317e))

### v12.8.1 (2024-12-04)

#### Bug fixes

* Fixed matching for ALB and API Gateway (v1 & v2) events for Lambda ([#2780](https://github.com/Cryptoking28/monisagent/pull/2780)) ([2f1a6c6](https://github.com/Cryptoking28/monisagent/commit/2f1a6c6dc6e4408c62b074d71a95b67cc0926785))
* Updated `mysql2` instrumentation to work with 3.11.5+ ([#2811](https://github.com/Cryptoking28/monisagent/pull/2811)) ([3ec4fee](https://github.com/Cryptoking28/monisagent/commit/3ec4fee486c6f609426deddb7cee8372e4dc1192))

#### Documentation

* Fixed changelog to group the labels in logs work ([#2776](https://github.com/Cryptoking28/monisagent/pull/2776)) ([04271da](https://github.com/Cryptoking28/monisagent/commit/04271dae2306f54d885aa723eebc3041edee2575))
* Fixed links to next.js apps ([#2812](https://github.com/Cryptoking28/monisagent/pull/2812)) ([834440c](https://github.com/Cryptoking28/monisagent/commit/834440caee017fe632b354d20112c3016587064b))
* Updated compatibility report ([#2809](https://github.com/Cryptoking28/monisagent/pull/2809)) ([fc1fbda](https://github.com/Cryptoking28/monisagent/commit/fc1fbdaf69c82caf4d7933c7fdd4eec395648e63))

#### Tests

* Migrated `test/integration/api` tests to `node:test` ([#2787](https://github.com/Cryptoking28/monisagent/pull/2787)) ([03b01a3](https://github.com/Cryptoking28/monisagent/commit/03b01a3bf40c8902c29c772aee4d70af8020ae62))
* Migrated `test/integration/core` tests to `node:test` ([#2781](https://github.com/Cryptoking28/monisagent/pull/2781)) ([36bc0e7](https://github.com/Cryptoking28/monisagent/commit/36bc0e7f97f1bbde522031942ec0cc7c1d4c1349))
* Migrated `test/integration/instrumentation` tests to `node:test` ([#2784](https://github.com/Cryptoking28/monisagent/pull/2784)) ([963fb30](https://github.com/Cryptoking28/monisagent/commit/963fb30087e1b9a7bf12c4ae71b8252a872e90e5))
* Migrated `test/integration/transaction` tests to `node:test` ([#2783](https://github.com/Cryptoking28/monisagent/pull/2783)) ([68e1a0c](https://github.com/Cryptoking28/monisagent/commit/68e1a0c8c529702fafb29a7684f6982b0d3c48cb))
* Migrated `test/integration/utilization` tests to node `node:test` ([#2794](https://github.com/Cryptoking28/monisagent/pull/2794)) ([db237e9](https://github.com/Cryptoking28/monisagent/commit/db237e9b8811554472b4f83100b3266ce52dc38b))
* Migrated `test/smoke/api` tests to `node:test` ([#2772](https://github.com/Cryptoking28/monisagent/pull/2772)) ([af3bbcd](https://github.com/Cryptoking28/monisagent/commit/af3bbcddd1e9ed28fdea32b2837bf509737181cc))
* Migrated CAT integration tests to `node:test` ([#2778](https://github.com/Cryptoking28/monisagent/pull/2778)) ([bd9df5f](https://github.com/Cryptoking28/monisagent/commit/bd9df5f0def633391762a191c16886735cddf9d2))
* Migrated integration tests at root to `node:test` ([#2803](https://github.com/Cryptoking28/monisagent/pull/2803)) ([a7ef080](https://github.com/Cryptoking28/monisagent/commit/a7ef080296b79d5fb8d313aa2bd9d474904e0a22))
* Migrated root smoke tests to `node:test` ([#2771](https://github.com/Cryptoking28/monisagent/pull/2771)) ([78f2709](https://github.com/Cryptoking28/monisagent/commit/78f2709a24328225f0c3c2392cf0a3b8072a877f))
* Migrated smoke tests in `test/smoke/agent`, `test/smoke/e2e`, and `test/smoke/index` to `node:test` ([#2774](https://github.com/Cryptoking28/monisagent/pull/2774)) ([440a0af](https://github.com/Cryptoking28/monisagent/commit/440a0af5545c0585d1bb5036b950f201444566db))
* Removed `t.diagnostic` as they are better suited as code comments ([#2786](https://github.com/Cryptoking28/monisagent/pull/2786)) ([ee24027](https://github.com/Cryptoking28/monisagent/commit/ee24027539aa2a6b5c8ab4c49529ff7f4fb8f269))
* Fixed flaky test on macOS ([#2790](https://github.com/Cryptoking28/monisagent/pull/2790)) ([eebf06b](https://github.com/Cryptoking28/monisagent/commit/eebf06b16c86cd40402c8d5566e01ca140802b24))
* Removed reference to `pino` internals ([#2805](https://github.com/Cryptoking28/monisagent/pull/2805)) ([0382ee2](https://github.com/Cryptoking28/monisagent/commit/0382ee26342546467f2f3b93be1c82d74e9d0123))
* Restricted `mysql2` version to get CI working ([#2808](https://github.com/Cryptoking28/monisagent/pull/2808)) ([ad60ed4](https://github.com/Cryptoking28/monisagent/commit/ad60ed4faf69d7c7938d63f335186323327e350f))
* Updated agent integration tests to `node:test` ([#2782](https://github.com/Cryptoking28/monisagent/pull/2782)) ([d556512](https://github.com/Cryptoking28/monisagent/commit/d556512ffebe3f38887aae65706dc5f1da4122d8))
* Updated config integration tests to `node:test` ([#2777](https://github.com/Cryptoking28/monisagent/pull/2777)) ([fe8d2df](https://github.com/Cryptoking28/monisagent/commit/fe8d2df36ccc7d818bbc7350985034767ca221b5))
* Updated distributed-tracing integration tests to `node:test` ([#2798](https://github.com/Cryptoking28/monisagent/pull/2798)) ([83ad1f3](https://github.com/Cryptoking28/monisagent/commit/83ad1f3e72f06211993b5dcbc2a5af4a27b259fe))
* Updated `grpc` integration tests to `node:test` ([#2789](https://github.com/Cryptoking28/monisagent/pull/2789)) ([ea8f743](https://github.com/Cryptoking28/monisagent/commit/ea8f743c7ef0d8bad0aa25f77b239ea18da59368))
* Updated index, issue-2155, and metric integration tests to `node:test` ([#2801](https://github.com/Cryptoking28/monisagent/pull/2801)) ([80b55c2](https://github.com/Cryptoking28/monisagent/commit/80b55c211aa9712ba79e39b236257583d4ccffd3))
* Updated `q`, `superagent`, and `when` tests to `node:test` ([#2773](https://github.com/Cryptoking28/monisagent/pull/2773)) ([ff2d8d0](https://github.com/Cryptoking28/monisagent/commit/ff2d8d02df8f602adbed3e361763ed406b891d21))
* Updated shimmer, uninstrumented, environment, flatten, and logger integration tests to `node:test` ([#2802](https://github.com/Cryptoking28/monisagent/pull/2802)) ([83fd7ee](https://github.com/Cryptoking28/monisagent/commit/83fd7ee912f5548b651bfa4c1ad7d7cbbc304092))
* Added per test file timing to test reporter ([#2785](https://github.com/Cryptoking28/monisagent/pull/2785)) ([00d9940](https://github.com/Cryptoking28/monisagent/commit/00d994086a228a096aaabb1f7f8af1f2f5ffc954))

### v12.8.0 (2024-11-19)

#### Features

* Added new configuration options to add custom tags (labels) to logs ([#2743](https://github.com/Cryptoking28/monisagent/pull/2743)) ([d20c874](https://github.com/Cryptoking28/monisagent/commit/d20c874638ebb19f8888003d4402bce17e56360f))
    ...
    * To enable set `config.application_logging.forwarding.labels.enabled` to `true` or the environment variable `NEW_RELIC_APPLICATION_LOGGING_FORWARDING_LABELS_ENABLED` to `true` ([#2727](https://github.com/Cryptoking28/monisagent/pull/2727)) ([36adb13](https://github.com/Cryptoking28/monisagent/commit/36adb13caad41a5df5a5fa9345b9dcb9061db969))
...
* Added support for Bedrock Claude 3.5 invoke model user request ([#2721](https://github.com/Cryptoking28/monisagent/pull/2721)) ([a901a24](https://github.com/Cryptoking28/monisagent/commit/a901a2499e73e0f1142054ead53e7b99df94b201))
* Moved `entity.guid`, `entity.name`, `entity.type`, and `hostname` to `common.attributes` on logs payload instead of in every log message ([#2736](https://github.com/Cryptoking28/monisagent/pull/2736)) ([a7f14de](https://github.com/Cryptoking28/monisagent/commit/a7f14def489000ab7492b01155069b1a084eeb36))

#### Bug fixes

* Corrected expected shape of user input in get Prompt() ([#2741](https://github.com/Cryptoking28/monisagent/pull/2741)) ([a8eef8b](https://github.com/Cryptoking28/monisagent/commit/a8eef8b0f80ec2b0db5834a722a69f58a32b5676))

#### Documentation

* Updated compatibility report ([#2755](https://github.com/Cryptoking28/monisagent/pull/2755)) ([459a3f1](https://github.com/Cryptoking28/monisagent/commit/459a3f19ee080a3a2e560636ce087f9e91bc529e))

#### Miscellaneous chores

* Fixed test reporter ([#2751](https://github.com/Cryptoking28/monisagent/pull/2751)) ([5878ef9](https://github.com/Cryptoking28/monisagent/commit/5878ef9844fd56038d08e3b2f8cd9e26ba8c4c92))
* Improved unit test speed ([#2728](https://github.com/Cryptoking28/monisagent/pull/2728)) ([9640030](https://github.com/Cryptoking28/monisagent/commit/96400304e451502ce2f09b569b46eaff271fd9ab))

#### Tests

* Fixed two assertions to work against older versions of `openai` ([#2726](https://github.com/Cryptoking28/monisagent/pull/2726)) ([8996fc3](https://github.com/Cryptoking28/monisagent/commit/8996fc3538735d7ad2d447bc7c4221b08c6c2be5))
* Migrated `ioredis`, `prisma` and `undici` versioned tests to `node:test` ([#2746](https://github.com/Cryptoking28/monisagent/pull/2746)) ([449ae03](https://github.com/Cryptoking28/monisagent/commit/449ae03883d2a5e92d11590372993eedc976ab99))
* Migrated `memcached`, `nestjs`, and `restify` versioned tests to `node:test` ([#2752](https://github.com/Cryptoking28/monisagent/pull/2752)) ([653f614](https://github.com/Cryptoking28/monisagent/commit/653f61410a0258683ac104cd8b8b2e7ae7c61043))
* Migrated `nextjs` versioned tests to `node:test` ([#2749](https://github.com/Cryptoking28/monisagent/pull/2749)) ([d385af6](https://github.com/Cryptoking28/monisagent/commit/d385af69c84a5425cee9ff19eaeadcba9e63a761))
* Migrated `redis` versioned tests to `node:test` ([#2725](https://github.com/Cryptoking28/monisagent/pull/2725)) ([9752827](https://github.com/Cryptoking28/monisagent/commit/97528270c70ecaac9161f4eb0cc78ffcc482be36))
* Updated `hapi` tests to `node:test` ([#2722](https://github.com/Cryptoking28/monisagent/pull/2722)) ([636899b](https://github.com/Cryptoking28/monisagent/commit/636899b487e196572a3bc0970e7338d0c9f113cf))
* Updated `kafkajs`, `langchain`, & `openai` tests to `node:test` ([#2723](https://github.com/Cryptoking28/monisagent/pull/2723)) ([b6e4c5d](https://github.com/Cryptoking28/monisagent/commit/b6e4c5d4c59032a615fea6d12623a881a6211917))
* Updated `koa` tests to `node:test` ([#2744](https://github.com/Cryptoking28/monisagent/pull/2744)) ([86c22a4](https://github.com/Cryptoking28/monisagent/commit/86c22a4813ec5a63ae8bd04f7d9d013979ac34ed))
* Updated `mongodb` tests to `node:test` ([#2738](https://github.com/Cryptoking28/monisagent/pull/2738)) ([295e7e6](https://github.com/Cryptoking28/monisagent/commit/295e7e6441b7220022ce4fcaaf33054945a678b0))
* Updated `pg` and `pg-esm` tests to `node:test` ([#2750](https://github.com/Cryptoking28/monisagent/pull/2750)) ([40aea36](https://github.com/Cryptoking28/monisagent/commit/40aea36320d15b201800431268be2c3d4c794a7b))

### v12.7.0 (2024-11-11)

#### Features

* Added `cloud.resource_id` attribute to dynamo spans ([#2701](https://github.com/Cryptoking28/monisagent/pull/2701)) ([904f41b](https://github.com/Cryptoking28/monisagent/commit/904f41b26637394a24aa13f31ff94b100ae6d090))
* Enhance Proxy Request Handling to Display Actual External URLs ([#2698](https://github.com/Cryptoking28/monisagent/pull/2698)) ([3ef7bbe](https://github.com/Cryptoking28/monisagent/commit/3ef7bbe595860234c021a02235e6fd0615da5f69))
    * Thanks for the contribution @mstarzec386

#### Documentation

* Updated compatibility report ([#2712](https://github.com/Cryptoking28/monisagent/pull/2712)) ([82f0e98](https://github.com/Cryptoking28/monisagent/commit/82f0e9806c88d14cba2e0cdf47593e036107bd7d)) ([#2699](https://github.com/Cryptoking28/monisagent/pull/2699)) ([4432c42](https://github.com/Cryptoking28/monisagent/commit/4432c4215d68cc79333ee3828f1ecd55476c63d8))

#### Miscellaneous chores

* Added a benchmark script for our sql parser ([#2708](https://github.com/Cryptoking28/monisagent/pull/2708)) ([9b6de68](https://github.com/Cryptoking28/monisagent/commit/9b6de6852747230b87a9873faffba6e5b39669f3))
* Updated express-esm, generic-pool, grpc, & grpc-esm tests to node:test ([#2702](https://github.com/Cryptoking28/monisagent/pull/2702)) ([a229bbf](https://github.com/Cryptoking28/monisagent/commit/a229bbf0dd92c43fb2da077d8dce831b84c0c972))

#### Tests

* Migrated `mysql` and `mysql2` versioned tests to `node:test` ([#2711](https://github.com/Cryptoking28/monisagent/pull/2711)) ([fc767e0](https://github.com/Cryptoking28/monisagent/commit/fc767e08d8b546d14c53c07bc2cfe65f3fb55368))

### v12.6.1 (2024-11-07)

#### Features

* added `cloud.aws.account_id` to default config ([#2691](https://github.com/Cryptoking28/monisagent/pull/2691)) ([0ccee8e](https://github.com/Cryptoking28/monisagent/commit/0ccee8e471b5568a36a5ef755f83f0da513548c8))

#### Bug fixes

* Fixed issue parsing docker container id ([#2705](https://github.com/Cryptoking28/monisagent/pull/2705)) ([0c897ab](https://github.com/Cryptoking28/monisagent/commit/0c897ab7bea32daf0afbf75e2349f2fad008cc92))

#### Documentation

* Updated compatibility report ([#2679](https://github.com/Cryptoking28/monisagent/pull/2679)) ([3c19cdf](https://github.com/Cryptoking28/monisagent/commit/3c19cdfed751dfa20ebba471a6cdd320f0610d95))

#### Miscellaneous chores

* Moved recorders to `lib/metrics/recorders` ([#2666](https://github.com/Cryptoking28/monisagent/pull/2666)) ([d8dfe84](https://github.com/Cryptoking28/monisagent/commit/d8dfe843aebf275bda6d5c857cfe263039bc1a83))

#### Tests

* Fixed file extensions for aws-sdk v2 and v3 versioned tests to reflect they have been migrated to `node:test` ([#2687](https://github.com/Cryptoking28/monisagent/pull/2687)) ([4ec09ba](https://github.com/Cryptoking28/monisagent/commit/4ec09ba34a825fa9decdc2d854eec6d24ee37ac4))
* Migrated elasticsearch and esm-package versioned tests to `node:test` ([#2680](https://github.com/Cryptoking28/monisagent/pull/2680)) ([0e0c2b2](https://github.com/Cryptoking28/monisagent/commit/0e0c2b2f15e2179def4e67741fc988b7d16248d7))
* Updated cls and connect tests to node:test ([#2676](https://github.com/Cryptoking28/monisagent/pull/2676)) ([1e74434](https://github.com/Cryptoking28/monisagent/commit/1e74434efd21c13199ad12af837129d251136c76))
* Reorganized custom assertions and improved test reporter ([#2700](https://github.com/Cryptoking28/monisagent/pull/2700)) ([9e98b18](https://github.com/Cryptoking28/monisagent/commit/9e98b18b0f2768df9f75348975bebe904418a4a2))
* Updated cassandra-driver tests to node:test ([#2678](https://github.com/Cryptoking28/monisagent/pull/2678)) ([bd4f7ff](https://github.com/Cryptoking28/monisagent/commit/bd4f7ff9df2cd1057e21a6ba3e28aac9fe02ecc6))

### v12.6.0 (2024-10-30)

#### Features

* Added ARN and provider to Lambda segments ([#2674](https://github.com/Cryptoking28/monisagent/pull/2674)) ([a23294c](https://github.com/Cryptoking28/monisagent/commit/a23294c2d2cc665de5df1a0f3c9099dedbfbb896))
* Added IAST configurations for scan scheduling and restrictions ([#2645](https://github.com/Cryptoking28/monisagent/pull/2645)) ([13a627a](https://github.com/Cryptoking28/monisagent/commit/13a627a1a1529dd8f8c93d0b9f582457c019a63e))

#### Documentation

* Updated compatibility report ([#2673](https://github.com/Cryptoking28/monisagent/pull/2673)) ([e4d0503](https://github.com/Cryptoking28/monisagent/commit/e4d0503934f7de45d3cdb6dbb4640a66cf8d8421))

#### Miscellaneous chores

* Replaced static openssl cert usage with in-process cert ([#2671](https://github.com/Cryptoking28/monisagent/pull/2671)) ([72872f4](https://github.com/Cryptoking28/monisagent/commit/72872f4313fd9bc6d2b358a735dc76b9cda1a489))

### v12.5.2 (2024-10-23)

#### Features

* Updated shim/when instrumentation to use tracer to run in context ([#2642](https://github.com/Cryptoking28/monisagent/pull/2642)) ([1a80ad5](https://github.com/Cryptoking28/monisagent/commit/1a80ad56a6d502182a0db368f40443467f7943df))

#### Bug fixes

* Fixed amqplib instrumentation via ESM ([#2668](https://github.com/Cryptoking28/monisagent/pull/2668)) ([a36deba](https://github.com/Cryptoking28/monisagent/commit/a36deba7ba7b46c4947fcb83db0a4f97bd4c0bf1))

#### Documentation

* Remove SECURITY.md ([#2633](https://github.com/Cryptoking28/monisagent/pull/2633)) ([41002cd](https://github.com/Cryptoking28/monisagent/commit/41002cd1c423c378bfbe024ebe7dae03d02d2949))
* Updated compatibility report ([#2670](https://github.com/Cryptoking28/monisagent/pull/2670)) ([281c0fa](https://github.com/Cryptoking28/monisagent/commit/281c0fa3be096a0ef3eef25b0f51df7ae8bf50bf))
* Updated match custom-assertion jsdoc ([#2636](https://github.com/Cryptoking28/monisagent/pull/2636)) ([c37abe5](https://github.com/Cryptoking28/monisagent/commit/c37abe5eb4528493bb3950e376bf780d6cd29023))

#### Miscellaneous chores

* Upgraded `import-in-the-middle` to work around a bug introduced in 1.11.1 ([#2618](https://github.com/Cryptoking28/monisagent/pull/2618)) ([9ad476a](https://github.com/Cryptoking28/monisagent/commit/9ad476a765eee472f510239b4265d10f0a50c666))

#### Tests

* Migrated `aws-sdk-v2` and `aws-sdk-v3` tests to `node:test` ([#2620](https://github.com/Cryptoking28/monisagent/pull/2620)) ([e0dc015](https://github.com/Cryptoking28/monisagent/commit/e0dc01571087c3d53434d2d21d77206592137b66))
* Migrated `test/unit/shim` to `node:test` ([#2599](https://github.com/Cryptoking28/monisagent/pull/2599)) ([8d1acff](https://github.com/Cryptoking28/monisagent/commit/8d1acffabf29ba6e0b5e20a675b87a81f893fc0a))
* Migrated `test/versioned/amqplib` to `node:test` ([#2612](https://github.com/Cryptoking28/monisagent/pull/2612)) ([7bdada6](https://github.com/Cryptoking28/monisagent/commit/7bdada678c18997c268cf19c56262b870bae5673))
* Migrated `test/versioned/express` to `node:test` ([#2609](https://github.com/Cryptoking28/monisagent/pull/2609)) ([bd2f1a5](https://github.com/Cryptoking28/monisagent/commit/bd2f1a53f8e03810e3c0aa5d042b6b256ec7346b))
* Migrated bluebird versioned tests to `node:test` ([#2635](https://github.com/Cryptoking28/monisagent/pull/2635)) ([6e28fad](https://github.com/Cryptoking28/monisagent/commit/6e28fad70390ffaf4df7ccbc96c88f79bb5d2fe2))
* Migrated last group of unit tests to `node:test` ([#2624](https://github.com/Cryptoking28/monisagent/pull/2624)) ([386f546](https://github.com/Cryptoking28/monisagent/commit/386f54682128d0dda8ad073a57cd45109c927fe1))
* Migrated unit tests to `node:test` ([#2623](https://github.com/Cryptoking28/monisagent/pull/2623)) ([86231b7](https://github.com/Cryptoking28/monisagent/commit/86231b7dec5bc5807ae26a88a7b8f2ff1535d9c4))
* Updated tests that relied on `tspl` by awating the `plan.completed` instead of calling `end` to avoid flaky tests ([#2610](https://github.com/Cryptoking28/monisagent/pull/2610)) ([935ac14](https://github.com/Cryptoking28/monisagent/commit/935ac14dbff7d11e797d290fb24a0d791ac9a61a))
* Updated tests that used the context manager directly and instead use the tracer to access the segment context ([#2643](https://github.com/Cryptoking28/monisagent/pull/2643)) ([b917b3e](https://github.com/Cryptoking28/monisagent/commit/b917b3ea9416eaf64bf365f6f46a0d4eafdfc437))
* Updated the mininum version of pg-native in pg-esm tests to align with the pg tests ([#2616](https://github.com/Cryptoking28/monisagent/pull/2616)) ([16be714](https://github.com/Cryptoking28/monisagent/commit/16be71404dcea903f3f7b7d4d238cc0a416d7b79))
* Migrated `bunyan`, `pino`, and `winston` tests to `node:test` ([#2634](https://github.com/Cryptoking28/monisagent/pull/2634)) ([69c1ab8](https://github.com/Cryptoking28/monisagent/commit/69c1ab8951f8cd405986e879399dff716f839a78))
* Migrated `fastify` tests to `node:test` ([#2632](https://github.com/Cryptoking28/monisagent/pull/2632)) ([b522477](https://github.com/Cryptoking28/monisagent/commit/b522477168c2049b12bcfd39ae485f9e5374f724))
* Migrated block of unit tests to `node:test` ([#2607](https://github.com/Cryptoking28/monisagent/pull/2607)) ([e33807b](https://github.com/Cryptoking28/monisagent/commit/e33807b817852bb7cdc93c9b171250df17a3b867))
* Migrated block of unit tests to `node:test` ([#2604](https://github.com/Cryptoking28/monisagent/pull/2604)) ([cd90ce1](https://github.com/Cryptoking28/monisagent/commit/cd90ce11908edc4376a704153f44d4f3ddfb6866))
* Migrated block of unit tests to `node:test` ([#2593](https://github.com/Cryptoking28/monisagent/pull/2593)) ([6d4d49e](https://github.com/Cryptoking28/monisagent/commit/6d4d49e075d8c4c687d4730b65aa39177e384ce5))

#### Continuous integration

* Added delay to site extension publishing to wait for NPM ([#2665](https://github.com/Cryptoking28/monisagent/pull/2665)) ([e412020](https://github.com/Cryptoking28/monisagent/commit/e412020865bab187d8c7d274cdc6973946286a1f))

### v12.5.1 (2024-09-23)

#### Bug fixes

* Fixed handling of Pino merging object ([#2600](https://github.com/Cryptoking28/monisagent/pull/2600)) ([de3c266](https://github.com/Cryptoking28/monisagent/commit/de3c26683a1fb63da26cfd813599774a5db61097))

#### Documentation

* Updated compatibility report ([#2589](https://github.com/Cryptoking28/monisagent/pull/2589)) ([2f45a4a](https://github.com/Cryptoking28/monisagent/commit/2f45a4a535d83ac8fe073ed5082edda4ff1fb720))

#### Miscellaneous chores

* **deps:** Udpated @monisagent/security-agent to v2.0.0 ([#2594](https://github.com/Cryptoking28/monisagent/pull/2594)) ([92e6978](https://github.com/Cryptoking28/monisagent/commit/92e6978d74b365085afa719b02c41d07b1ba82ea))

#### Tests

* Convert transaction* and urltils tests to `node:test` ([#2585](https://github.com/Cryptoking28/monisagent/pull/2585)) ([d169546](https://github.com/Cryptoking28/monisagent/commit/d169546b7c51d83db0697f941343cd334f675e60))
* Fixed @koa/router tests. path-to-regex differs between @koa/router and koa-router now ([#2587](https://github.com/Cryptoking28/monisagent/pull/2587)) ([608dd98](https://github.com/Cryptoking28/monisagent/commit/608dd98924a3b8fd4b3b48d8fc3a0dc54ce493b2))
* Removed transitive deps from versioned tests as they will auto-install if required as peer deps ([#2580](https://github.com/Cryptoking28/monisagent/pull/2580)) ([0db6599](https://github.com/Cryptoking28/monisagent/commit/0db6599505ca568c82f36584f3214adcdb68a976))
* Updated a missing `minSupported` in aws-sdk-v3 versioned tests ([#2582](https://github.com/Cryptoking28/monisagent/pull/2582)) ([c997af6](https://github.com/Cryptoking28/monisagent/commit/c997af6ab935ff103fa97a21d204c9482e66aa61))
* Updated fastify versioned tests to work with `fastify@5.0.0` ([#2584](https://github.com/Cryptoking28/monisagent/pull/2584)) ([a5a1526](https://github.com/Cryptoking28/monisagent/commit/a5a1526c9aa83ca96d5d6e3ac0cc703cf7042efc))
* Updated how we handle the koa-router nuance of wildcard routes ([#2588](https://github.com/Cryptoking28/monisagent/pull/2588)) ([ddeb097](https://github.com/Cryptoking28/monisagent/commit/ddeb097a7f29b8fcdd7b4082fa4f8b55e5e386a9))
* Updated koa-router to tests to handle bug fixes from 13.0.1 ([#2578](https://github.com/Cryptoking28/monisagent/pull/2578)) ([a28e2e6](https://github.com/Cryptoking28/monisagent/commit/a28e2e66e8bcc71aadd6bbd9a84eadbc4990d490))
* Migrate block of unit tests to `node:test` ([#2570](https://github.com/Cryptoking28/monisagent/pull/2570)) ([5cd1d8a](https://github.com/Cryptoking28/monisagent/commit/5cd1d8aa6fa673d090e7b3d5fdc962c75c866706))
* Migrate second block of unit tests to `node:test` ([#2572](https://github.com/Cryptoking28/monisagent/pull/2572)) ([943a83e](https://github.com/Cryptoking28/monisagent/commit/943a83eb9f6267d76cd576c5375889cff89557e9))
* Reduce koa-router version to enable CI ([#2573](https://github.com/Cryptoking28/monisagent/pull/2573)) ([f44a99b](https://github.com/Cryptoking28/monisagent/commit/f44a99b2ffdd7b35c38708ebf200fb266e740187))
* Removed noisy test log ([#2583](https://github.com/Cryptoking28/monisagent/pull/2583)) ([3766ed6](https://github.com/Cryptoking28/monisagent/commit/3766ed634df348898515f95edc3c58389d67b62d))

#### Continuous integration

* Added workflow run trigger to Azure site extension publish job ([#2575](https://github.com/Cryptoking28/monisagent/pull/2575)) ([e8ae942](https://github.com/Cryptoking28/monisagent/commit/e8ae94249553c8c648e43adec271e9e2900c574a))

### v12.5.0 (2024-09-12)

#### Features

* Added utilization info for ECS ([#2565](https://github.com/Cryptoking28/monisagent/pull/2565)) ([6f92073](https://github.com/Cryptoking28/monisagent/commit/6f92073a6c01124d8ab1b54d06c176a36fbc3441))

#### Bug fixes

* Ensured README displays for Azure site extension ([#2564](https://github.com/Cryptoking28/monisagent/pull/2564)) ([a30aed5](https://github.com/Cryptoking28/monisagent/commit/a30aed5cf31c0c89678618e51215063562331848))

#### Documentation

* Updated compatibility report ([#2562](https://github.com/Cryptoking28/monisagent/pull/2562)) ([8f7aebe](https://github.com/Cryptoking28/monisagent/commit/8f7aebe7e4274ce45cfe961537a09b34077b3aa0))

#### Tests

* Convert `metric` and `metrics-recorder` tests to `node:test` ([#2552](https://github.com/Cryptoking28/monisagent/pull/2552)) ([7ae4af4](https://github.com/Cryptoking28/monisagent/commit/7ae4af4c8adfabadd3c865bd2fdd0e8ba5317eef))
* Updated `serverless` unit tests to `node:test` ([#2549](https://github.com/Cryptoking28/monisagent/pull/2549)) ([619f23c](https://github.com/Cryptoking28/monisagent/commit/619f23c938bf39c360a6da9a307c178986c70902))

### v12.4.0 (2024-09-11)

#### Features

* Added support for `express@5` ([#2555](https://github.com/Cryptoking28/monisagent/pull/2555)) ([252f3b2](https://github.com/Cryptoking28/monisagent/commit/252f3b2bc1206dad52d914b98a2352da317da2d5))
* Provided ability to disable instrumentation for a 3rd party package ([#2551](https://github.com/Cryptoking28/monisagent/pull/2551)) ([abfb9f0](https://github.com/Cryptoking28/monisagent/commit/abfb9f029a4f6c25966c35d3284ddae0d46dfecb))
  * To disable instrumentation set `config.instrumentation.<library>.enabled` to false.  The values of `<library>` are the keys listed [here](https://github.com/Cryptoking28/monisagent/blob/main/lib/instrumentations.js)
...
* Added CI for publishing agent as Azure site extension ([#2488](https://github.com/Cryptoking28/monisagent/pull/2488)) ([468943a](https://github.com/Cryptoking28/monisagent/commit/468943a1ed3864dafb93a2f96561d1a778d03a5f))
* Added Azure site extension installation scripts ([#2448](https://github.com/Cryptoking28/monisagent/pull/2448)) ([a56c4e1](https://github.com/Cryptoking28/monisagent/commit/a56c4e146ead7d3205fead1f17afad0ea7a77e59))

#### Tests

* Converted `llm-events` tests to use `node:test` ([#2535](https://github.com/Cryptoking28/monisagent/pull/2535)) ([ebfa2e9](https://github.com/Cryptoking28/monisagent/commit/ebfa2e9ab8ecbe4bc9adaddd3e4a60e3ba84d0d9))
* Migrated `test/unit/spans` to use `node:test` ([#2556](https://github.com/Cryptoking28/monisagent/pull/2556)) ([9319071](https://github.com/Cryptoking28/monisagent/commit/931907182b0168990a04bb92c2f28310450f8ba0))
* Migrated `test/unit/util` to use `node:test` ([#2546](https://github.com/Cryptoking28/monisagent/pull/2546)) ([0b07be8](https://github.com/Cryptoking28/monisagent/commit/0b07be8f7f29e67630326c73b96faa5e20527a0b))
* Migrated tests in `test/unit/instrumentation` to use `node:test` ([#2531](https://github.com/Cryptoking28/monisagent/pull/2531)) ([47b8398](https://github.com/Cryptoking28/monisagent/commit/47b8398820d665a85a96ae84e30eaaf20564dcf8))
* Converted `collector` unit tests to `node:test` ([#2510](https://github.com/Cryptoking28/monisagent/pull/2510)) ([762511b](https://github.com/Cryptoking28/monisagent/commit/762511be524f971a609ff45c111c2d1a89ec1c46))
* Converted `errors` unit tests to `node:test` ([#2540](https://github.com/Cryptoking28/monisagent/pull/2540)) ([ae82760](https://github.com/Cryptoking28/monisagent/commit/ae82760f7001f6bcdd6a9fe0ec1e96dc60db99e5))

### v12.3.1 (2024-09-04)

#### Bug fixes

* Fixed detection of REST API type payloads in AWS Lambda ([#2543](https://github.com/Cryptoking28/monisagent/pull/2543)) ([adfeebc](https://github.com/Cryptoking28/monisagent/commit/adfeebc043161e0e0c35de2cf93989dbde9cb8fa))

#### Documentation

* Cleaned up formatting of api.js to properly inject example snippets when rendering on API docs site ([#2524](https://github.com/Cryptoking28/monisagent/pull/2524)) ([4b34f3d](https://github.com/Cryptoking28/monisagent/commit/4b34f3dbab45a55ec447b6e21b69c7621b41e539))
* Updated compatibility report ([#2523](https://github.com/Cryptoking28/monisagent/pull/2523)) ([29784ea](https://github.com/Cryptoking28/monisagent/commit/29784ea766b2a9388c050f271ab7190895bc22ed))
* Updated Next.js Otel cloud provider FAQ ([#2537](https://github.com/Cryptoking28/monisagent/pull/2537)) ([6553807](https://github.com/Cryptoking28/monisagent/commit/655380760a89193c5b6cd47d3955d1244cd79e7b))

#### Tests

* Converted db unit tests to node:test ([#2514](https://github.com/Cryptoking28/monisagent/pull/2514)) ([bea4548](https://github.com/Cryptoking28/monisagent/commit/bea45481a8a04099096929b36532203fbb8b6921))
* Converted grpc, lib, and utilization tests to `node:test` ([#2532](https://github.com/Cryptoking28/monisagent/pull/2532)) ([c207e1e](https://github.com/Cryptoking28/monisagent/commit/c207e1e3de75a9c3a2c4a05fa1bc318d3e455ef9))
* Replaced distributed tracing tests with `node:test` ([#2527](https://github.com/Cryptoking28/monisagent/pull/2527)) ([8184c56](https://github.com/Cryptoking28/monisagent/commit/8184c5676155b9028c84adc0da3902803ee9d107))
* Added a match function for tests ([#2541](https://github.com/Cryptoking28/monisagent/pull/2541)) ([51e7f34](https://github.com/Cryptoking28/monisagent/commit/51e7f34e733202a9c2c024d9d9a7f3c207dfc4b0))
* Converted `config` to `node:test` ([#2517](https://github.com/Cryptoking28/monisagent/pull/2517)) ([1534a73](https://github.com/Cryptoking28/monisagent/commit/1534a734995b6800c4cab3b6712f1b6b1329ed5e))
...
* Added new API method `withLlmCustomAttributes` to run a function in a LLM context ([#2437](https://github.com/Cryptoking28/monisagent/pull/2437)) ([57e6be9](https://github.com/Cryptoking28/monisagent/commit/57e6be9f4717fde3caada0e3ca3680959180f928))
    * The context will be used to assign custom attributes to every LLM event produced within the function

#### Bug fixes

* Improved AWS Lambda event detection ([#2498](https://github.com/Cryptoking28/monisagent/pull/2498)) ([5e8b260](https://github.com/Cryptoking28/monisagent/commit/5e8b2608d9914e2a4282f7c9c42ff17dfa9f793e))

#### Documentation

* Updated compatibility report ([#2493](https://github.com/Cryptoking28/monisagent/pull/2493)) ([0448927](https://github.com/Cryptoking28/monisagent/commit/0448927a49254b5b3c7ed9ff072cec24449fc558))

#### Miscellaneous chores
* Fixed linting scripts ([#2497](https://github.com/Cryptoking28/monisagent/pull/2497)) ([c395779](https://github.com/Cryptoking28/monisagent/commit/c395779f499cca0ec7f915342c23b2d2381b0163))
* Removed examples/shim ([#2484](https://github.com/Cryptoking28/monisagent/pull/2484)) ([40d1f5c](https://github.com/Cryptoking28/monisagent/commit/40d1f5ccc50d49805fc68946806fc9f74179673b))
* Updated test-utils dependency and added matrix-count only ([#2494](https://github.com/Cryptoking28/monisagent/pull/2494)) ([5e04c76](https://github.com/Cryptoking28/monisagent/commit/5e04c76600b8e6b7bfe331c2bec1b6cfa05ab922))

#### Tests

* Converted the api unit tests to `node:test` ([#2516](https://github.com/Cryptoking28/monisagent/pull/2516)) ([ab91576](https://github.com/Cryptoking28/monisagent/commit/ab91576fa949161f902b1604752a7fc38e7f2a74))
* Converted context-manager unit tests to `node:test` ([#2508](https://github.com/Cryptoking28/monisagent/pull/2508)) ([9363eb0](https://github.com/Cryptoking28/monisagent/commit/9363eb08ce8a13e67f94e5378ca95f32a562d504))

#### Continuous integration

* Updated codecov action sha to post coverage from forks.  Added flag to fail ci if it fails to upload report ([#2490](https://github.com/Cryptoking28/monisagent/pull/2490)) ([12fbe56](https://github.com/Cryptoking28/monisagent/commit/12fbe56ca2581b3dd5cc5e2c1eceade46a8d191d))

### v12.2.0 (2024-08-19)

#### Features

* Added instrumentation support for Express 5 beta ([#2476](https://github.com/Cryptoking28/monisagent/pull/2476)) ([06a4c2f](https://github.com/Cryptoking28/monisagent/commit/06a4c2f9d62f7313fd246b4eed7f9f04f8b6345b))
    * This will be experimental until `express@5.0.0` is generally available

#### Bug fixes

* Updated `koa` instrumentation to properly get the matched route name and to handle changes in `@koa/router@13.0.0` ([#2486](https://github.com/Cryptoking28/monisagent/pull/2486)) ([0c2ee2f](https://github.com/Cryptoking28/monisagent/commit/0c2ee2fd1698972de35a0ad2685e626a074125ed))

#### Documentation

* Removed reference to `@monisagent/next` in README ([#2479](https://github.com/Cryptoking28/monisagent/pull/2479)) ([8740539](https://github.com/Cryptoking28/monisagent/commit/8740539c4004e421e5f26d0c92216bcffb93c9cc))
* Updated compatibility report ([#2487](https://github.com/Cryptoking28/monisagent/pull/2487)) ([c0a5e64](https://github.com/Cryptoking28/monisagent/commit/c0a5e646773c365897a908daf034881703dbd1df))

#### Miscellaneous chores

* Reverted to upstream `require-in-the-middle` ([#2473](https://github.com/Cryptoking28/monisagent/pull/2473)) ([9bbc41c](https://github.com/Cryptoking28/monisagent/commit/9bbc41c5be479af56d5aa0c87291d2fec607e9e4))
* Updated aggregators unit tests to node:test ([#2481](https://github.com/Cryptoking28/monisagent/pull/2481)) ([fd2d76f](https://github.com/Cryptoking28/monisagent/commit/fd2d76fb2f6e8debc165700f932d57a02c3d3956))

### v12.1.1 (2024-08-15)

#### Bug fixes

* Updated `amqplib` instrumentation to properly parse host/port from connect ([#2461](https://github.com/Cryptoking28/monisagent/pull/2461)) ([91636a8](https://github.com/Cryptoking28/monisagent/commit/91636a8e9702ba4ad1bf9b3941432ea65a3920fe))
* Updated `redis` instrumentation to parse host/port when a url is not provided ([#2463](https://github.com/Cryptoking28/monisagent/pull/2463)) ([2b67623](https://github.com/Cryptoking28/monisagent/commit/2b67623afef5fb132105c7f5b1d72e23b6d56dc1))
* Updated the `kafkajs` node metrics to remove `/Named` from the name ([#2458](https://github.com/Cryptoking28/monisagent/pull/2458)) ([37ce113](https://github.com/Cryptoking28/monisagent/commit/37ce1137a91c2efa85541cf6ec252a759e5f48ea))

#### Code refactoring

* Updated pino instrumentation to separate the wrapping of asJson into its own function ([#2464](https://github.com/Cryptoking28/monisagent/pull/2464)) ([81fdde1](https://github.com/Cryptoking28/monisagent/commit/81fdde1e35b5643ff141db1309ca58d7f6176cd5))

#### Documentation

* Updated compatibility report ([#2460](https://github.com/Cryptoking28/monisagent/pull/2460)) ([a4570e9](https://github.com/Cryptoking28/monisagent/commit/a4570e93298d10f4464570b75867634b95a61e89))

#### Miscellaneous chores

* Removed limit on superagent versioned testing ([#2456](https://github.com/Cryptoking28/monisagent/pull/2456)) ([b4b6a6b](https://github.com/Cryptoking28/monisagent/commit/b4b6a6b2eca8bd47d17f8b265344b4596c8226b3))

### v12.1.0 (2024-08-12)

#### Bug fixes

* Pick log message from merging object in Pino instrumentation ([#2421](https://github.com/Cryptoking28/monisagent/pull/2421)) ([599072b](https://github.com/Cryptoking28/monisagent/commit/599072b43b77a8c11c9ef414b08dfe6e04bca9d2))
* Added TLS verification for Redis ([#2446](https://github.com/Cryptoking28/monisagent/pull/2446)) ([9a16b70](https://github.com/Cryptoking28/monisagent/commit/9a16b7016a943a0c2817ab2151eaa81f5ea19760))


#### Documentation

* Updated compatibility report ([#2440](https://github.com/Cryptoking28/monisagent/pull/2440)) ([32abe5f](https://github.com/Cryptoking28/monisagent/commit/32abe5f90d93d470737986b3bfe6c797915c4215))
* Updated examples to properly use specs ([#2422](https://github.com/Cryptoking28/monisagent/pull/2422)) ([f7e8c58](https://github.com/Cryptoking28/monisagent/commit/f7e8c5831305ac0bcb2c906ec176863552a083c4))
* Fixed typo in doc header ([#2433](https://github.com/Cryptoking28/monisagent/pull/2433)) ([9726e23](https://github.com/Cryptoking28/monisagent/commit/9726e231fe631623f882df38344df4db9ce67b70))

#### Miscellaneous chores

* Added entity relationship attributes to SQS segments ([#2436](https://github.com/Cryptoking28/monisagent/pull/2436)) ([578aead](https://github.com/Cryptoking28/monisagent/commit/578aead8c0b2d18dced4eaca54b19c769f398868))
* Converted agent unit tests to node:test ([#2414](https://github.com/Cryptoking28/monisagent/pull/2414)) ([b32f793](https://github.com/Cryptoking28/monisagent/commit/b32f7934fec5dc9e7b29dee5d1994ab180bb0c37))
* Fixed mongodb-esm tests in combination with security agent ([#2444](https://github.com/Cryptoking28/monisagent/pull/2444)) ([5d617de](https://github.com/Cryptoking28/monisagent/commit/5d617de99bc89b678b8c11aaebcad5dcacf0b5c3))
* Limited superagent tests to avoid new breaking release ([#2439](https://github.com/Cryptoking28/monisagent/pull/2439)) ([f1dd8e7](https://github.com/Cryptoking28/monisagent/commit/f1dd8e73b8329a075667f6696d2a27bc749e4e7a))
* Removed promise resolvers from callback based agent unit tests ([#2450](https://github.com/Cryptoking28/monisagent/pull/2450)) ([3766895](https://github.com/Cryptoking28/monisagent/commit/3766895cd7cc8145ba8eef6d49330e0d354158a1))


#### Tests

* Moved pkgVersion to collection-common to avoid a conflict with ESM tests ([#2438](https://github.com/Cryptoking28/monisagent/pull/2438)) ([7260fa3](https://github.com/Cryptoking28/monisagent/commit/7260fa36372877bb6f60637f8255312fcf207a0a))
* Restored mongodb-esm tests ([#2434](https://github.com/Cryptoking28/monisagent/pull/2434)) ([67a12e3](https://github.com/Cryptoking28/monisagent/commit/67a12e32c6deef0c7f8397ac75c369f3371519e8))
* Updated custom test reporter to only log failed tests when there are failures ([#2425](https://github.com/Cryptoking28/monisagent/pull/2425)) ([baa37ec](https://github.com/Cryptoking28/monisagent/commit/baa37ece0d027ca6d57fd5b52ceedfaa97ecbfaa))
* Updated tls redis tests to work with older versions of redis v4 ([#2454](https://github.com/Cryptoking28/monisagent/pull/2454)) ([ffd9b17](https://github.com/Cryptoking28/monisagent/commit/ffd9b177e85ed73963f88767e9d3e20c57ea372d))
...
* Dropped support for Node.js 16 ([#2394](https://github.com/Cryptoking28/monisagent/pull/2394)) ([1870010](https://github.com/Cryptoking28/monisagent/commit/1870010a1d7dc417fc03ae526a9709e382b3fe1f))
* Removed legacy context manager ([#2404](https://github.com/Cryptoking28/monisagent/pull/2404)) ([321244c](https://github.com/Cryptoking28/monisagent/commit/321244c357bc5dd9b4aeefc308cda5e80b8012b0))
* Removed support for `redis` < 2.6.0 ([#2405](https://github.com/Cryptoking28/monisagent/pull/2405)) ([e2c0a31](https://github.com/Cryptoking28/monisagent/commit/e2c0a31b5230e0ffbdc3d4567619190570b7167c))
* Removed instrumentation for `director` ([#2402](https://github.com/Cryptoking28/monisagent/pull/2402)) ([1b355e7](https://github.com/Cryptoking28/monisagent/commit/1b355e733aef0e14c5f4cb2899642a3d5b6f18ce))
* Added `server.address` to amqplib spans ([#2406](https://github.com/Cryptoking28/monisagent/pull/2406)) ([09636a4](https://github.com/Cryptoking28/monisagent/commit/09636a4ce90969e7aea229ef008bd35f57e09217))
* Updated `mongodb` instrumentation to drop support for versions 2 and 3 ([#2398](https://github.com/Cryptoking28/monisagent/pull/2398)) ([a0ae32a](https://github.com/Cryptoking28/monisagent/commit/a0ae32a6a61112e0473d477075543485d02313cf))
* Migrated instrumentation for `next` into agent ([#2409](https://github.com/Cryptoking28/monisagent/pull/2409)) ([b55d8e1](https://github.com/newr    elic/node-monisagent/commit/b55d8e1ca09e6055ea09f4fcd773a05245e7203f)) 
  * You no longer need to load Next.js instrumentation via `@monisagent/next`.
  * Instead you must load the agent via `NODE_OPTIONS='-r monisagent' next start`

#### Documentation

* Updated compatibility report ([#2401](https://github.com/Cryptoking28/monisagent/pull/2401)) ([a53085d](https://github.com/Cryptoking28/monisagent/commit/a53085ddce2f2d7a4c9288fbf63fbf82436fb15f))

#### Miscellaneous chores

* Added test configs for defined targets in the aws test suite ([#2403](https://github.com/Cryptoking28/monisagent/pull/2403)) ([cf514d9](https://github.com/Cryptoking28/monisagent/commit/cf514d97b82889b14a342cbded630bae73992c35))
* Added producer and consumer metrics to kafkajs instrumentation ([#2407](https://github.com/Cryptoking28/monisagent/pull/2407)) ([41c1cc6](https://github.com/Cryptoking28/monisagent/commit/41c1cc6d9815a1b89a7ab043b5da5f032969a87e))
* Switched to using Node built-in test runner ([#2387](https://github.com/Cryptoking28/monisagent/pull/2387)) ([b9f64b7](https://github.com/Cryptoking28/monisagent/commit/b9f64b76b8777fc790a4694a95318f401a56abdd))
* Updated `@monisagent/native-metrics` to 11.0.0 ([#2412](https://github.com/Cryptoking28/monisagent/pull/2412)) ([aef69e2](https://github.com/Cryptoking28/monisagent/commit/aef69e28cc3ead2079cfc0bdf9bde74129a3711f))
* Updated dashboard links in developer-setup.md ([#2397](https://github.com/Cryptoking28/monisagent/pull/2397)) ([16866da](https://github.com/Cryptoking28/monisagent/commit/16866da381366ad848ea06be44fd838d57c9fb67))
* Verified MySQL host:port metric is recorded ([#2400](https://github.com/Cryptoking28/monisagent/pull/2400)) ([74176f7](https://github.com/Cryptoking28/monisagent/commit/74176f77f70247a3cf65b1b49c5414279b4eeca6))

#### Tests

* Removed mongodb-esm tests as they are not atomic and conflicting with mongodb tests in CI ([#2416](https://github.com/Cryptoking28/monisagent/pull/2416)) ([e587b9d](https://github.com/Cryptoking28/monisagent/commit/e587b9dcb795cca3c29c6e0da18770401c3085a0))
* Updated minimum version of lesser used versions of 3rd party libraries ([#2399](https://github.com/Cryptoking28/monisagent/pull/2399)) ([ef8c006](https://github.com/Cryptoking28/monisagent/commit/ef8c00674c22b4794c6cee823d46ad9db7d67fed))

### v11.23.2 (2024-07-22)

#### Features

* Added support for `fs.glob` in Node 22+ ([#2369](https://github.com/Cryptoking28/monisagent/pull/2369)) ([1791a4e](https://github.com/Cryptoking28/monisagent/commit/1791a4ef4a31e36757c47a9947ef8840fdd995c2))

#### Bug fixes

* Updated aws-sdk v3 instrumentation to load custom middleware last to properly get the external http span to add `aws.*` attributes ([#2382](https://github.com/Cryptoking28/monisagent/pull/2382)) ([751801b](https://github.com/Cryptoking28/monisagent/commit/751801be814343c9ddcee3dd7e83f87a1c6786d4))
* Updated cassandra-driver instrumentation to properly trace promise based executions ([#2351](https://github.com/Cryptoking28/monisagent/pull/2351)) ([bab9a8b](https://github.com/Cryptoking28/monisagent/commit/bab9a8bab4ab6af8efa70d8559bdcc7ca6f5df32))

#### Documentation

* Removed examples/api/ ([#2381](https://github.com/Cryptoking28/monisagent/pull/2381)) ([fb964de](https://github.com/Cryptoking28/monisagent/commit/fb964de863f8989161f9a780f9eddc6e3ec91138))
* Removed out of date `ROADMAP_Node.md` from root of project ([#2367](https://github.com/Cryptoking28/monisagent/pull/2367)) ([4be870c](https://github.com/Cryptoking28/monisagent/commit/4be870c758d9b931866ef3e6781d01bf176671a9))
* Updated compatibility report ([#2345](https://github.com/Cryptoking28/monisagent/pull/2345)) ([f08adc3](https://github.com/Cryptoking28/monisagent/commit/f08adc3a30bdf3e5d23bd00efeb3b16ac06cd3e5))

#### Miscellaneous chores

* Always upload status logs in compatibility report CI ([#2341](https://github.com/Cryptoking28/monisagent/pull/2341)) ([b3f1ee3](https://github.com/Cryptoking28/monisagent/commit/b3f1ee3fe40c38c7484661dfb2e599df4f31003e))

#### Tests

* Removed `server.start` in grpc tests as it is deprecated and no longer needed ([#2372](https://github.com/Cryptoking28/monisagent/pull/2372)) ([d212b15](https://github.com/Cryptoking28/monisagent/commit/d212b15c929ebca22881f3d41a8d7f99033847a8))
* Updated benchmark test results to output result files ([#2350](https://github.com/Cryptoking28/monisagent/pull/2350)) ([1b51a68](https://github.com/Cryptoking28/monisagent/commit/1b51a68200dae14b865a6db06d62655a25a62c2d))

#### Continuous integration

* Added benchmark test GitHub Action ([#2366](https://github.com/Cryptoking28/monisagent/pull/2366)) ([afd3ab4](https://github.com/Cryptoking28/monisagent/commit/afd3ab48611ec8409be1472ebbc63db24cff8e73))
* Increased the limit of installs from 2 to a bigger number for versioned tests ([#2346](https://github.com/Cryptoking28/monisagent/pull/2346)) ([f85a385](https://github.com/Cryptoking28/monisagent/commit/f85a38524f1d41e82b2c5085c41d79d1263b63c3))
* Updated `bin/create-docs-pr` to create an empty array if changelog.json is missing security ([#2348](https://github.com/Cryptoking28/monisagent/pull/2348)) ([7d5368c](https://github.com/Cryptoking28/monisagent/commit/7d5368ce873affbf2593bd6b1cc32259da852e1d))

### v11.23.1 (2024-07-11)

#### Bug fixes

* Updated redis v4 instrumentation to work with transactions(multi/exec) ([#2343](https://github.com/Cryptoking28/monisagent/pull/2343)) ([39eb842](https://github.com/Cryptoking28/monisagent/commit/39eb8421b84f7fe298acf5c9c89de31ee0cc2604))

#### Documentation

* Updated compatibility report ([#2342](https://github.com/Cryptoking28/monisagent/pull/2342)) ([5c9e3e6](https://github.com/Cryptoking28/monisagent/commit/5c9e3e6bfa8a388c7dd071ecb0231b069f065645))

### v11.23.0 (2024-07-10)

#### Features

* Added support for account level governance of AI Monitoring ([#2326](https://github.com/Cryptoking28/monisagent/pull/2326)) ([7069335](https://github.com/Cryptoking28/monisagent/commit/7069335bfee38b1774da00bdbb63138ebf38da90))

#### Code refactoring

* Removed redundant isExpected in the Exception class ([#2328](https://github.com/Cryptoking28/monisagent/pull/2328)) ([38f9825](https://github.com/Cryptoking28/monisagent/commit/38f982564c0e0b93f17146be8beed005f9405ead))
* Reduced duplication in the error-collector ([#2323](https://github.com/Cryptoking28/monisagent/pull/2323)) ([10581bf](https://github.com/Cryptoking28/monisagent/commit/10581bf8cdad5c61c25dc1309ad97ca36d58cf79))
* Refactored benchmark tests to complete async functions ([#2334](https://github.com/Cryptoking28/monisagent/pull/2334)) ([57a4dfb](https://github.com/Cryptoking28/monisagent/commit/57a4dfb77c0408cbd81291c71db770005a0f2b5a))

#### Documentation

* Included commands and links for Mac setup ([#2327](https://github.com/Cryptoking28/monisagent/pull/2327)) ([6eddb72](https://github.com/Cryptoking28/monisagent/commit/6eddb721b676b246e5ace28bea75c6cd723d5ddb))
* Updated compatibility report ([#2318](https://github.com/Cryptoking28/monisagent/pull/2318)) ([3a910ef](https://github.com/Cryptoking28/monisagent/commit/3a910ef29c76cfd05903f01fb84d6775f8669578))

#### Miscellaneous chores

* Fixed copy paste error in post release workflow ([#2329](https://github.com/Cryptoking28/monisagent/pull/2329)) ([6f2da7a](https://github.com/Cryptoking28/monisagent/commit/6f2da7a2a07ce699f8d6ef859b4a90f0bd68df15))
* Implemented split jobs for post release docs publishing ([#2319](https://github.com/Cryptoking28/monisagent/pull/2319)) ([c14ec3b](https://github.com/Cryptoking28/monisagent/commit/c14ec3b7020f43f6515609346f3b2f9586e63430))

#### Tests

* Fixed recordMiddlewawre benchmark test ([#2338](https://github.com/Cryptoking28/monisagent/pull/2338)) ([fb55ac7](https://github.com/Cryptoking28/monisagent/commit/fb55ac7e19a26c76d19ead169664e40e0df4b822))
...
* Added support for Node 22([#2305](https://github.com/Cryptoking28/monisagent/pull/2305)) ([0bf8908](https://github.com/Cryptoking28/monisagent/commit/0bf89081a59fe598b22613257f519c171149c454))
* Added AIM support for Meta Llama3 models in AWS Bedrock ([#2306](https://github.com/Cryptoking28/monisagent/pull/2306)) ([ff2e509](https://github.com/Cryptoking28/monisagent/commit/ff2e509913c2169c274387db461edffeee896834))

#### Documentation

* Updated compatibility report ([#2309](https://github.com/Cryptoking28/monisagent/pull/2309)) ([7bf77c6](https://github.com/Cryptoking28/monisagent/commit/7bf77c6b41d8313c6837293f42901c6e13954af4))

#### Miscellaneous chores

* Added [@amychisholm03](https://github.com/amychisholm03) to list of contributors 🎉 ([#2310](https://github.com/Cryptoking28/monisagent/pull/2310)) ([8a890f1](https://github.com/Cryptoking28/monisagent/commit/8a890f1d8879715be3b15bdc58f95c764c112646))
* Forced re-creation of API docs on gh-pages ([#2307](https://github.com/Cryptoking28/monisagent/pull/2307)) ([917110a](https://github.com/Cryptoking28/monisagent/commit/917110a189bc77823f114b1bfb338788fa2b6043))

#### Tests

* Updated undici versioned tests to assert an error is present and not the actual message ([#2299](https://github.com/Cryptoking28/monisagent/pull/2299)) ([4e38ed4](https://github.com/Cryptoking28/monisagent/commit/4e38ed494f2706d4c6b3f89474efb7365e766903))

#### Continuous integration

* Added Node 22 to CI ([#2164](https://github.com/Cryptoking28/monisagent/pull/2164)) ([4b12d9e](https://github.com/Cryptoking28/monisagent/commit/4b12d9e7d89d8367fdb895b24e2818ff85d67592))
* Added Node 22 to smoke tests and nightly versioned test runs ([#2316](https://github.com/Cryptoking28/monisagent/pull/2316)) ([af00666](https://github.com/Cryptoking28/monisagent/commit/af00666d3b1a3458c40bd6f0e3dca6ac2e477335))
* Moved the docs PR job to before api docs publish ([#2300](https://github.com/Cryptoking28/monisagent/pull/2300)) ([2e7252e](https://github.com/Cryptoking28/monisagent/commit/2e7252ef3281046c3c85722ccede582e5aefa1a9))

### v11.21.0 (2024-06-25)

#### Features

* Added support for getting container ids from ECS metadata API ([#2292](https://github.com/Cryptoking28/monisagent/pull/2292)) ([dbca830](https://github.com/Cryptoking28/monisagent/commit/dbca830deb6c9420427b60df4875ba71939508c4))

#### Bug fixes

* Handled assigning headers in LambdaProxyWebRequest when there are no headers present ([#2293](https://github.com/Cryptoking28/monisagent/pull/2293)) ([e4d22f3](https://github.com/Cryptoking28/monisagent/commit/e4d22f38b70cee061b345d6dbc94a2783a164b76))

#### Documentation

* Updated compatibility report ([#2290](https://github.com/Cryptoking28/monisagent/pull/2290)) ([b5fc893](https://github.com/Cryptoking28/monisagent/commit/b5fc8932ed5a0372f8be3f0e53c6d9fa0cf12855))

#### Tests

* Fixed log error stack message truncating and failing equality test ([#2294](https://github.com/Cryptoking28/monisagent/pull/2294)) ([8e06f0f](https://github.com/Cryptoking28/monisagent/commit/8e06f0f77762922e7862446bdf85a32eef3f9096))
* Updated shimmer method in benchmark tests ([#2281](https://github.com/Cryptoking28/monisagent/pull/2281)) ([1528d68](https://github.com/Cryptoking28/monisagent/commit/1528d685c7fd8e9af23ea91bd66124b82dcdb523))

### v11.20.0 (2024-06-24)

#### Features

* Added support for Anthropic Claude 3 messages API ([#2278](https://github.com/Cryptoking28/monisagent/pull/2278)) ([7e3cab9](https://github.com/Cryptoking28/monisagent/commit/7e3cab9739a9924b904ce78380fd70b1e30cd89f))

#### Code refactoring

* Replaced instances of `substr()` with `substring()` ([#2274](https://github.com/Cryptoking28/monisagent/pull/2274)) ([8f96c73](https://github.com/Cryptoking28/monisagent/commit/8f96c734862d42f459dd4de8ed9d498ef7d693de))

#### Documentation

* Fixed typos in API jsdoc ([#2287](https://github.com/Cryptoking28/monisagent/pull/2287)) ([7b3c8d1](https://github.com/Cryptoking28/monisagent/commit/7b3c8d1445ea9876b36eda31d979dac9b65dad14))
* Updated compatibility report ([#2285](https://github.com/Cryptoking28/monisagent/pull/2285)) ([b1b5e3e](https://github.com/Cryptoking28/monisagent/commit/b1b5e3e54074cc8b535927f4edad07925618260c))

#### Miscellaneous chores

* Added a missing library we instrument to be picked up by the compatibility report ([#2261](https://github.com/Cryptoking28/monisagent/pull/2261)) ([6c964b2](https://github.com/Cryptoking28/monisagent/commit/6c964b2029874353908486228113a468959b1597))
* Added a script that generates Dashboard json for reporting on libraries by version ([#2267](https://github.com/Cryptoking28/monisagent/pull/2267)) ([d2877c1](https://github.com/Cryptoking28/monisagent/commit/d2877c17c7c2f4432b2ce4056c94200a2e7334b2))
* Added AI support docs for automation ([#2249](https://github.com/Cryptoking28/monisagent/pull/2249)) ([e2efc1f](https://github.com/Cryptoking28/monisagent/commit/e2efc1fb202a3e87be710f352546a00df6bf6cef))
* Fixed comment about transaction_tracer.transaction_threshold ([#2258](https://github.com/Cryptoking28/monisagent/pull/2258)) ([7cd6aef](https://github.com/Cryptoking28/monisagent/commit/7cd6aef7ecc32d8647f0313b36be368bfa14a0e9))
* Made elastic versioned tests work on Node 16 ([#2284](https://github.com/Cryptoking28/monisagent/pull/2284)) ([143b475](https://github.com/Cryptoking28/monisagent/commit/143b4757c27d497a25d1b3c7fd56b32bcede619f))
* Updated docker compose configuration ([#2268](https://github.com/Cryptoking28/monisagent/pull/2268)) ([eb1cce9](https://github.com/Cryptoking28/monisagent/commit/eb1cce9143fe87eed1bdd077471942f85cf14f21))
* Updated GitHub Actions versions ([#2272](https://github.com/Cryptoking28/monisagent/pull/2272)) ([07a841b](https://github.com/Cryptoking28/monisagent/commit/07a841b9acf0a0dcb1a495c5cb0ee8f77e283fc9))
* Updated mysql tests to use MySQL 8.3 ([#2280](https://github.com/Cryptoking28/monisagent/pull/2280)) ([11e0f8c](https://github.com/Cryptoking28/monisagent/commit/11e0f8cf63a5f792419382635496a29c0286c737))
* Updated mysql2 tests to fix CI issue ([#2282](https://github.com/Cryptoking28/monisagent/pull/2282)) ([5a37971](https://github.com/Cryptoking28/monisagent/commit/5a37971b03fe8d69b39db66d97ecfc1176c42902))
* Updated versioned security agent workflow with simpler setup ([#2259](https://github.com/Cryptoking28/monisagent/pull/2259)) ([a886187](https://github.com/Cryptoking28/monisagent/commit/a886187bf1bf29d2430e38223d0215436e006540))

#### Continuous integration

* Added ability to run a build step in create release ([#2273](https://github.com/Cryptoking28/monisagent/pull/2273)) ([4c2f24c](https://github.com/Cryptoking28/monisagent/commit/4c2f24cb6e94dd05f269998eeb763196c3fac274))
* Updated security agent workflow to use large runners when available ([#2271](https://github.com/Cryptoking28/monisagent/pull/2271)) ([181ec1b](https://github.com/Cryptoking28/monisagent/commit/181ec1bfa8d420514fca3d6de6c3989e796a29db))
* Updated security agent workflow to use large runners when available ([#2270](https://github.com/Cryptoking28/monisagent/pull/2270)) ([761fcd5](https://github.com/Cryptoking28/monisagent/commit/761fcd5ca5ae32ba922d0880979dbfff97604641))

### v11.19.0 (2024-06-06)

#### Features

* Added instrumentation for `kafkajs` (enabled through a [feature flag](https://github.com/Cryptoking28/monisagent/blob/f003ee78204149c7905cb17cb4f084aeac1ba751/documentation/feature-flags.md#kakfajs_instrumentation)) ([#2237](https://github.com/Cryptoking28/monisagent/pull/2237)) ([#2244](https://github.com/Cryptoking28/monisagent/pull/2244)) ([#2236](https://github.com/Cryptoking28/monisagent/pull/2236)) ([#2236](https://github.com/Cryptoking28/monisagent/pull/2236)) ([#2251](https://github.com/Cryptoking28/monisagent/pull/2251))


#### Miscellaneous chores

* Added kafkajs instrumentation and versioned tests skeleton ([#2224](https://github.com/Cryptoking28/monisagent/pull/2224)) ([fc13916](https://github.com/Cryptoking28/monisagent/commit/fc13916b94b813d028270dfccfed292af91875fb))
* Added kafkajs to compatibility list ([#2254](https://github.com/Cryptoking28/monisagent/pull/2254)) ([f003ee7](https://github.com/Cryptoking28/monisagent/commit/f003ee78204149c7905cb17cb4f084aeac1ba751))
* Implemented DT header injection for message specs ([#2250](https://github.com/Cryptoking28/monisagent/pull/2250)) ([3e6bc6d](https://github.com/Cryptoking28/monisagent/commit/3e6bc6d5485fd6e236c6f0a58922d698c00c920f))
* Removed targets for kafka versioned tests ([#2235](https://github.com/Cryptoking28/monisagent/pull/2235)) ([838bab2](https://github.com/Cryptoking28/monisagent/commit/838bab2ff425f5acb111a19f397760ed01c1bdde))
* Updated flaky when test ([#2241](https://github.com/Cryptoking28/monisagent/pull/2241)) ([4079a0a](https://github.com/Cryptoking28/monisagent/commit/4079a0ae38e584181eec284963560341941c5dd3))
* Updated readme to remove no longer relevant information ([#2240](https://github.com/Cryptoking28/monisagent/pull/2240)) ([01fb53c](https://github.com/Cryptoking28/monisagent/commit/01fb53cfe3c7df63bc2ef03d85991edb159569a6))
* Updated versioned tests due to update in @monisagent/security-agent V1.3.0 ([#2239](https://github.com/Cryptoking28/monisagent/pull/2239)) ([982276c](https://github.com/Cryptoking28/monisagent/commit/982276cd4fca57bbf64219e846a0a93cdfb3400b))

#### Tests

* Migrated `memcached` tests to versioned tests ([#2231](https://github.com/Cryptoking28/monisagent/pull/2231)) ([0b3a928](https://github.com/Cryptoking28/monisagent/commit/0b3a9284dc5bdc7755d176739186ea3c15cde23e))
* Ported `when` and `q` integration tests to versioned tests ([#2233](https://github.com/Cryptoking28/monisagent/pull/2233)) ([9a4dddc](https://github.com/Cryptoking28/monisagent/commit/9a4dddc64ce69ea63866d1ebaf6b86b9234c99ea))
* Updated ioredis tests to assert the host metric getting created on ioredis calls ([#2230](https://github.com/Cryptoking28/monisagent/pull/2230)) ([89df06a](https://github.com/Cryptoking28/monisagent/commit/89df06a6b885f8789e68d2b8047bada61db62e24))
* Updated unit tests that were missing constructing specs at instrumentation source ([#2252](https://github.com/Cryptoking28/monisagent/pull/2252)) ([54ab238](https://github.com/Cryptoking28/monisagent/commit/54ab238436717b5a248f40374e174f1b19217a0c))

### v11.18.0 (2024-05-29)

#### Features

* Added support for redis v4 legacyMode `client.v4.<command>` ([#2200](https://github.com/Cryptoking28/monisagent/pull/2200)) ([b2284c5](https://github.com/Cryptoking28/monisagent/commit/b2284c58eb798ab00a141ce08f4072584795c728))

#### Code refactoring

* Updated `shim.recordConsume` to use `shim.record` and added ability to invoke an after hook with callback args ([#2207](https://github.com/Cryptoking28/monisagent/pull/2207)) ([4f48fc3](https://github.com/Cryptoking28/monisagent/commit/4f48fc3bbd5afce4954019620b112f600b2dfb53))

#### Documentation

* Updated compatibility report ([#2223](https://github.com/Cryptoking28/monisagent/pull/2223)) ([a256ca0](https://github.com/Cryptoking28/monisagent/commit/a256ca0f2060efe576018527d37718a041ffc925))

#### Miscellaneous chores

* Removed outdated Slack reference ([#2198](https://github.com/Cryptoking28/monisagent/pull/2198)) ([8110d42](https://github.com/Cryptoking28/monisagent/commit/8110d426f402659d44bf786fec0503ca2413ee6b))
* Removed package-lock.json ([#2208](https://github.com/Cryptoking28/monisagent/pull/2208)) ([b267695](https://github.com/Cryptoking28/monisagent/commit/b26769502b4cb38f9133f76f427ee96ce718c15b))
* Removed unused express5 feature flag ([#2197](https://github.com/Cryptoking28/monisagent/pull/2197)) ([366504b](https://github.com/Cryptoking28/monisagent/commit/366504ba1e3bfed477a37be5d61f4e30e46b690d))

#### Tests

* Updated langchain versioned tests to separate the vectorstore and other tests. This is to avoid peer resolution of `@langchain/community` package that is being used to test the elasticsearch vectorstore ([#2216](https://github.com/Cryptoking28/monisagent/pull/2216)) ([e768955](https://github.com/Cryptoking28/monisagent/commit/e7689554aec2a038d5b80c54d4b6b603075856ac))
* Fixed aws-sdk-v3 bedrock tests ([#2211](https://github.com/Cryptoking28/monisagent/pull/2211)) ([050469e](https://github.com/Cryptoking28/monisagent/commit/050469ecc59ccc9ba6a6e78527ac392f262ff939))
* Fixed aws-sdk-v3 bedrock tests (again) ([#2212](https://github.com/Cryptoking28/monisagent/pull/2212)) ([330cc4b](https://github.com/Cryptoking28/monisagent/commit/330cc4b6ff8e3777b1dfa0fda7f5b4c5b20005af))

#### Continuous integration

* Updated the langchain vectorstore test to reference the correct version of `@langchain/core` getting tested ([#2202](https://github.com/Cryptoking28/monisagent/pull/2202)) ([ed81852](https://github.com/Cryptoking28/monisagent/commit/ed81852a4b3c582a54c0d274ba9d5887041ebeef))
* Added updating of docs site with compatibility table ([#2205](https://github.com/Cryptoking28/monisagent/pull/2205)) ([c28a938](https://github.com/Cryptoking28/monisagent/commit/c28a9387f68feb8fa59d4134828662b3babeb9d0))
* Fixed CI jobs ([#2215](https://github.com/Cryptoking28/monisagent/pull/2215)) ([8b030fb](https://github.com/Cryptoking28/monisagent/commit/8b030fbf479cd348e9b75544bc753c1d618bfca7))
* Fixed should-run CI step ([#2214](https://github.com/Cryptoking28/monisagent/pull/2214)) ([d0a481d](https://github.com/Cryptoking28/monisagent/commit/d0a481d4b58706c4793fa12fa7706091eaffa0a4))

### v11.17.0 (2024-05-15)

#### Features

* Added otel compliant `server.address`, `server.port`, and `http.request.method` to external http spans ([#2169](https://github.com/Cryptoking28/monisagent/pull/2169)) ([b0a3e6d](https://github.com/Cryptoking28/monisagent/commit/b0a3e6def7d1ffc1d033842c58eb71979ab208eb))
* Added otel compliant `db.system`, `server.address`, and `server.port` attributes to database spans ([#2173](https://github.com/Cryptoking28/monisagent/pull/2173)) ([3fdcab4](https://github.com/Cryptoking28/monisagent/commit/3fdcab42196e5c870fd5dddd136daa9b01e9617d))

#### Bug fixes

* Added support for AWS API Gateway v2 payloads ([#2191](https://github.com/Cryptoking28/monisagent/pull/2191)) ([0ccdc6a](https://github.com/Cryptoking28/monisagent/commit/0ccdc6ada757291dc020feb88bf30addb7a4f47b))

#### Code refactoring

* Updated instrumentation for http, undici, grpc to use a new `segment.captureExternalAttributes` to centralize the necessary data needed to create segment and span attributes ([#2179](https://github.com/Cryptoking28/monisagent/pull/2179)) ([ddb6356](https://github.com/Cryptoking28/monisagent/commit/ddb6356528ca3d8ec8433512c2f44263d29452c2))

#### Documentation

* Updated compatibility report ([#2185](https://github.com/Cryptoking28/monisagent/pull/2185)) ([eb986c9](https://github.com/Cryptoking28/monisagent/commit/eb986c9c97f938bbb50ad2dfb70c5d7f97261249))

#### Miscellaneous chores

* Added workflow for generating compatibility doc ([#2183](https://github.com/Cryptoking28/monisagent/pull/2183)) ([9b1d5cb](https://github.com/Cryptoking28/monisagent/commit/9b1d5cbd82bb8df98ebccf98e068989b35c9964d))
* Fixed conditionals in CI workflow ([#2188](https://github.com/Cryptoking28/monisagent/pull/2188)) ([6b733c0](https://github.com/Cryptoking28/monisagent/commit/6b733c0fff3b8ed9d25bdb3b95d48580d2c81686))
* Fixed superagent versioned tests ([#2190](https://github.com/Cryptoking28/monisagent/pull/2190)) ([297bc01](https://github.com/Cryptoking28/monisagent/commit/297bc0107bcd2f79d65acb8871ccd1322b056a99))
* Made pre-commit hook require dependency changes ([#2172](https://github.com/Cryptoking28/monisagent/pull/2172)) ([e7bd356](https://github.com/Cryptoking28/monisagent/commit/e7bd356b84e8b526825fd84bf04017928cc53e4a))
* Updated CI to skip expensive actions when not needed ([#2184](https://github.com/Cryptoking28/monisagent/pull/2184)) ([8639fb9](https://github.com/Cryptoking28/monisagent/commit/8639fb90845de12076f04d58bac7aff048407a09))
* Updated validate-pr workflow ([#2186](https://github.com/Cryptoking28/monisagent/pull/2186)) ([6ff4497](https://github.com/Cryptoking28/monisagent/commit/6ff4497fd3857259d2cb2c6e0dac009df7a6e582))

#### Continuous integration

* Updated minimum version of lib-dynamo to work around peer dependency resolution ([#2174](https://github.com/Cryptoking28/monisagent/pull/2174)) ([7ddf2c9](https://github.com/Cryptoking28/monisagent/commit/7ddf2c9473be180151e64f9b35beb6c5593883c5))

### v11.16.0 (2024-04-29)

#### Features

* Added API `ignoreApdex` to ignore calculating apdex for the active transaction ([#2166](https://github.com/Cryptoking28/monisagent/pull/2166)) ([cb21d2c](https://github.com/Cryptoking28/monisagent/commit/cb21d2c95e5bb0de7e16535ecd4b2f5a77dc6fb7))

#### Bug fixes

* Fixed issue with CJS being imported as ESM ([#2168](https://github.com/Cryptoking28/monisagent/pull/2168)) ([9a14cb0](https://github.com/Cryptoking28/monisagent/commit/9a14cb02dce5bfbe7830aaa25d71edb38447250b))

#### Security improvements

* **deps:** bump formidable and superagent ([#2162](https://github.com/Cryptoking28/monisagent/pull/2162)) ([260f16b](https://github.com/Cryptoking28/monisagent/commit/260f16bba6822cfadbf8648bba38a1013b2d19de))

#### Documentation

* Fixed images in markdown tutorials ([#2153](https://github.com/Cryptoking28/monisagent/pull/2153)) ([ef14948](https://github.com/Cryptoking28/monisagent/commit/ef14948a0068e21d7c5aa569b8f2862f07a7f941))
* Includes api.js in jsdoc generation ([#2139](https://github.com/Cryptoking28/monisagent/pull/2139)) ([3883348](https://github.com/Cryptoking28/monisagent/commit/3883348bd0aab54efdbb5e876a4e4c867f5df2e3))

#### Miscellaneous chores

* Migrated @monisagent/superagent into agent repo ([#2141](https://github.com/Cryptoking28/monisagent/pull/2141))
* Migrated @monisagent/aws-sdk into agent repo ([#2161](https://github.com/Cryptoking28/monisagent/pull/2161)) ([a9eb593](https://github.com/Cryptoking28/monisagent/commit/a9eb593c1a6b44b770de92c1b2ca2acdf8e2f222))
* Migrated @monisagent/koa into mainline agent repo ([#2148](https://github.com/Cryptoking28/monisagent/pull/2148)) ([33af646](https://github.com/Cryptoking28/monisagent/commit/33af646878994d7f12d3cb42680e21410b34322f))
* Removed repetitive cache busting ([#2160](https://github.com/Cryptoking28/monisagent/pull/2160)) ([5ac870e](https://github.com/Cryptoking28/monisagent/commit/5ac870e7a75ba791060dfaffd49cfa400d60e910))
* Updated instrumentation to use type constants instead of raw strings ([#2165](https://github.com/Cryptoking28/monisagent/pull/2165)) ([c5b42cd](https://github.com/Cryptoking28/monisagent/commit/c5b42cd7b2df6bb1054a589ad666890550a01d43))
* Updated versioned tests readme ([#2159](https://github.com/Cryptoking28/monisagent/pull/2159)) ([a957304](https://github.com/Cryptoking28/monisagent/commit/a9573041f44462d6ccb287f7dccf672f54b0d7b3))
* Updated versioned tests to support upcoming tooling ([#2147](https://github.com/Cryptoking28/monisagent/pull/2147)) ([38e47d9](https://github.com/Cryptoking28/monisagent/commit/38e47d9d7ffadbea3103c77686e031c4cf954d2c))
* Updated versioned tests to use quiet output mode ([#2145](https://github.com/Cryptoking28/monisagent/pull/2145)) ([63a5ddc](https://github.com/Cryptoking28/monisagent/commit/63a5ddcb6c0040918189db17ee236007dba9f993))

### v11.15.0 (2024-04-09)

#### Bug fixes

* Fixed instrumenting the same module installed in different locations ([#2104](https://github.com/Cryptoking28/monisagent/pull/2104)) ([88bdace](https://github.com/Cryptoking28/monisagent/commit/88bdace6489c7d258ed3200f1550367f35824bc1))

#### Code refactoring

* **mongodb:** Removed instrumentation that handles connecting via unix domain socket. ([#2129](https://github.com/Cryptoking28/monisagent/pull/2129)) ([808323f](https://github.com/Cryptoking28/monisagent/commit/808323f0832952870fd1e94474b3fd3e0ab1b8c4))
* Updated shim classes to no longer construct specs. ([#2096](https://github.com/Cryptoking28/monisagent/pull/2096)) ([158c295](https://github.com/Cryptoking28/monisagent/commit/158c29566f6a5993ec77f84aeaa266ceab0bf4f0))

#### Miscellaneous chores

* **deps-dev:** Bumped express from 4.18.2 to 4.19.2 ([#2101](https://github.com/Cryptoking28/monisagent/pull/2101)) ([639cb78](https://github.com/Cryptoking28/monisagent/commit/639cb785dff7568ad227091512013c2dfb81e5f9))
* **deps:** Updated @monisagent/security-agent to v1.1.1 ([#2092](https://github.com/Cryptoking28/monisagent/pull/2092)) ([3272aa3](https://github.com/Cryptoking28/monisagent/commit/3272aa3da2260ce18c71c24608ffdda512ca6817))
* Fixed incorrect pinning of @elastic/transport ([#2120](https://github.com/Cryptoking28/monisagent/pull/2120)) ([7b5bdaa](https://github.com/Cryptoking28/monisagent/commit/7b5bdaac1b1081636636cd7ca7c6b484f5251f76))
* Removed scrollbar styling in generated API docs ([#2091](https://github.com/Cryptoking28/monisagent/pull/2091)) ([cb0fa11](https://github.com/Cryptoking28/monisagent/commit/cb0fa11c81290bb93cb30e974fdb1ece82a1e80e))
* Removed transaction_id and legacy token count attributes from llm events for openai and langchain ([#2093](https://github.com/Cryptoking28/monisagent/pull/2093)) ([df2a0fd](https://github.com/Cryptoking28/monisagent/commit/df2a0fd7c99a7bbf024c1e33c7fdff512b45c970))

#### Tests

* Updated test/integration/core/dns reverse test to remove flakiness ([#2121](https://github.com/Cryptoking28/monisagent/pull/2121)) ([c32cb27](https://github.com/Cryptoking28/monisagent/commit/c32cb2739ece3adcf5bd42e646071b3f59e691ba))
* Updated elastic tests to skip broken version ([#2119](https://github.com/Cryptoking28/monisagent/pull/2119)) ([5d0d1bb](https://github.com/Cryptoking28/monisagent/commit/5d0d1bb4994b41d43ab9b4eb110fea036ac307bc))

#### Continuous integration

* Removed usage of `use_new_release` from prepare release workflow ([#2124](https://github.com/Cryptoking28/monisagent/pull/2124)) ([007ddb4](https://github.com/Cryptoking28/monisagent/commit/007ddb4dce6cf5ab463a1868fe4cfa203d3e9ff2))
* Updated `prepare-release.js` to not require changelog.json ([#2106](https://github.com/Cryptoking28/monisagent/pull/2106)) ([328a570](https://github.com/Cryptoking28/monisagent/commit/328a570bbe9f359d23a21317ccd8a8bc52b473b4))
* Updated prepare release to provide a drop down for release type ([#2133](https://github.com/Cryptoking28/monisagent/pull/2133)) ([846269b](https://github.com/Cryptoking28/monisagent/commit/846269bb256f287c5fb9be32bdb62e9786e3cfe4))
* Updated versioned security agent workflow ([#2100](https://github.com/Cryptoking28/monisagent/pull/2100)) ([f787b15](https://github.com/Cryptoking28/monisagent/commit/f787b15f94c416d547af1ab4b2d7c31665b417b7))
* Fixed typo in constant name for prepare release script ([#2094](https://github.com/Cryptoking28/monisagent/pull/2094)) ([3b887d9](https://github.com/Cryptoking28/monisagent/commit/3b887d96c70a2cc5e3833cdc8b65de99b643f7a1))

### v11.14.0 (2024-03-20)

#### Features

* Added `guid` attribute to `TransactionError` events ([#2079](https://github.com/Cryptoking28/monisagent/pull/2079)) ([3468fb1](https://github.com/Cryptoking28/monisagent/commit/3468fb14635b10c30a9a814dc0d084aeacfd9e10))
* Added instrumentation for `initializeUnorderedBulkOp`, and `initializeOrderedBulkOp` in mongodb 4+ ([#2086](https://github.com/Cryptoking28/monisagent/pull/2086)) ([666ae6e](https://github.com/Cryptoking28/monisagent/commit/666ae6ea4be8167748e31fe9b1d086aee5d0135d))
* Added support for Mongo v5+ ([#2085](https://github.com/Cryptoking28/monisagent/pull/2085)) ([00f6feb](https://github.com/Cryptoking28/monisagent/commit/00f6febb4893ed2abe902644514af3ab629cdbc1))

#### Security improvements

* **deps:** bump follow-redirects from 1.15.5 to 1.15.6 ([#2078](https://github.com/Cryptoking28/monisagent/pull/2078)) ([aa86482](https://github.com/Cryptoking28/monisagent/commit/aa86482738ba6b17bf6c2c7362931a3ad57736dd))

#### Documentation

* Changed bug bounty URL ([#2081](https://github.com/Cryptoking28/monisagent/pull/2081)) ([f4586d7](https://github.com/Cryptoking28/monisagent/commit/f4586d71cbe9c886181fbfe4b414cf0f9d630873))

#### Miscellaneous chores

* Added instrumentation tracking class ([#2084](https://github.com/Cryptoking28/monisagent/pull/2084)) ([07d7e7d](https://github.com/Cryptoking28/monisagent/commit/07d7e7d50edf9cd8a1cd1b465b24bc589409c5dc))
* **deps:** pin @monisagent/security-agent to 1.0.1 ([#2089](https://github.com/Cryptoking28/monisagent/pull/2089)) ([e133c76](https://github.com/Cryptoking28/monisagent/commit/e133c76a34f7d2af16610f00958651a6cff8824d))
...
* Added AI Monitoring(AIM) for OpenAI, Amazon Bedrock, and Langchain.
  ...
  * **Note**: Enabling [high-security mode](https://docs.monisagent.com/docs/apm/agents/manage-apm-agents/configuration/high-security-mode/) will disable the AIM instrumentation and events. 
* Added instrumentation for VectorStore.similaritySearch for langchain.js ([#2049](https://github.com/Cryptoking28/monisagent/pull/2049)) ([3c50606](https://github.com/Cryptoking28/monisagent/commit/3c50606a57a8dc18c91fe36e3b180bafd15a4cbc))
* Added setLlmTokenCountCallback API endpoint to register a callback for calculating token count when none is provided ([#2065](https://github.com/Cryptoking28/monisagent/pull/2065)) ([d2faf1a](https://github.com/Cryptoking28/monisagent/commit/d2faf1a4942aacefd8b92e0bc2dc11bd8b687328))
* Added token_count to LlmEmbedding and LlmChatCompletionMessage for openai ([#2061](https://github.com/Cryptoking28/monisagent/pull/2061)) ([47a925e](https://github.com/Cryptoking28/monisagent/commit/47a925eccce8e5b5d682b46277bbef5191f8b553))
* Added tool_id to langchain error event ([#2064](https://github.com/Cryptoking28/monisagent/pull/2064)) ([793abe8](https://github.com/Cryptoking28/monisagent/commit/793abe8c9854b80fb1cf42f839a7db6a646cdc0b))

#### Miscellaneous chores

* Added flag for verbosity during docs publishing ([#2060](https://github.com/Cryptoking28/monisagent/pull/2060)) ([fe0d41a](https://github.com/Cryptoking28/monisagent/commit/fe0d41a86cba8da6173f5935e61c62b7dca75344))
* Added some delays to docs publishing ([#2062](https://github.com/Cryptoking28/monisagent/pull/2062)) ([a602fd4](https://github.com/Cryptoking28/monisagent/commit/a602fd48e929437e4bc933c4ce276989013c53f1))
* Changed casing of OpenAI in vendor property ([#2068](https://github.com/Cryptoking28/monisagent/pull/2068)) ([64b4ca2](https://github.com/Cryptoking28/monisagent/commit/64b4ca2750c9de8d9028fef515c15019e358a5d9))
* Changed token_count to only use tokenCountCallback ([#2070](https://github.com/Cryptoking28/monisagent/pull/2070)) ([66f94b0](https://github.com/Cryptoking28/monisagent/commit/66f94b05aa7018af6fa1db1d2d87de9013f23a5b))
* Removed langchain_instrumentation feature flag as the instrumentation is feature complete ([#2073](https://github.com/Cryptoking28/monisagent/pull/2073)) ([925a463](https://github.com/Cryptoking28/monisagent/commit/925a463c708b29c78567aecf78ac89ac226b7995))
* updated @monisagent/aws-sdk and @monisagent/koa to latest ([#2074](https://github.com/Cryptoking28/monisagent/pull/2074)) ([0747ca4](https://github.com/Cryptoking28/monisagent/commit/0747ca4f0f6615e1fbfcc734a36059960facf23e))

### v11.12.0 (2024-03-04)

#### Features

* Added instrumentation for `chain.stream` for langchain js. ([#2052](https://github.com/Cryptoking28/monisagent/pull/2052)) ([03abfce](https://github.com/Cryptoking28/monisagent/commit/03abfce666d3c48abd0994c44817bb5cbe8655a9))

#### Miscellaneous chores

* Added @azure/openai and @langchain/community/llms/bedrock as tracking packages so we can measure usage with angler ([#2053](https://github.com/Cryptoking28/monisagent/pull/2053)) ([4830ea3](https://github.com/Cryptoking28/monisagent/commit/4830ea3285726f8cc8fb60820c4cf2d3790e5250))

#### Tests

* Updated aws-sdk branch to main as the necessary code was merged. ([#2051](https://github.com/Cryptoking28/monisagent/pull/2051)) ([1e52a5c](https://github.com/Cryptoking28/monisagent/commit/1e52a5cd7a8acc8970dbdc6b1bf774c06aa6f5fb))

### v11.11.0 (2024-02-27)

#### Features

* Added instrumentation for RunnableSequence ([#1996](https://github.com/Cryptoking28/monisagent/pull/1996)) ([71ffa37](https://github.com/Cryptoking28/monisagent/commit/71ffa373e01d27be4d3ad40464facc8a33f4aeb2))

* Added LangChain error events capture ([#2040](https://github.com/Cryptoking28/monisagent/pull/2040)) ([4d0d839](https://github.com/Cryptoking28/monisagent/commit/4d0d8396ac3c19dee9d14477d8b408efaae3c24f))

* Added `ai_monitoring.streaming.enabled`. When set to `false` this will not instrument chat completion streams, thus it will not create relevant Llm events. ([#2021](https://github.com/Cryptoking28/monisagent/pull/2021)) ([ff78b51](https://github.com/Cryptoking28/monisagent/commit/ff78b514d0afe8127a094ce810f164b08768bcac))
* Added ability to recordLlmFeedbackEvent by traceId ([#2043](https://github.com/Cryptoking28/monisagent/pull/2043)) ([b0a4ed1](https://github.com/Cryptoking28/monisagent/commit/b0a4ed10ad7d6e021727d6d5e4746292e7a34ea1))
* Added instrumentation for langchain tools. ([#2009](https://github.com/Cryptoking28/monisagent/pull/2009)) ([695d10e](https://github.com/Cryptoking28/monisagent/commit/695d10e28ee6cbeba252299d7d94c9660137d293))

#### Code refactoring

* Updated AIM instrumentation ([#2015](https://github.com/Cryptoking28/monisagent/pull/2015)) ([d37d2a8](https://github.com/Cryptoking28/monisagent/commit/d37d2a88a4754c23ee039955c5839d8b7d35f875))
...
* Updated capturing conversation_id on Llm Events as `llm.conversation_id` ([#2020](https://github.com/Cryptoking28/monisagent/pull/2020)) ([5f93f65](https://github.com/Cryptoking28/monisagent/commit/5f93f6571eeb38740d8f3cb59f7706d9cb07c67a))
* Updated instrumentation to construct specs at source instead of within the shim methods ([#2035](https://github.com/Cryptoking28/monisagent/pull/2035)) ([ead8c25](https://github.com/Cryptoking28/monisagent/commit/ead8c25e851d49b199cf808529e6483b2a3f024d))
...
* Added note about using sudo for firewall script ([#2032](https://github.com/Cryptoking28/monisagent/pull/2032)) ([bf106d2](https://github.com/Cryptoking28/monisagent/commit/bf106d2a8a84d86443765a27d031233993cbd788))

* Fixed spec objects parameter definitions ([#2024](https://github.com/Cryptoking28/monisagent/pull/2024)) ([4378173](https://github.com/Cryptoking28/monisagent/commit/4378173b19cd1a7c92c38d6d9d7c6ad22d823fe5))


#### Miscellaneous chores

* Added missing is_response to LangChain completion messages ([#2044](https://github.com/Cryptoking28/monisagent/pull/2044)) ([20c7d47](https://github.com/Cryptoking28/monisagent/commit/20c7d473e318d50854ab8fefcc92d0b7a3b95b64))

* Attached specs to the `Shim.prototype` for use in custom instrumentation and instrumentation outside of the agent ([#2038](https://github.com/Cryptoking28/monisagent/pull/2038)) ([2c97488](https://github.com/Cryptoking28/monisagent/commit/2c974887068b7cc522eb29dd781481bb1583bde7))
* **deps:** Updated to use @monisagent/ritm from require-in-the-middle ([#2034](https://github.com/Cryptoking28/monisagent/pull/2034)) ([ffb729f](https://github.com/Cryptoking28/monisagent/commit/ffb729f1e9389e7a3d495b09df913eb3b5b43c3f))
* Updated DatastoreParameters to include collection ([#2039](https://github.com/Cryptoking28/monisagent/pull/2039)) ([b9c73ca](https://github.com/Cryptoking28/monisagent/commit/b9c73ca482d13d26f2bf54c22cd3ab4f77f413ca))

#### Tests

* Cleaned up pending mocks in the log dropping test to avoid a console warning around pending mocks in after each ([#2017](https://github.com/Cryptoking28/monisagent/pull/2017)) ([d2f40c2](https://github.com/Cryptoking28/monisagent/commit/d2f40c2e67c5bff826d0234412eacdfff70a2fd7))

### v11.10.4 (2024-02-13)

#### Bug fixes

* Resolved application logs getting blocked when an excessive payload is encountered ([#2013](https://github.com/Cryptoking28/monisagent/pull/2013)) ([365ded4](https://github.com/Cryptoking28/monisagent/commit/365ded432b7781ee9c896bf0e067dac8cc2c45cc))
* Updated Shim to properly calculate the `_moduleRoot` on windows environments ([#2014](https://github.com/Cryptoking28/monisagent/pull/2014)) ([ab0bd7f](https://github.com/Cryptoking28/monisagent/commit/ab0bd7f87a5ed6ea38f51f068a2fc066af8f8d74))

#### Code refactoring

* Abstracted registering of new aggregators into a Harvester class that is responsible for starting, stopping, updating all registered aggregators. ([#1994](https://github.com/Cryptoking28/monisagent/pull/1994)) ([1fb85a6](https://github.com/Cryptoking28/monisagent/commit/1fb85a6f97c522ce2951911c670fcbddaa218049))
* Refactored specs into classes for easier code navigation ([#2004](https://github.com/Cryptoking28/monisagent/pull/2004)) ([4daedc0](https://github.com/Cryptoking28/monisagent/commit/4daedc08c707bec22056466ef15a45b50f20026f))

#### Miscellaneous chores

* **deps:** Updated @monisagent/security agent to v1.0.1 ([#2002](https://github.com/Cryptoking28/monisagent/pull/2002)) ([b460c7b](https://github.com/Cryptoking28/monisagent/commit/b460c7be589dd6fa801285b756bf66f62e0f10aa))

#### Tests

* Updated smoke tests to send data to the appropriate collector method ([#2005](https://github.com/Cryptoking28/monisagent/pull/2005)) ([6130486](https://github.com/Cryptoking28/monisagent/commit/6130486514268b02f68dccceb9b1e29d1e99c78e))

### v11.10.3 (2024-02-07)

#### Features

* Added feature flag for LangChain instrumentation ([#1990](https://github.com/Cryptoking28/monisagent/pull/1990)) ([ab04e7a](https://github.com/Cryptoking28/monisagent/commit/ab04e7a80b3aa7d669786d469ba256d009a195e6))
* Added message entities for LangChain ([#1983](https://github.com/Cryptoking28/monisagent/pull/1983)) ([6b44a3a](https://github.com/Cryptoking28/monisagent/commit/6b44a3ab84690acce71ade9364cb3634b7d42614))
* Added vectorsearch entities ([#1992](https://github.com/Cryptoking28/monisagent/pull/1992)) ([ef74b2e](https://github.com/Cryptoking28/monisagent/commit/ef74b2e4426c625e43cadcb4a84e4c389ae06577))

#### Bug fixes

* Updated grpc-js instrumentation to properly track errors and end transactions ([#2001](https://github.com/Cryptoking28/monisagent/pull/2001)) ([fda1346](https://github.com/Cryptoking28/monisagent/commit/fda134623522e9fde9dccb7606d4a2da89adf511))

#### Documentation

* Removed documentation around aws_bedrock_instrumentation as feature flag has been removed ([#1991](https://github.com/Cryptoking28/monisagent/pull/1991)) ([f414564](https://github.com/Cryptoking28/monisagent/commit/f414564738ab3ad8df207f96a857f27309d01f0b))

#### Miscellaneous chores

* Fixed third party notices and package-lock as they were out of sync. ([#1999](https://github.com/Cryptoking28/monisagent/pull/1999)) ([a89def8](https://github.com/Cryptoking28/monisagent/commit/a89def89f5cd7fec29c6466e15740f0f157da9b5))

#### Tests

* Updated prisma versioned test range to skip 5.9.0 as it was broken ([#1993](https://github.com/Cryptoking28/monisagent/pull/1993)) ([d885286](https://github.com/Cryptoking28/monisagent/commit/d8852867282dc79ea495cac8c414485ee91e7cd1))

### v11.10.2 (2024-01-31)

#### Bug fixes

* Updated winston instrumentation to wrap configure to properly retain our transporter to do log forwarding ([#1987](https://github.com/Cryptoking28/monisagent/pull/1987)) ([b54a97f](https://github.com/Cryptoking28/monisagent/commit/b54a97fc1be26a562e1fa5b80428d103d25cfdf9))

#### Documentation

* Fixed jsdoc generation by marking private methods as [@private](https://github.com/private) ([#1976](https://github.com/Cryptoking28/monisagent/pull/1976)) ([f33c0cc](https://github.com/Cryptoking28/monisagent/commit/f33c0cc0764747b808d4b9c1ab8cfbfdd41f2269))

#### Miscellaneous chores

* Update eslint config ([#1980](https://github.com/Cryptoking28/monisagent/pull/1980)) ([8991a15](https://github.com/Cryptoking28/monisagent/commit/8991a150078a54ae0988a1c9d3a192b9d165d614))

#### Tests

* Pinned prisma instrumentation testing to <5.9.0 until we can fix issues with instrumentation ([#1985](https://github.com/Cryptoking28/monisagent/pull/1985)) ([5eae6ee](https://github.com/Cryptoking28/monisagent/commit/5eae6ee3c4b3bd7bded3143a811461d67c4b8a3d))
...
* Updated instrumentation registration to allow for instrumenting of a local file that does not exist within node_modules. 
  * To properly instrument a local file, you must pass in `absolutePath` with the absolute path to the file that is being instrumented along with the `moduleName` which in this case is just the file name without the extension. ([#1974](https://github.com/Cryptoking28/monisagent/pull/1974)) ([f545b4e](https://github.com/Cryptoking28/monisagent/commit/f545b4ebc3394f0a7179a51e156c6df28896edf0))

### v11.10.0 (2024-01-22)

#### Features

* Added llm attribute to all transactions that contain llm spans for openai ([#1946](https://github.com/Cryptoking28/monisagent/pull/1946)) ([6312629](https://github.com/Cryptoking28/monisagent/commit/6312629326c02fe3de4db91ee293eb71b7ddd042))
* Added transaction ID to ErrorTrace event ([#1954](https://github.com/Cryptoking28/monisagent/pull/1954)) ([5d0ebcd](https://github.com/Cryptoking28/monisagent/commit/5d0ebcd216cb60b3a488b2b5f7c20f71f8d5bbeb))

#### Security improvements

* **remote_method:** Redacted ingest key in trace level logs ([#1948](https://github.com/Cryptoking28/monisagent/pull/1948)) ([04fee88](https://github.com/Cryptoking28/monisagent/commit/04fee886bd2f479e568830ea03217d7c9aba87d9))

#### Code refactoring

* Updated `lib/shim/shim.js` to remove cognitive complexity violations ([#1950](https://github.com/Cryptoking28/monisagent/pull/1950)) ([60e57a1](https://github.com/Cryptoking28/monisagent/commit/60e57a10f038c1e70dfef2937592983b2bfd5613))
* Updated message-shim to remove cognitive complexity violations. ([#1958](https://github.com/Cryptoking28/monisagent/pull/1958)) ([3d1caaf](https://github.com/Cryptoking28/monisagent/commit/3d1caaf7d7f7de1c2e139eb7943f557b896fc1e2))

#### Miscellaneous chores

* **deps:** Updated @monisagent/aws-sdk to latest and removed aws_bedrock_instrumentation feature flag ([#1956](https://github.com/Cryptoking28/monisagent/pull/1956)) ([9eae28c](https://github.com/Cryptoking28/monisagent/commit/9eae28c7ca06f9287fe09a2d51ad61534d9e8b1d))
* **deps:** Updated @monisagent/security-agent to v0.7.0 ([#1955](https://github.com/Cryptoking28/monisagent/pull/1955)) ([e156539](https://github.com/Cryptoking28/monisagent/commit/e15653916f4614e17501202f6831459a8104e7a7))
* Migrated non-sensitive CI values to vars ([#1957](https://github.com/Cryptoking28/monisagent/pull/1957)) ([1739378](https://github.com/Cryptoking28/monisagent/commit/17393782a278fd3c3289332c78a88a5d6819be7c))
* updated contributors list to include james and svetlana 🎉 ([#1947](https://github.com/Cryptoking28/monisagent/pull/1947)) ([33a59fd](https://github.com/Cryptoking28/monisagent/commit/33a59fdcdeb3e4074b4611d88e2fe79a65168fe3))

### v11.9.0 (2024-01-10)

#### Features

* Assign pkgVersion and id of all child shim instances when using shim.makeSpecializedShim with a ConglomerateShim instance ([#1941](https://github.com/Cryptoking28/monisagent/pull/1941)) ([d3e393d](https://github.com/Cryptoking28/monisagent/commit/d3e393da4ece46853b01f88878d487a1336634bf))

#### Bug fixes

* Dropped support for ElasticSearch < 7.16.0 ([#1940](https://github.com/Cryptoking28/monisagent/pull/1940)) ([e017768](https://github.com/Cryptoking28/monisagent/commit/e017768466c9ca80b16cf1b51155801c3ecf0cc4))
    * Previously, Monis Agent's Node Agent instrumented ElasticSearch as early as v7.13.0, which was susceptible to crashing when using ElasticSearch's `.helper` API. ElasticSearch [fixed this bug in v7.16.0](https://github.com/elastic/elasticsearch-js/pull/1594), so we now support instrumentation from that version onward, and previous versions are noops.  
* Removed extra / in openai framework metric name ([#1938](https://github.com/Cryptoking28/monisagent/pull/1938)) ([7f586c3](https://github.com/Cryptoking28/monisagent/commit/7f586c36f6fc119f4dac6e075468d90d43ff07fe))

#### Security improvements

* **deps:** bump follow-redirects from 1.15.2 to 1.15.4 ([#1942](https://github.com/Cryptoking28/monisagent/pull/1942)) ([c1b04b6](https://github.com/Cryptoking28/monisagent/commit/c1b04b69ce15173c88517b4baf920546e187ba07))

#### Miscellaneous chores

* Removed assigning unused metadata to LLM events ([#1932](https://github.com/Cryptoking28/monisagent/pull/1932)) ([2f67d49](https://github.com/Cryptoking28/monisagent/commit/2f67d496557d6192835e4b4b9cced8b7a2d932c0))

#### Tests

* Fix DNS lookup in remote-method test ([#1937](https://github.com/Cryptoking28/monisagent/pull/1937)) ([4da2149](https://github.com/Cryptoking28/monisagent/commit/4da2149f3c48137bc3a5005ff12d29b0c8bee1d7))
* removed console log ([#1939](https://github.com/Cryptoking28/monisagent/pull/1939)) ([7d378aa](https://github.com/Cryptoking28/monisagent/commit/7d378aa9ba7b0e529dc0da24b2ee767735631b16))
* updated abort controller test expected error message based on undici version ([#1935](https://github.com/Cryptoking28/monisagent/pull/1935)) ([3e79cc7](https://github.com/Cryptoking28/monisagent/commit/3e79cc77c8d10f84de71cf9a20c0c4f0642b7450))
* updated chat-completions tests to properly assert segments ([#1931](https://github.com/Cryptoking28/monisagent/pull/1931)) ([10762a7](https://github.com/Cryptoking28/monisagent/commit/10762a7c2c884c459af76d1877cd57641e572678))

### v11.8.0 (2024-01-03)

#### Features

* Removed `api.setLlmMetadata` ([#1918](https://github.com/Cryptoking28/monisagent/pull/1918)) ([cc4a975](https://github.com/Cryptoking28/monisagent/commit/cc4a975a3f020648d183ce620e244ba0a09c286d))
...
* Ensure opts.headers is defined in http instrumentation ([#1926](https://github.com/Cryptoking28/monisagent/pull/1926)) ([7ea31a3](https://github.com/Cryptoking28/monisagent/commit/7ea31a3c3ff45567cf102da6bbec4b9e68af9602))

#### Code refactoring

* Updated `lib/instrumentation/core/http.js` to reduce the cognitive complexity to an allowable value ([#1922](https://github.com/Cryptoking28/monisagent/pull/1922)) ([4c30d97](https://github.com/Cryptoking28/monisagent/commit/4c30d977ca74421cfa396c2f86383212e40475e1))
* Updated `lib/shim/promise-shim.js` to reduce the cognitive complexity ([#1924](https://github.com/Cryptoking28/monisagent/pull/1924)) ([bd0a5dc](https://github.com/Cryptoking28/monisagent/commit/bd0a5dc95c8077794c30c5ebe25f0e153aefb1b4))
* Updated `lib/shim/webframework-shim.js` to reduce the cognitive complexity ([#1927](https://github.com/Cryptoking28/monisagent/pull/1927)) ([1ce371e](https://github.com/Cryptoking28/monisagent/commit/1ce371e69fd8db7306137c749b9e5486aaacd434))

#### Miscellaneous chores

* **deps:** Updated @monisagent/security-agent to v0.6.0 ([#1929](https://github.com/Cryptoking28/monisagent/pull/1929)) ([4e09927](https://github.com/Cryptoking28/monisagent/commit/4e0992709f8bd07b941a8c7adf0aa51481b0282e))

#### Tests

* Refactored tests that were still using the tap mocha shim + chai to now use tap. ([#1919](https://github.com/Cryptoking28/monisagent/pull/1919)) ([957529e](https://github.com/Cryptoking28/monisagent/commit/957529e901115a16ed31c4663e460e4044d9a09d))
* removed access to deprecated `req._headers` and instead use `req.headers` ([#1923](https://github.com/Cryptoking28/monisagent/pull/1923)) ([0ec2f66](https://github.com/Cryptoking28/monisagent/commit/0ec2f6669bf90e54af8eddad7b42aa029a7ef517))
* updated the cross agent tests, made updates to tests based on fixture changes ([#1917](https://github.com/Cryptoking28/monisagent/pull/1917)) ([2d666b6](https://github.com/Cryptoking28/monisagent/commit/2d666b6e47d6ad7ecf14aa832a6ae1fbd15ee973))
* Updated `helper.randomPort` to use `crypto.randomInt` instead of `Math.random` by using crypto lib ([#1921](https://github.com/Cryptoking28/monisagent/pull/1921)) ([9003791](https://github.com/Cryptoking28/monisagent/commit/9003791e934efb7ab284406735b334bd9ae4872c))

### v11.7.0 (2023-12-14)

#### Features

* Added deserialized X-MonisAgent-Synthetics-Info header to transaction and transaction trace intrinsic attributes ([#1912](https://github.com/Cryptoking28/monisagent/pull/1912)) ([7ed64bd](https://github.com/Cryptoking28/monisagent/commit/7ed64bd1410d7eed6c4dbf153e0a67754e7bcdef))
    ...
    * It will also include the `X-MonisAgent-Synthetics-Info` header in outgoing http requests
* Added instrumentation for Restify async handlers ([#1910](https://github.com/Cryptoking28/monisagent/pull/1910)) ([1a3f87f](https://github.com/Cryptoking28/monisagent/commit/1a3f87ff10dea1c25b35c349550338f327446cb1))

#### Bug fixes

* Update import-in-the-middle to fix ESM on Node 18.19.0 ([#1906](https://github.com/Cryptoking28/monisagent/pull/1906)) ([e9c3748](https://github.com/Cryptoking28/monisagent/commit/e9c37487a606d986d3568c11a014f6397f4f379e))

#### Code refactoring

* change dynamic import to work with bundlers ([#1905](https://github.com/Cryptoking28/monisagent/pull/1905)) ([ee81429](https://github.com/Cryptoking28/monisagent/commit/ee81429f5c34491392ed79026e6f716c76e2d735))

#### Miscellaneous chores

* Add AWS Bedrock feature flag ([#1913](https://github.com/Cryptoking28/monisagent/pull/1913)) ([91019b0](https://github.com/Cryptoking28/monisagent/commit/91019b0a45dcf8399cd8eadbe4e111e72ceab512))

#### Continuous integration

* removed step in post release process to update an internal system with the latest agent version ([#1909](https://github.com/Cryptoking28/monisagent/pull/1909)) ([2080b1f](https://github.com/Cryptoking28/monisagent/commit/2080b1fe03e65a4c6aaa073e8e338835c708680d))

### v11.6.1 (2023-12-07)

#### Bug fixes

* **deps:** Updated @monisagent/aws-sdk to 7.0.3 ([#1902](https://github.com/Cryptoking28/monisagent/pull/1902)) ([bf22ae5](https://github.com/Cryptoking28/monisagent/commit/bf22ae502ee74d5071dc5578cc77c38039e68778))
* Updated shimmer to handle instrumenting named and default exports of CommonJS modules in ESM ([#1894](https://github.com/Cryptoking28/monisagent/pull/1894)) ([9f7979c](https://github.com/Cryptoking28/monisagent/commit/9f7979cd41dcb3735e553cbd4837ad455836e3ff))

#### Code refactoring

* Fixed cognitive complexity violations of openai instrumentation by moving functions outside of the parent function scope ([#1895](https://github.com/Cryptoking28/monisagent/pull/1895)) ([31dc717](https://github.com/Cryptoking28/monisagent/commit/31dc71797c4798793b1bba8ca15733482ba3e7d6))
* Updated span names of openai actions to allow AI O11y team to locate relevant spans ([#1896](https://github.com/Cryptoking28/monisagent/pull/1896)) ([b7a644d](https://github.com/Cryptoking28/monisagent/commit/b7a644d1ef56bf88171fb74868ae78d24745dd19))

#### Miscellaneous chores

* Improve OpenAI mock server streams ([#1890](https://github.com/Cryptoking28/monisagent/pull/1890)) ([d12bfe4](https://github.com/Cryptoking28/monisagent/commit/d12bfe45f2c8d01277a1f8186844f0dd3598cbd7))

#### Tests

* Fix winston-esm versioned tests ([#1898](https://github.com/Cryptoking28/monisagent/pull/1898)) ([6e02e57](https://github.com/Cryptoking28/monisagent/commit/6e02e57a2b4ed8351e39e5fb8d47e2702bcafde0))
* pin undici versioned to <6.0.0 on Node 16 ([#1900](https://github.com/Cryptoking28/monisagent/pull/1900)) ([9973b24](https://github.com/Cryptoking28/monisagent/commit/9973b24067211f5fcc06adae79e02df8f599d735))
...
* Added instrumentation for `openai`. 
  ...
  * Aside from creating spans for chat completions and embeddings, it will create custom events that drive the [Monis Agent AI Monitoring](https://monisagent.com/platform/ai-monitoring).
  * Added instrumentation for chat completion streams ([#1884](https://github.com/Cryptoking28/monisagent/pull/1884)) ([404e317](https://github.com/Cryptoking28/monisagent/commit/404e31737092fd7e6cd66b38d17507fb4375e079))
  * Added instrumentation for openai chat completion creation ([#1862](https://github.com/Cryptoking28/monisagent/pull/1862)) ([34dcd70](https://github.com/Cryptoking28/monisagent/commit/34dcd7015b379982b90716a87763576cafe9cbd1))
  * Added instrumentation for openai embedding creation ([#1872](https://github.com/Cryptoking28/monisagent/pull/1872)) ([1c62321](https://github.com/Cryptoking28/monisagent/commit/1c62321a4320a81a6a25aa064e3cdb42d6fbf851))
  * Added `ai_monitoring.enabled` configuration.([#1873](https://github.com/Cryptoking28/monisagent/pull/1873)) ([52bf9f3](https://github.com/Cryptoking28/monisagent/commit/52bf9f362884f481a6dcc955be4fb1267458def8))
  * Added `Nodejs/ML/OpenAI/<version>` metric every time a chat completion or embedding occurs.([#1886](https://github.com/Cryptoking28/monisagent/pull/1886)) ([d11d100](https://github.com/Cryptoking28/monisagent/commit/d11d100a37ad04201a9065363b1bc6b2d6fe36f2))
  * Added `setLlmMetadata` API to allow users to specify metadata for LLM events ([#1863](https://github.com/Cryptoking28/monisagent/pull/1863)) ([85979d7](https://github.com/Cryptoking28/monisagent/commit/85979d752ee4b47db5e50c48953dcf62ea23a9fa))
  * Ensure API errors are tracked ([#1880](https://github.com/Cryptoking28/monisagent/pull/1880)) ([289c2a2](https://github.com/Cryptoking28/monisagent/commit/289c2a295b157b18c5ccf7da2e68391e5fb3cba6))
  * Added `getLlmMessageIds` and `recordLlmFeedbackEvent` API methods for tracking LLM feedback ([#1868](https://github.com/Cryptoking28/monisagent/pull/1868)) ([1681e4b](https://github.com/Cryptoking28/monisagent/commit/1681e4bbaa60264a0638790424d3e5370b1ee7bf))
  * Added openai LLM events. ([#1857](https://github.com/Cryptoking28/monisagent/pull/1857)) ([a7786f3](https://github.com/Cryptoking28/monisagent/commit/a7786f3e033e33a7a1652cf55b7e3bece9b01378))
* Added pkgVersion to shim instances to facilitate semver checking without having to re-parse the package.json ([#1883](https://github.com/Cryptoking28/monisagent/pull/1883)) ([4ddfd81](https://github.com/Cryptoking28/monisagent/commit/4ddfd81a7c8c707d216c97a49a83ab96b20d59ba))

#### Bug fixes

* Updated isSimpleObject util to only check plain objects not arrays ([#1865](https://github.com/Cryptoking28/monisagent/pull/1865)) ([8baa5bc](https://github.com/Cryptoking28/monisagent/commit/8baa5bc7daa58d6db3c0c5d2687892fa189f54b5))

#### Security improvements

* Set log file permissions to read/write for Node process only ([#1854](https://github.com/Cryptoking28/monisagent/pull/1854)) ([1b93ec9](https://github.com/Cryptoking28/monisagent/commit/1b93ec942809505ae84aebba3b195b503a58f67d))

#### Code refactoring

* Improved custom event attributes checking when using api.recordCustomEvent ([#1870](https://github.com/Cryptoking28/monisagent/pull/1870)) ([20e7f1d](https://github.com/Cryptoking28/monisagent/commit/20e7f1ddf51c48f88339dcab496fe4fc49684bec))

#### Miscellaneous chores

* **dep:** Updated @monisagent/security-agent to v0.5.0 ([#1877](https://github.com/Cryptoking28/monisagent/pull/1877)) ([2882236](https://github.com/Cryptoking28/monisagent/commit/2882236b9f6d3a626bda0bbc0783ed829bdcdf9b))
* **dev-deps:** bump axios and @slack/bolt ([#1871](https://github.com/Cryptoking28/monisagent/pull/1871)) ([2d00b02](https://github.com/Cryptoking28/monisagent/commit/2d00b02c8f341a919c12ee62081cf77b4ccff30c))
* **docs:** Updated links in documentation to https ([#1888](https://github.com/Cryptoking28/monisagent/pull/1888)) ([f1913ea](https://github.com/Cryptoking28/monisagent/commit/f1913ea9aff12051167e11b2c3ca899a5e8324fc))
* Fixed bool -> boolean in jsdoc ([#1853](https://github.com/Cryptoking28/monisagent/pull/1853)) ([3c00e55](https://github.com/Cryptoking28/monisagent/commit/3c00e55291ef8a54e64339519700384c06cc5d71))

#### Tests

* Added streaming responses to mock OpenAI sever ([#1881](https://github.com/Cryptoking28/monisagent/pull/1881)) ([86d83f2](https://github.com/Cryptoking28/monisagent/commit/86d83f20028ec8a135241d4ad92032488ff5ad3a))
* Added unit tests for LLM API methods ([#1878](https://github.com/Cryptoking28/monisagent/pull/1878)) ([3d8b987](https://github.com/Cryptoking28/monisagent/commit/3d8b987408512e0643b4daed078a6fd7ebe363ca))
* Added a mock server for openai testing ([#1858](https://github.com/Cryptoking28/monisagent/pull/1858)) ([3b1f5e6](https://github.com/Cryptoking28/monisagent/commit/3b1f5e69950385a9f8482d33ebb783c8cf054e57))
* Fixed shadowed variable lint error in pino versioned tests ([#1859](https://github.com/Cryptoking28/monisagent/pull/1859)) ([e1b21eb](https://github.com/Cryptoking28/monisagent/commit/e1b21eb8ed87297b5e55ee2c86e33bc2594d8d8b))
* Updated openai versioned tests to properly work with the legacy context manager ([#1876](https://github.com/Cryptoking28/monisagent/pull/1876)) ([a879700](https://github.com/Cryptoking28/monisagent/commit/a87970019dab2fa2a393f2f10e8da2cf03338c87))

#### Continuous integration

* Made release note date always in pacific time ([#1855](https://github.com/Cryptoking28/monisagent/pull/1855)) ([6d7dc69](https://github.com/Cryptoking28/monisagent/commit/6d7dc69ccb71b2778da28598c50b65842ac4e3f7))
* Remove updating staging with newly release agent version ([#1887](https://github.com/Cryptoking28/monisagent/pull/1887)) ([9d38faa](https://github.com/Cryptoking28/monisagent/commit/9d38faa3de07d0dc194fddc7317908adfc51b627))

### v11.5.0 (2023-10-30)

#### Miscellaneous chores

* **dep:** Updated @monisagent/security-agent to v0.4.0 ([#1837](https://github.com/Cryptoking28/monisagent/pull/1837)) ([fb06ac9](https://github.com/Cryptoking28/monisagent/commit/fb06ac930269b784fcea6c2b8ea5e54158677ec4))

#### Continuous integration

* Disable fail-fast on nightly versioned test runs ([#1836](https://github.com/Cryptoking28/monisagent/pull/1836)) ([fe1b4fc](https://github.com/Cryptoking28/monisagent/commit/fe1b4fc4c00b2e4ea4c7b6fa5a8c1cd6e864145a))

### v11.4.0 (2023-10-25)

#### Features

* Added support for parsing container ids from docker versions using cgroups v2. ([#1830](https://github.com/Cryptoking28/monisagent/pull/1830)) ([9892901](https://github.com/Cryptoking28/monisagent/commit/98929013da3e62e2223f94531b8d6f59eecfc35b))

#### Miscellaneous chores

* [Snyk] Upgraded @grpc/grpc-js from 1.9.2 to 1.9.4. ([#1823](https://github.com/Cryptoking28/monisagent/pull/1823)) ([81f9450](https://github.com/Cryptoking28/monisagent/commit/81f945033376e4d33651d1e42afc30aea19dbdeb))
* **deps:** Updated aws-sdk, koa, superagent ([#1831](https://github.com/Cryptoking28/monisagent/pull/1831)) ([8b4e963](https://github.com/Cryptoking28/monisagent/commit/8b4e963e84d34e4727b9fda3aa630ef119aa3905))

#### Tests

* Increased timeout for integration tests to avoid random failures. ([#1827](https://github.com/Cryptoking28/monisagent/pull/1827)) ([5202048](https://github.com/Cryptoking28/monisagent/commit/52020485191868f479092ae4860019acf105b3eb))

### v11.3.0 (2023-10-23)

#### Features

* Updated agent initialization to allow running in worker threads when config.worker_threads.enabled is true ([#1817](https://github.com/Cryptoking28/monisagent/pull/1817)) ([a39f0ef](https://github.com/Cryptoking28/monisagent/commit/a39f0ef5ac670d03ab407b24e5aeccd8d5e8c680))

#### Bug fixes

* Updated Elasticsearch instrumentation to register on v7.13.0+ only ([#1816](https://github.com/Cryptoking28/monisagent/pull/1816)) ([6437671](https://github.com/Cryptoking28/monisagent/commit/6437671b921cd6bd73ed31180b0d62f62cc229a2))

#### Miscellaneous chores

* **dev-deps:** Bumped @babel/traverse ([#1818](https://github.com/Cryptoking28/monisagent/pull/1818)) ([d3c8d04](https://github.com/Cryptoking28/monisagent/commit/d3c8d04b74b7a84846609b744e3b4922136dbdd6))
* Updated release note headers to follow standard sentence caps ([#1806](https://github.com/Cryptoking28/monisagent/pull/1806)) ([91d3600](https://github.com/Cryptoking28/monisagent/commit/91d36009e0496af823cfbc3a4bdb2b32a97ba8c5))

#### Tests

* Updated the grpc versioned tests utils to dynamically bind ports to avoid conflicts between cjs and esm tests ([#1820](https://github.com/Cryptoking28/monisagent/pull/1820)) ([95ac917](https://github.com/Cryptoking28/monisagent/commit/95ac917da92575e178d8026bdc0badb08ba6fb83))

#### Continuous integration

* Disabled fail-fast on testing jobs to make sure all versions are run before getting canceled because of a flappy test ([#1819](https://github.com/Cryptoking28/monisagent/pull/1819)) ([0928ee3](https://github.com/Cryptoking28/monisagent/commit/0928ee3db82533e2386ad2bf4b87074b4f15f33b))
* Updated CI workflow to use larger runners on versioned tests but only when running against the main branch ([#1812](https://github.com/Cryptoking28/monisagent/pull/1812)) ([01eaa14](https://github.com/Cryptoking28/monisagent/commit/01eaa14c76a32966f6af8475e6ba6d4e00b03513))
* Updated post release script to update the nodejs_agent_version only on staging and us prod, eu will get it via replication now ([#1811](https://github.com/Cryptoking28/monisagent/pull/1811)) ([317a00a](https://github.com/Cryptoking28/monisagent/commit/317a00a9c160b52b053cb1f9f55292551c4c3428))
...
* Added instrumentation for ElasticSearch ([#1785](https://github.com/Cryptoking28/monisagent/pull/1785)) ([a748b84](https://github.com/Cryptoking28/monisagent/commit/a748b84c6a706ed0cea2e07c9fae8807a82dbc95))

#### Bug Fixes

* Updated agent to create a stub api when running in a worker thread to avoid Next.js early return errors ([#1800](https://github.com/Cryptoking28/monisagent/pull/1800)) ([636e8f0](https://github.com/Cryptoking28/monisagent/commit/636e8f068a2ec2f989e28f6646f844b951ee636d))
* Updated shimmer to allow registering instrumentation for different versions of the same module ([#1799](https://github.com/Cryptoking28/monisagent/pull/1799)) ([30f0b16](https://github.com/Cryptoking28/monisagent/commit/30f0b16e13e9621c86481c5d5409a799dbbb8d57))

#### Miscellaneous Chores

* **deps:** Updated @monisagent/security-agent to v0.3.0 ([#1786](https://github.com/Cryptoking28/monisagent/pull/1786)) ([9ca78ae](https://github.com/Cryptoking28/monisagent/commit/9ca78aede72ddecd3eb8271d349ad35cc4ce05f9))
* Separated running versioned tests between local and external ([#1792](https://github.com/Cryptoking28/monisagent/pull/1792)) ([6ffe2f6](https://github.com/Cryptoking28/monisagent/commit/6ffe2f6e16c769c3fb8de767e9336992b1cca797))
* **dev-deps** Updated get-func-name to fix CVE ([#1790](https://github.com/Cryptoking28/monisagent/pull/1790)) ([f378c77](https://github.com/Cryptoking28/monisagent/commit/f378c77eb09fcd3453850a1d177faea41422f637))

#### Tests

* Updated elasticsearch container to ignore highwatermark to function on a constrained environment ([#1803](https://github.com/Cryptoking28/monisagent/pull/1803)) ([8380e9d](https://github.com/Cryptoking28/monisagent/commit/8380e9d527f3ffc61d1f3e32199e81ed25837185))
* Updated invalid json pino test as this was fixed in 8.15.1 of the pino library. ([#1782](https://github.com/Cryptoking28/monisagent/pull/1782)) ([3e65fdc](https://github.com/Cryptoking28/monisagent/commit/3e65fdcc68999e09d9ef3c341ff7c1159b65ab37))

#### Continuous Integration

* Added steps to zip up container logs on versioned test failure ([#1804](https://github.com/Cryptoking28/monisagent/pull/1804)) ([0a54729](https://github.com/Cryptoking28/monisagent/commit/0a54729f1d8187bb50508659716ec55349e9ee31))

### v11.1.0 (2023-09-07)

#### Features

* Added instrumentation for fetch. ([#1776](https://github.com/Cryptoking28/monisagent/pull/1776)) ([980b4dc](https://github.com/Cryptoking28/monisagent/commit/980b4dc31d085cafc45961a157f76cb73768741a))
* Removed undici feature flag. This will now instrument undici by default. ([#1772](https://github.com/Cryptoking28/monisagent/pull/1772)) ([683b254](https://github.com/Cryptoking28/monisagent/commit/683b254c1c4686527a37e628f80eed9fcc03cb37))
* Updated undici instrumentation to create segment on request create instead of after connection and opening socket to more accurately record time it takes to make an undici request. ([#1770](https://github.com/Cryptoking28/monisagent/pull/1770)) ([3f494f8](https://github.com/Cryptoking28/monisagent/commit/3f494f8ad8dd1350fbe034e9c4a582a40228bc45))

#### Performance Improvements

* **Trace:** optimise getTotalTimeDurationInMillis function to push to an array instead of concat arrays. ([#1774](https://github.com/Cryptoking28/monisagent/pull/1774)) ([6ecde97](https://github.com/Cryptoking28/monisagent/commit/6ecde97a5efeef4d816b2e82ba762f2130914658))
    * Thanks @infinity-naveen for your contribution 🎉 

#### Miscellaneous Chores

* Updated Next.js plugin versioned tests to use main now that require-in-the-middle fixes have been merged. ([#1768](https://github.com/Cryptoking28/monisagent/pull/1768)) ([6a72d1f](https://github.com/Cryptoking28/monisagent/commit/6a72d1fb452ea2655c35d7cd008fa78935821ab8))
* Upgraded `@monisagent/test-utilities` and removed unused shimmer.patchModule and shimmer.unpatchModule ([#1769](https://github.com/Cryptoking28/monisagent/pull/1769)) ([96620ef](https://github.com/Cryptoking28/monisagent/commit/96620efa725f0f548b683825cb3cefff270fb252))
...
* Replaced ESM loader with import-in-the-middle to fix instrumentation firing for both CommonJS and ESM. 
    * You must load both the ESM loader and agent as follows: `node --experimental-loader monisagent/esm-loader.mjs -r monisagent path/to/app.js`.  
    * Removed `config.esm.custom_instrumentation_entrypoint` to register ESM instrumentation. You can now just call the `monisagent.instrument*` APIs but you must pass in an object and specify `isEsm: true`. [See example](https://github.com/Cryptoking28/monisagent-node-examples/blob/main/esm-app/custom-instrumentation/parse-json.js).
...
* Renamed `shim.handleCATHeaders` to `shim.handleMqTracingHeaders` ([#1735](https://github.com/Cryptoking28/monisagent/pull/1735)) ([6788f9e](https://github.com/Cryptoking28/monisagent/commit/6788f9e9b7ffb92e06b342553135871e5918fe87))
...
* Updated the default context manager to be AsyncLocalContextManager ([#1731](https://github.com/Cryptoking28/monisagent/pull/1731)) ([25f2bd8](https://github.com/Cryptoking28/monisagent/commit/25f2bd8f9502c0e96fbe45ff4f417e426d32eed8))
    ...
    * Please note this legacy context manager will be removed in future major releases. If you have any issues, please raise with Monis Agent support or on the [issues](https://github.com/Cryptoking28/monisagent/issues) of the agent.

#### Bug Fixes

* Replaced esm loader with import-in-the-middle to fix instrumentation firing for both commonjs and esm ([#1760](https://github.com/Cryptoking28/monisagent/pull/1760)) ([4452354](https://github.com/Cryptoking28/monisagent/commit/4452354a567438b3830ef454ed0299df5a12eab4)), closes [1646](https://github.com/Cryptoking28/monisagent/issues/1646)
    *  **Breaking Change**: Updated ESM loader that now requires to use both a loader and -r.    
        * `node --experimental-loader monisagent/esm-loader.mjs -r monisagent path/to/app.js`   
    * **Breaking Change**: Removed `config.esm.custom_instrumentation_entrypoint` to register ESM instrumentation.     
        * You can now just call the `monisagent.instrument*` APIs but you must pass in an object and specify `isEsm: true`.
* Updated prisma instrumentation to parse prisma datamodel with internal package ([#1765](https://github.com/Cryptoking28/monisagent/pull/1765)) ([48079b3](https://github.com/Cryptoking28/monisagent/commit/48079b30332ef44b175443478dbe572fc4031ce7))

#### Code Refactoring

* Updated agent to use require-in-the-middle to register CommonJS instrumentation ([#1758](https://github.com/Cryptoking28/monisagent/pull/1758)) ([d4b4f11](https://github.com/Cryptoking28/monisagent/commit/d4b4f1177267dfc2e9e9216afe90180964fff823))
...
* Remove support for Node 14 ([#1756](https://github.com/Cryptoking28/monisagent/pull/1756)) ([0ff9912](https://github.com/Cryptoking28/monisagent/commit/0ff9912cd581599f22e12bedf7625b974b9332b3))
* Updated the bundled packages to the latest `@monisagent/superagent`, `@monisagent/aws-sdk`, `@monisagent/koa`, `@monisagent/native-metrics`, and `@monisagent/test-utilities` ([#1766](https://github.com/Cryptoking28/monisagent/pull/1766)) ([8f6e15b](https://github.com/Cryptoking28/monisagent/commit/8f6e15b89054ee81bfe30a065f4e6c4cacd073b2))
* Updated the aws-sdk external branch to be main now that the code is in there ([#1761](https://github.com/Cryptoking28/monisagent/pull/1761)) ([d34d0fe](https://github.com/Cryptoking28/monisagent/commit/d34d0fe3c99dc2dbc40799dace5a2a6ebdc8e19f))

#### Tests

* update smoke tests versioned matrix in CI to 16, 18, and 20. ([#1762](https://github.com/Cryptoking28/monisagent/pull/1762)) ([c82b517](https://github.com/Cryptoking28/monisagent/commit/c82b517abbb34b7505ebeafbd9b5be837167ca33))

### v10.6.2 (2023-08-07)

#### Bug Fixes

* added defensive code around JSON.parse in formatting pino log lines because pino can return invalid json ([#1750](https://github.com/Cryptoking28/monisagent/pull/1750)) ([8f2e11a](https://github.com/Cryptoking28/monisagent/commit/8f2e11ab0d018d2a99b928cd3ec189a74ff8d6d6))

#### Miscellaneous Chores

* **deps:** Updated @monisagent/security-agent to v0.2.1 ([#1754](https://github.com/Cryptoking28/monisagent/pull/1754)) ([0d04f14](https://github.com/Cryptoking28/monisagent/commit/0d04f14f1383d903b4c30a787c4079b3dec01323))
* Fix smoke tests node 20 ([#1745](https://github.com/Cryptoking28/monisagent/pull/1745)) ([8c053e0](https://github.com/Cryptoking28/monisagent/commit/8c053e00e289f214105fc3919b206ac160e81a2d))
* fixed typos in lib/config/index.js comments ([#1749](https://github.com/Cryptoking28/monisagent/pull/1749)) ([9000a14](https://github.com/Cryptoking28/monisagent/commit/9000a14a48ba6c29ac6b7f0ffeb94eace9d4a37a))

#### Tests

* Added a full suite of unit tests for the collector/http-agents ([#1748](https://github.com/Cryptoking28/monisagent/pull/1748)) ([9d4201b](https://github.com/Cryptoking28/monisagent/commit/9d4201b9035dc629bd4f4a1c0ea72a6e14172356))

### v10.6.1 (2023-08-01)

#### Security Improvements

* updated ESM loader to track instrumentation by url in a map instead of in url to avoid remote code execution. ([#1741](https://github.com/Cryptoking28/monisagent/pull/1741)) ([c8dc779](https://github.com/Cryptoking28/monisagent/commit/c8dc779c7799b234290b6f7eb1d0a4e07d692ef9))

### v10.6.0 (2023-07-26)

#### Miscellaneous Chores

* **deps:** Updated @monisagent/security-agent to v0.2.0 ([#1737](https://github.com/Cryptoking28/monisagent/pull/1737)) ([9bf2a01](https://github.com/Cryptoking28/monisagent/commit/9bf2a011aed846a024d6445f557eb8eb7d2e5efe))
* restored engines to >=14 until we actually drop support for Node 14 ([#1738](https://github.com/Cryptoking28/monisagent/pull/1738)) ([8d66123](https://github.com/Cryptoking28/monisagent/commit/8d66123105d25a3f949f0f5c2db53ecb7e9f2df0))

#### Continuous Integration

* Add Node.js 20.x to CI and remove 14.x ([#1603](https://github.com/Cryptoking28/monisagent/pull/1603)) ([c4b008c](https://github.com/Cryptoking28/monisagent/commit/c4b008c98c758ba3e669768a840e40dd8fe3e681))
* update support statement ([#1733](https://github.com/Cryptoking28/monisagent/pull/1733)) ([3013da9](https://github.com/Cryptoking28/monisagent/commit/3013da977ed6dae70bef81b1f1cf0dbf4acbb37b))

### v10.5.0 (2023-07-20)

#### Features

* enabled code_level_metrics by default ([#1723](https://github.com/Cryptoking28/monisagent/pull/1723)) ([0b96de3](https://github.com/Cryptoking28/monisagent/commit/0b96de3fbf8db7be7d3673e29bab706d1d67de42))

#### Bug Fixes

* prevent ESM loader from loading instrumentation multiple times ([#1729](https://github.com/Cryptoking28/monisagent/pull/1729)) ([962d172](https://github.com/Cryptoking28/monisagent/commit/962d172aa5a9496041fe40e73ab8d183db94bae7))

#### Miscellaneous Chores

* **deps-dev:** bump word-wrap from 1.2.3 to 1.2.4 ([#1730](https://github.com/Cryptoking28/monisagent/pull/1730)) ([500a69e](https://github.com/Cryptoking28/monisagent/commit/500a69e6c9e94e4073805630e6d380f349d91689))

### v10.4.2 (2023-07-13)

#### Bug Fixes

* Dropped query params from `request.uri` attribute when obfuscating ([#1719](https://github.com/Cryptoking28/monisagent/pull/1719)) ([76112a6](https://github.com/Cryptoking28/monisagent/commit/76112a6143e503b21096d569cb81c82d83be4dfa))

#### Miscellaneous Chores

* Created story issue template ([#1694](https://github.com/Cryptoking28/monisagent/pull/1694)) ([20442c6](https://github.com/Cryptoking28/monisagent/commit/20442c6f65c4894aca9e0d9d9da9ade045aca90d))

#### Tests

* Pinned prisma to < 5 when running on node 14 ([#1717](https://github.com/Cryptoking28/monisagent/pull/1717)) ([b000d7b](https://github.com/Cryptoking28/monisagent/commit/b000d7b5915b5f6ca571d627ee31e6082ae66ed2))

### v10.4.1 (2023-07-10)

#### Security Improvements

* **deps:** bump protobufjs from 7.2.3 to 7.2.4 ([#1713](https://github.com/Cryptoking28/monisagent/pull/1713)) ([5fb4606](https://github.com/Cryptoking28/monisagent/commit/5fb4606f04f1317bbb5fa1807d149233bb0b84fd))

#### Miscellaneous Chores

* **test:** Converted adaptive-sampler.test.js to tap ([#1709](https://github.com/Cryptoking28/monisagent/pull/1709)) ([bb42249](https://github.com/Cryptoking28/monisagent/commit/bb4224926dd0576d57dd233596c12088de099183))
* **test:** converted environment.test.js to tap ([#1705](https://github.com/Cryptoking28/monisagent/pull/1705)) ([53b4376](https://github.com/Cryptoking28/monisagent/commit/53b4376863f88b9aaa5e778dcce71cba2fe0ee20))
* **test:** Replaced t.equals with t.equal ([#1711](https://github.com/Cryptoking28/monisagent/pull/1711)) ([a0b255e](https://github.com/Cryptoking28/monisagent/commit/a0b255e74ded6c9342a5411446a635b38df9f805))

### v10.4.0 (2023-06-30)

#### Miscellaneous Chores

* **test:** Converted 'errors/expected.test.js' to tap-style ([#1695](https://github.com/Cryptoking28/monisagent/pull/1695)) ([86025de](https://github.com/Cryptoking28/monisagent/commit/86025de673b2380561b29ff6a384babb85df7521))
* **test:** Converted server-config.test.js to tap-style ([#1702](https://github.com/Cryptoking28/monisagent/pull/1702)) ([2c6906d](https://github.com/Cryptoking28/monisagent/commit/2c6906de3b21068424acb42229d4ad5fdf6c547c))

#### Continuous Integration

* skip running test suite when merging releases ([#1704](https://github.com/Cryptoking28/monisagent/pull/1704)) ([f78b981](https://github.com/Cryptoking28/monisagent/commit/f78b98146839b8ff594a066764284ac83b9fdfde))

#### Build System

* updated `@monisagent/aws-sdk` to latest to get the instrumentation fixes for 3.363.0 ([#1707](https://github.com/Cryptoking28/monisagent/pull/1707)) ([a2cca08](https://github.com/Cryptoking28/monisagent/commit/a2cca08bdbdf509701e1d7f056b479e6947ce344))

### v10.3.2 (2023-06-26)

#### Bug Fixes

* **prisma:** check for query args in string property ([#1684](https://github.com/Cryptoking28/monisagent/pull/1684)) ([8d9b176](https://github.com/Cryptoking28/monisagent/commit/8d9b176e05424d34dd2eafe243a8cee7284efe64))

#### Security Improvements

* **deps:** Updated security agent to v0.1.3 ([#1696](https://github.com/Cryptoking28/monisagent/pull/1696)) ([0f957bd](https://github.com/Cryptoking28/monisagent/commit/0f957bd0e39a32614337b5ade33f07d9729f1897))

#### Miscellaneous Chores

* **test:** Added t.end() to trace unit test ([#1698](https://github.com/Cryptoking28/monisagent/pull/1698)) ([254c9c0](https://github.com/Cryptoking28/monisagent/commit/254c9c0e2aae73ed154a009d264aa262cb3799e3))
* **test:** convert error-trace-aggregator.test.js to tap-style ([#1690](https://github.com/Cryptoking28/monisagent/pull/1690)) ([44b17ab](https://github.com/Cryptoking28/monisagent/commit/44b17abf3c6295661736932e9c9dc5b5a42eb3e1))
* **test:** convert trace unit test to tap style ([#1692](https://github.com/Cryptoking28/monisagent/pull/1692)) ([727c17f](https://github.com/Cryptoking28/monisagent/commit/727c17f4163ff44b90be87f71e43ad6924874fe4))
* **test:** Fixed tap end/autoend calls in trace unit test ([#1700](https://github.com/Cryptoking28/monisagent/pull/1700)) ([b4a4948](https://github.com/Cryptoking28/monisagent/commit/b4a4948719af7c20c22b12150bb3070f6526c247))

### v10.3.1 (2023-06-22)

#### Security

* **deps:** Updated semver to v7.5.2, also in native-metrics and test utils ([#1685](https://github.com/Cryptoking28/monisagent/pull/1685)) ([e207a6b](https://github.com/Cryptoking28/monisagent/commit/e207a6b3a5cdd3d927f212f73d66e9aad52c5910))

#### Miscellaneous Chores

* Added test for getRedisParams ([#1670](https://github.com/Cryptoking28/monisagent/pull/1670)) ([e9f8556](https://github.com/Cryptoking28/monisagent/commit/e9f8556750a88314f0faeb993364fe2d67adc231))
* temporarily limit prisma tests to non-breaking version ([#1680](https://github.com/Cryptoking28/monisagent/pull/1680)) ([76d3ade](https://github.com/Cryptoking28/monisagent/commit/76d3adea11b077a506aeeb6af49391620b0fb1a5))
* **testing:** convert query-test-aggregator tests to tap style ([#1676](https://github.com/Cryptoking28/monisagent/pull/1676)) ([d2e45ad](https://github.com/Cryptoking28/monisagent/commit/d2e45ada751e9ae9cdca8b617834230d7d91f7b2))
* **testing:** Converted error-event-aggregator.test.js to tap ([#1683](https://github.com/Cryptoking28/monisagent/pull/1683)) ([9f1d66f](https://github.com/Cryptoking28/monisagent/commit/9f1d66f9df88512f353f01d16c1e6c93173dc88f))

### v10.3.0 (2023-06-13)

#### Features

* Added Interactive Application Security Testing(IAST) mode of security agent when `config.security.agent.enabled` is true. ([#1664](https://github.com/Cryptoking28/monisagent/pull/1664)) ([3e926e5](https://github.com/Cryptoking28/monisagent/commit/3e926e59ab5feba4b2759d8a108c424b237b5eda))
...
* Added supportability metrics to indicate how agent was loaded and if source maps were enabled ([#1657](https://github.com/Cryptoking28/monisagent/pull/1657)) ([6f6f7e6](https://github.com/Cryptoking28/monisagent/commit/6f6f7e68bf382c6082550306aee30a670652347d))
    * `Supportability/Features/CJS/Preload` - recorded if `-r monisagent` was used to load agent  
    * `Supportability/Features/CJS/Require` - recorded if `require('monisagent')` was used to load agent  
    * `Supportability/Features/EnableSourceMaps` - recorded if `node --enable-source-maps` was present to start application

* Added logging of `process.execArgs` at the debug level ([#1654](https://github.com/Cryptoking28/monisagent/pull/1654)) ([c85c006](https://github.com/Cryptoking28/monisagent/commit/c85c006e722fce1271795b2613e1dd2a96983046))

#### Miscellaneous Chores

* Updated c8 to merge v8 coverage reports asynchronously to avoid OOM issues ([#1652](https://github.com/Cryptoking28/monisagent/pull/1652)) ([34376d7](https://github.com/Cryptoking28/monisagent/commit/34376d7d51c0e0d34a5c94b53785d153341f06b8))
* Updated explorer hub link in readme ([#1656](https://github.com/Cryptoking28/monisagent/pull/1656)) ([c1e81a7](https://github.com/Cryptoking28/monisagent/commit/c1e81a7d04c113dc3659dad3c777d0ce2dd21162))

#### Tests

* Added unit tests for MySQL instrumentation ([#1649](https://github.com/Cryptoking28/monisagent/pull/1649)) ([b693ba0](https://github.com/Cryptoking28/monisagent/commit/b693ba039a42f9034f5206692e6d7a0523e23e51))

### v10.1.2 (2023-05-24)

#### Bug Fixes

* Updated mysql instrumentation to properly wrap the connection pool.getConnection and poolCluster.of ([#1647](https://github.com/Cryptoking28/monisagent/pull/1647)) ([4caf1db](https://github.com/Cryptoking28/monisagent/commit/4caf1db60b930c7b21307e381c13b5dd572e5cc3))
    * Added instrumentation to `PoolNamespace.prototype.query` 

#### Continuous Integration

* fix minor release note generation bugs ([#1643](https://github.com/Cryptoking28/monisagent/pull/1643)) ([dd6ab9a](https://github.com/Cryptoking28/monisagent/commit/dd6ab9addb8ee16de92ba9d6602f71c40527b940))

### v10.1.1 (2023-05-15)

#### Bug Fixes

* updated prisma instrumentation to properly parse database connection strings that work across all versions of prisma ([#1634](https://github.com/Cryptoking28/monisagent/pull/1634)) ([b2101fd](https://github.com/Cryptoking28/monisagent/commit/b2101fd606af43093b9caf525dbef9e122f6ca7e))

#### Code Refactoring

* **run-versioned-tests.sh:** added ability to run versioned tests and skip collecting coverage by passing in `SKIP_C8` env var to the job. ([#1621](https://github.com/Cryptoking28/monisagent/pull/1621)) ([0ba9dcb](https://github.com/Cryptoking28/monisagent/commit/0ba9dcb38654a8363732c558a0310df7bd032ab1))

#### Documentation

* update Contribution Guide with Conventional Commit info ([#1635](https://github.com/Cryptoking28/monisagent/pull/1635)) ([f1a00e5](https://github.com/Cryptoking28/monisagent/commit/f1a00e5cc4c907d046bc1f5205082761f620ecf1))

#### Miscellaneous Chores

* pin testdobule to 3.17.2 as 3.18.0 no longer works on node 14 ([#1628](https://github.com/Cryptoking28/monisagent/pull/1628)) ([d68bd9f](https://github.com/Cryptoking28/monisagent/commit/d68bd9fa3f6af974b5c978b61732491294b2e5cf))
* remove release-please workflow and scripts ([#1624](https://github.com/Cryptoking28/monisagent/pull/1624)) ([80f7eb8](https://github.com/Cryptoking28/monisagent/commit/80f7eb88a4f71e44b4413e3b39c5766046e9ec8a))

#### Tests

* pin prisma to 4.14.0 until we fix instrumentation ([#1631](https://github.com/Cryptoking28/monisagent/pull/1631)) ([a60659d](https://github.com/Cryptoking28/monisagent/commit/a60659d6929be559854d01c83028d5acfbcd3603))
* **scripts:** fix failing changelog unit test ([#1626](https://github.com/Cryptoking28/monisagent/pull/1626)) ([08f48b3](https://github.com/Cryptoking28/monisagent/commit/08f48b33ce1c402e4a8c42c9c02e5b22e6cbe02a))
* **config:** increase test coverage ([#1625](https://github.com/Cryptoking28/monisagent/pull/1625)) ([67f39d8](https://github.com/Cryptoking28/monisagent/commit/67f39d8dc89e627d27c7fd9a9cee1ac14ab816e3))
* **config:** revert changes to lib/config/index.js ([#1630](https://github.com/Cryptoking28/monisagent/pull/1630)) ([fea1068](https://github.com/Cryptoking28/monisagent/commit/fea1068281d9ce8ae966b47923aba6ecef894bc8))

#### Continuous Integration

* changed versioned tests script to use SKIP_C8 ([#1621](https://github.com/Cryptoking28/monisagent/pull/1621)) ([83e95e3](https://github.com/Cryptoking28/monisagent/commit/83e95e31365cd4d48c7ee1dbb789b58231841e41))
* add --use-new-release functionality ([#1633](https://github.com/Cryptoking28/monisagent/pull/1633)) ([d97b421](https://github.com/Cryptoking28/monisagent/commit/d97b421be5acda61f0212fd49a433e58811fc27c))
* add ability to generate release notes from conventional commits ([#1623](https://github.com/Cryptoking28/monisagent/pull/1623)) ([880a88b](https://github.com/Cryptoking28/monisagent/commit/880a88b6e816b8cd2694a16bfe74b37fc42231ab))
* **create-docs-pr:** Set username/email to machine user by default ([#1627](https://github.com/Cryptoking28/monisagent/pull/1627)) ([3870a1f](https://github.com/Cryptoking28/monisagent/commit/3870a1ff9979e6afde669c69c443d657f1f37af9))
* fix issue with missing type in the prep-release ([#1638](https://github.com/Cryptoking28/monisagent/pull/1638)) ([9a906e8](https://github.com/Cryptoking28/monisagent/commit/9a906e8e833753808ab779fdf4074aa7c90cd1fa))
* update prep-release to fetch entire history of caller repo ([#1641](https://github.com/Cryptoking28/monisagent/pull/1641)) ([428174a](https://github.com/Cryptoking28/monisagent/commit/428174afd6cca482382101316b4d03c2f96f9f95))
* update to conditionally add CLI flag to prep-release ([#1640](https://github.com/Cryptoking28/monisagent/pull/1640)) ([b167c93](https://github.com/Cryptoking28/monisagent/commit/b167c932659cbba073827a6936b65c0aeee98d8a))
...
* Exposed a method on [API](https://monisagent.github.io/node-monisagent/API.html#obfuscateSql) to obfuscate sql: `monisagent.obfuscateSql`.
...
```js
if (!monisagent.agent.collector.isConnected()) {
  await new Promise((resolve) => {
    monisagent.agent.on('connected', resolve)
  })
}
```
...
* Updated to latest version of `@monisagent/test-utilities`
...
* Laid foundation for supporting Code Level Metrics via [Codestream](https://docs.monisagent.com/docs/codestream/how-use-codestream/performance-monitoring/). Note that this integration is not fully finished and should not be used.
...
* Added `monisagent.noticeError()` example to our API docs.
...
* Increased the default limit of custom events from 1,000 events per minute to 3,000 events per minute. In the scenario that custom events were being limited, this change will allow more custom events to be sent to Monis Agent. There is also a new configurable maximum limit of 100,000 events per minute. To change the limits, see the documentation for [custom_insights_events](https://docs.monisagent.com/docs/apm/agents/nodejs-agent/installation-configuration/nodejs-agent-configuration#custom_events_max_samples_stored). To learn more about the change and how to determine if custom events are being dropped, see our Explorers Hub [post](https://discuss.monisagent.com/t/send-more-custom-events-with-the-latest-apm-agents/190497).
...
* Removed legacy agent async context propagation. The default behavior is now what was behind the `feature_flag.new_promise_tracking`. You can read more about the difference [here](https://docs.monisagent.com/docs/release-notes/agent-release-notes/nodejs-release-notes/node-agent-7-3-0#new-features). 
...
```js
monisagent.recordLogEvent({ message: 'hello world', level: 'info' })`
```
...
monisagent.recordLogEvent({ message: 'error example', level: 'error', error })
```
...
* Added ability to instrument ES Modules with the Monis Agent ESM Loader.
  * [Example ESM application](https://github.com/Cryptoking28/monisagent-node-examples/tree/main/esm-app)
...
* Added support for custom ESM instrumentation.
  ...
  * [Sample custom ESM instrumentation entrypoint](https://github.com/Cryptoking28/monisagent-node-examples/blob/main/esm-app/custom-instrumentation/index.js)
  * All the `monisagent.instrument*` methods will still work except `monisagent.instrumentLoadedModule`.  This is because it is geared toward CommonJS modules. 
...
* Enabled re-throwing ESM import errors of `monisagent.js` so that the user is informed to rename it to `monisagent.cjs`
...
* Added a special case to serialize BigInts when sending them to Monis Agent. BigInts can appear in log data that our customers may be trying to forward.
...
* **BREAKING**: Removed certificate bundle from agent. The configuration value `config.feature_flag.certificate_bundle` will no longer work.
    ...
    The agent no-longer includes the Monis Agent certificate bundle when using the 'certificates' configuration (commonly with proxies). If you find this breaking your current environment, we recommend getting a CA bundle such as the one from Mozilla.
...
* Bumped `@monisagent/test-utilities` to ^7.0.0.
...
* Advanced instrumentation API is now generally available.
  ...
  * `monisagent.instrumentWebframework()`/`WebFrameworkShim`: This method is
  ...
  documentation page: https://monisagent.github.io/node-monisagent/
...
* Rewrote instrumentation for Connect, Director, Express, Hapi, and Restify.
  ...
  https://monisagent.github.io/node-monisagent/.
...
* Monis Agent Insights support no longer requires a feature flag. If you are a
  ...
  [here](https://docs.monisagent.com/docs/insights/basic-attributes#transaction-defaults).

  You can read more about Insights [here](https://monisagent.com/insights).
