...
* Exposed a method on API to obfuscate sql `monisagent.obfuscateSql`.
...
--- NOTES NEEDS REVIEW ---
<h3>Snyk has created this PR to upgrade @monisagent/aws-sdk from 5.0.0 to 5.0.2.</h3>
...
--- NOTES NEEDS REVIEW ---
<h3>Snyk has created this PR to upgrade @monisagent/koa from 7.0.0 to 7.1.1.</h3>
