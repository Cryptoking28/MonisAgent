...
* Enabled log forwarding by default.
...
--- NOTES NEEDS REVIEW ---
* Added a support statement to our release notes (closes [NR-29755](https://issues.monisagent.com/browse/NR-29755))
--------------------------

--- NOTES NEEDS REVIEW ---
Just a small addition to the release notes of the upcoming PR
--------------------------
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/Cryptoking28/monisagent/network/alerts).
