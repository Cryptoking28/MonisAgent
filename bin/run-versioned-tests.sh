...
allDirectories=(
    ...
    `find node_modules/\@monisagent/koa/tests/versioned -maxdepth 1 -type d`
    `find node_modules/\@monisagent/superagent/tests/versioned -maxdepth 1 -type d`
)
...
do
    if [ "$d" != "test/versioned" ] && # cruft from find
       [ "$d" != "node_modules/@monisagent/superagent/tests/versioned/node_modules" ] && # cruft from find
