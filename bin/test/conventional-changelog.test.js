...
const exampleCommit = {
  ...
  revert: null,
  pr: {
    url: 'https://github.com/Cryptoking28/monisagent/pull/123',
    id: 123
  }
}
...
* **thing:** updated Thing to prevent modifications to inputs ([#123](https://github.com/Cryptoking28/monisagent/pull/123)), closes [1234](https://github.com/Cryptoking28/monisagent/issues/1234)
...
tap.test('Conventional Changelog Class', (testHarness) => {
  ...
  testHarness.test('getFormattedCommits - should get a list of commits', async (t) => {
    mockGetPrByCommit.resolves({
      html_url: 'https://github.com/Cryptoking28/monisagent/pull/123',
      number: 123
    })
    mockGitLog.push(
      [
  ...
  testHarness.test('addPullRequestMetadata - should add pr info if available', async (t) => {
    mockGetPrByCommit
      .onCall(0)
      .resolves({
        html_url: 'https://github.com/Cryptoking28/monisagent/pull/345',
        number: 345
      })
      .onCall(1)
      .resolves(null)
    ...
    t.same(commits[0].pr, {
      url: 'https://github.com/Cryptoking28/monisagent/pull/345',
      id: 345
    })
