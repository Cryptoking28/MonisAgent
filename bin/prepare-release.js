...
program.option(
  '--repo <repo>',
  'Repo to work against(Defaults to monisagent/node-monisagent)',
  'monisagent/node-monisagent'
)
program.option(
  '--changelog-json',
  'generate notes with a corresponding changelog.json(only for node-monisagent)'
)
