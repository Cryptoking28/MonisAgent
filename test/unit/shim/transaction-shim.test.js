  ...
  t.test('#insertCATRequestHeaders', function (t) {
    ...
    t.test('should not run if disabled', function (t) {
      helper.runInTransaction(agent, function () {
        ...
        t.notOk(headers['X-MonisAgent-Id'])
        t.notOk(headers['X-MonisAgent-Transaction'])
        t.end()
      })
    })
    ...
    t.test('should use X-Http-Style-Headers when useAlt is false - DT disabled', function (t) {
      ...
      helper.runInTransaction(agent, function () {
        ...
        t.notOk(headers.MonisAgentID)
        t.notOk(headers.MonisAgentTransaction)
        t.equal(headers['X-MonisAgent-Id'], 'RVpaRwNdQBJQ')
        t.match(headers['X-MonisAgent-Transaction'], /^[a-zA-Z0-9/-]{60,80}={0,2}$/)
        t.end()
      })
    })
    ...
    t.test(
      ...
      function (t) {
        ...
        helper.runInTransaction(agent, function () {
          ...
          t.notOk(headers['X-MonisAgent-Id'])
          t.notOk(headers['X-MonisAgent-Transaction'])
          t.equal(headers.MonisAgentID, 'RVpaRwNdQBJQ')
          t.match(headers.MonisAgentTransaction, /^[a-zA-Z0-9/-]{60,80}={0,2}$/)
          t.end()
        })
      }
    )
    ...
    t.test('should be an obfuscated value - DT disabled, id header', function (t) {
      ...
      helper.runInTransaction(agent, function () {
        ...
        t.match(headers['X-MonisAgent-Id'], /^[a-zA-Z0-9/-]+={0,2}$/)
        t.end()
      })
    })
  ...
  t.test('#insertCATReplyHeader', function (t) {
    ...
    t.test('should not run if disabled', function (t) {
      helper.runInTransaction(agent, function () {
        ...
        t.notOk(headers['X-MonisAgent-App-Data'])
        t.end()
      })
    })
    ...
    t.test('should use X-Http-Style-Headers when useAlt is false - DT disabled', function (t) {
      ...
      helper.runInTransaction(agent, function () {
        ...
        t.notOk(headers.MonisAgentAppData)
        t.match(headers['X-MonisAgent-App-Data'], /^[a-zA-Z0-9/-]{60,80}={0,2}$/)
        t.end()
      })
    })
    ...
    t.test('should use MessageQueueStyleHeaders when useAlt is true - DT disabled', function (t) {
      ...
      helper.runInTransaction(agent, function () {
        ...
        t.notOk(headers['X-MonisAgent-App-Data'])
        t.match(headers.MonisAgentAppData, /^[a-zA-Z0-9/-]{60,80}={0,2}$/)
        t.end()
      })
    })
