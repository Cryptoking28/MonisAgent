...
tap.test('config formatters', (t) => {
  ...
  tap.test('object', (t) => {
    ...
    t.test('should log error and return null if it cannot parse option as json', (t) => {
      ...
      t.equal(loggerMock.error.args[0][0], 'Monis Agent configurator could not deserialize object:')
  ...
  tap.test('objectList', (t) => {
    ...
    t.test('should log error and return null if it cannot parse option as json', (t) => {
      ...
      t.equal(
        ...
        'Monis Agent configurator could not deserialize object list:'
      )
      t.match(loggerMock.error.args[1][0], /SyntaxError: Unexpected token i in JSON at position/)
      t.end()
    })
  ...
  tap.test('regex', (t) => {
    ...
    t.test('should log error and return null if regex is invalid', (t) => {
      ...
      t.equal(loggerMock.error.args[0][0], `Monis Agent configurator could not validate regex: [a-z`)
