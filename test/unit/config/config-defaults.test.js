...
tap.test('with default properties', (t) => {
  ...
  t.test('should connect to the collector at collector.monisagent.com', (t) => {
    t.equal(configuration.host, 'collector.monisagent.com')
    t.end()
  })
  ...
  t.test('should have a log filepath of process.cwd + monisagent_agent.log', (t) => {
