...
var HOST = 'collector.monisagent.com'
var PORT = 443
var URL = 'https://' + HOST
var RUN_ID = 1337
  ...
  describe('_login', function() {
    ...
    describe('off the happy path', function() {
      ...
      describe('receiving InvalidLicenseKey after preconnect', function() {
        ...
        var response = {
          exception: {
            message: 'Invalid license key. Please contact support@monisagent.com.',
            error_type: 'MonisAgent::Agent::LicenseException'
          }
        }
        ...
        it('should have included an informative error message', function() {
          expect(captured.message)
            .equal('Invalid license key. Please contact support@monisagent.com.')
        })

        it('should have included the Monis Agent error class', function() {
          expect(captured.class).to.equal('MonisAgent::Agent::LicenseException')
        })
    ...
    describe('off the happy path', function() {
      var exception = {
        exception: {
          ...
          error_type: 'MonisAgent::Agent::ForceDisconnectException'
        }
      }
  ...
  describe('_runLifecycle', function() {
    ...
    it('should discard InternalLimitExceeded exceptions', function(done) {
      var exception = {
        exception: {
          ...
          error_type: 'MonisAgent::Agent::InternalLimitExceeded'
        }
      }
    ...
    it('should stop the agent on ForceDisconnectException', function(done) {
      ...
      function tested(error) {
        ...
        expect(error.class).equal('MonisAgent::Agent::ForceDisconnectException')
    ...
    it('should pass through maintenance notices', function(done) {
      var exception = {
        exception: {
          ...
          error_type: 'MonisAgent::Agent::MaintenanceError'
        }
      }
      ...
      function tested(error) {
        ...
        expect(error.class).equal('MonisAgent::Agent::MaintenanceError')
