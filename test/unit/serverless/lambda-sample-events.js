...
const cloudWatchLogsEvent = {
  awslogs: {
    data: 'l7KSN7tCOEJ4M3/qOI49vMHj+zCKdlFqLaU2ZHV2a4Ct/an0/ivdX8oYc1UVX860fQDQiMdxRQEAAA=='
  }
}
        ...
        mail: {
          ...
          headers: [
            ...
            },
            {
              name: 'Received',
              value:
                'from mailer.example.com (mailer.example.com [203.0.113.1]) by inbound-smtp.us-west-2.amazonaws.com with SMTP id o3vrnil0e2ic28trm7dfhrc2v0cnbeccl4nbp0g1 for johndoe@example.com; Wed, 07 Oct 2015 12:34:56 +0000 (UTC)'
            },
            {
              name: 'DKIM-Signature',
              value:
