...
describe('TraceContext', function () {
  ...
  describe('header creation', () => {
    ...
    it('should propogate existing list members when cannot accept monisagent list members', (done) => {
      // missing trust key means can't accept/match monisagent header
    ...
    it('should propogate existing when cannot accept or generate monisagent list member', (done) => {
      agent.config.trusted_account_key = null
