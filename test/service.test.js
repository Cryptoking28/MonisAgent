...
exports['test conn'] = function(beforeExit, assert) {
	var c = config.initialize(logger, { 'config': {'license_key': testLicense, 'host':'staging-collector.monisagent.com', 'port':80 }});
    var nr = service.createMonisAgentService(agent, c);
    var connected = false;
