...
test('should gracefully handle ESM imports', async (t) => {
  await t.test('when requiring monisagent.js in ESM app', async () => {
  ...
  await t.test('when requiring monisagent.mjs in ESM app', async () => {
  ...
  await t.test('when requiring monisagent.cjs in ESM app', async () => {
