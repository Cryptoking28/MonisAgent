...
| [sql_parsing.json](sql_parsing.json) | These tests show how an SQL string should be parsed for the operation and table name. *Java Note*: The Java Agent is [out-of-sync with these tests](https://source.datanerd.us/java-agent/java_agent/blob/master/monisagent-agent/src/main/java/com/monisagent/agent/database/DefaultDatabaseStatementParser.java), [has its own tests](https://source.datanerd.us/java-agent/java_agent/blob/master/monisagent-agent/src/test/java/com/monisagent/agent/database/DatabaseStatementResponseParserTest.java), and cannot implement these without a breaking change. |
