...
| `inputObfuscatedHeader` | An obfuscated form of the `X-MonisAgent-Synthetics` request header. If you obfuscate `syntheticsHeaderPayload` using the CAT obfuscation algorithm, this should be the output. |
