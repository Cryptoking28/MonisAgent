...
**NOTE:** If you've used previous versions of Monis Agent for Node.js, you should
...
Monis Agent for Node.js is currently in beta and has only limited support.
...
We're just as eager as you are to see Node and Monis Agent live happily ever
...
up](http://try.monisagent.com/nodejs) to be notified.
