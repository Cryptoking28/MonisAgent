 ...
 *
 * See documentation for monisagent.addCustomParameter for more information on
...
/**
 * Send errors to Monis Agent that you've already handled yourself. Should
 ...
 * @example
 * var monisagent = require('monisagent')
 * var transaction = monisagent.createBackgroundTransaction('myTransaction', function() {
 *   // do some work
 *   monisagent.endTransaction()
 * })
 *
