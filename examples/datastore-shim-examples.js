...
monisagent.instrument('cassandra-driver', function(shim, cassandra) {
...
monisagent.instrumentDatastore('cassandra-driver', function instrumenter(shim, cassandra) {
  var proto = cassandra.Client.prototype
...
monisagent.instrumentDatastore('redis', function instrumenter(shim, redis) {
...
monisagent.instrumentDatastore('mysql', function instrumenter(shim, mysql) {
