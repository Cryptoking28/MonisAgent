...
var BETA_MESSAGE =
  '!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n' +
  'This is a beta version of the Monis Agent agent and requires a valid beta\n' +
  ...
  '`beta_token` in your monisagent.js file or set the environment variable\n' +
...
logger.trace("Using Monis Agent for Node.js version %s.", agentVersion)
  ...
  try {
    ...
    if (!config.agent_enabled) {
      ...
      if (appNames.length < 1) {
        message = "Monis Agent requires that you name this application!\n" +
