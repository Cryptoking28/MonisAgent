...
function recordLambda(shim, handler) {
  ...
  function wrappedHandler() {
    ...
    // TODO: move global back into this module
    const awsAttributes = getAwsAgentAttributes(event, context)
    if (!shim.agent._coldStartRecorded) {
      awsAttributes['aws.lambda.coldStart'] = true
      shim.agent._coldStartRecorded = true
    }
