...
const VALID_CODES = new Map([
  ...
  ['NR-APM-003', 'Forced disconnect received from Monis Agent.'],
  ['NR-APM-004', 'HTTP error communicating with Monis Agent.'],
  ...
  ['NR-APM-009', 'Failed to connect to the Monis Agent data collector.'],
...
/**
 * HealthReporter implements the "super agent" (Monis Agent Control) health
...
class HealthReporter {
   ...
   * @param {object} params.agentConfig A standard `monisagent` configuration
