...
function Config(config) {
  ...
  this.transaction_events = {
    ...
    // This should be *greater* than max_samples_per_minute
    // or you're see odd behavior.
    // You probably want at least double the value,
    // but more is okay as long as you can handle the memory overhead.
 ...
 */
Config.prototype.onConnect = function onConnect(json) {
