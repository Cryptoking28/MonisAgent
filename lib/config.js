...
Config.prototype.onConnect = function (params) {
  if (params.apdex_t > 0 && params.apdex_t !== this.apdex_t) {
    this.apdex_t = params.apdex_t;
    this.emit('apdex_t', params.apdex_t);
  }

  if (params.data_report_period > 0 &&
      params.data_report_period !== this.data_report_period) {
    this.data_report_period = params.data_report_period;
    this.emit('data_report_period', params.data_report_period);
  }
