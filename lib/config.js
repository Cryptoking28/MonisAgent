...
function Config(config) {
  ...
  // undocumented, internal-only default values
  this.run_id = null;
...
Config.prototype.onConnect = function (params) {
  ...
  this._updateNestedIfChanged(params, this.transaction_tracer,
                              'transaction_tracer.enabled', 'enabled');
  this._updateNestedIfChanged(params, this.error_collector,
                              'error_collector.enabled', 'enabled');
 ...
 * @param {string} key  Value we're lookign to set.
 */
