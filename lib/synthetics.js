...
const NEWRELIC_SYNTHETICS_HEADER = 'x-monisagent-synthetics'
const NEWRELIC_SYNTHETICS_INFO_HEADER = 'x-monisagent-synthetics-info'

const KEYS = ['version', 'accountId', 'resourceId', 'jobId', 'monitorId']

/**
 * Decode the X-MonisAgent-Synthetics and X-MonisAgent-Synthetics-Info headers
...
/**
 * Take the X-MonisAgent-Synthetics-Info header and apply any appropriate data to the
 * transaction for later use. This is the gate keeper for attributes being
 * added onto the transaction object for synthetics info.
 *
 * @param {string} header - The raw X-MonisAgent-Synthetics-Info header
 * @param {string} encKey - Encoding key handed down from the server
 * @param {object} transaction - Where the synthetics data is attached to.
 */
...
/**
 * Parse out and verify the the pieces of the X-MonisAgent-Synthetics-Info header.
 *
 * @param {string} header - The raw X-MonisAgent-Synthetics-Info header
 * @param {string} encKey - Encoding key handed down from the server
...
/**
 * Helper method for assign the X-MonisAgent-Synthetics and X-MonisAgent-Synthetics-Info headers to outbound http requests
 *
 * @param {object} config agent config
 * @param {object} transaction The current transaction
...
/**
 * Helper method for assigning the X-MonisAgent-Synthetics and X-MonisAgent-Synthetics-Info headers to the response
 *
