...
defaultConfig.definition = () => ({
  ...
  /**
   * Collects configuration related to Monis Agent Agent Control, i.e. centralized
  ...
  agent_control: {
    ...
    health: {
       ...
       */
      delivery_location: {
        default: 'file:///monisagent/apm/health'
      },
  ...
  ai_monitoring: {
     ...
     * recorded spans (i.e. delivered to the Monis Agent collector). This is
     * enabled by default.
     */
    record_content: {
      enabled: {
