...
exports.config = () => ({
  ...
  diagnostics: {
    code_injector: {
      enabled: false,
      internal_file_pattern: /nodejs_agent\/(?:(?!test))|\/node_modules\/(?:@)?monisagent/
    }
  },
  ...
  distributed_tracing: {
    ...
    /**
     * Exludes Monis Agent format distributed tracing header (`monisagent`) on
     ...
     */
    exclude_monisagent_header: false
  },
  ...
  infinite_tracing: {
    /**
     *  The URI of the observer. Setting this enables infinite tracing.
     *
     * @env NEW_RELIC_INFINITE_TRACING_TRACE_OBSERVER
     */
    trace_observer: ''
  },
  ...
  mtb: { // TODO: proper-long-term naming
    endpoint:null,
    api_key:null,
  }
})
