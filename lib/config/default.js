...
exports.config = () => ({
  ...
  /**
   * Specifies whether the agent will be used to monitor an AWS Lambda function.
   *
   * @env NEW_RELIC_LAMBDA_MODE
   */
  lambda_mode: process.env.AWS_LAMBDA_FUNCTION_NAME != null
})
