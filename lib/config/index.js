...
Config.prototype.applyLasp = function applyLasp(agent, policies, callback) {
  ...
  if (!config.security_policies_token) {
    if (keys.length) {
      ...
      return callback(null, CollectorResponse.fatal(null))
    }
    return callback(null, CollectorResponse.success(null))
  }
  ...
  callback(null, CollectorResponse.success(finalPolicies))
}
