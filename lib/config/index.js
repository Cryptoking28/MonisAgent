...
/**
 * Verifies/cleans data specific to running DT in serverless_mode.
 */
Config.prototype._enforceServerlessDT = function _enforceServerlessDT() {
  const DT_KEYS = ['trusted_account_key', 'application_id', 'account_id']
  if (this.serverless_mode) {
...
Config.prototype._canonicalize = function _canonicalize() {
  ...
  this.serverless_mode = this.serverless_mode && this.feature_flag.serverless_mode
}
