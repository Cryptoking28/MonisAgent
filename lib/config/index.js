...
Config.prototype.publicSettings = function publicSettings() {
  ...
  for (var key in this) {
    if (this.hasOwnProperty(key)) {
      if (REDACT_BEFORE_SEND.has(key)) {
        settings[key] = '****'
      } else if (!REMOVE_BEFORE_SEND.has(key)) {
