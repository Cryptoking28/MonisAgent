...
function initialize(config) {
  ...
  if (!filepath) {
    logger.info(['Unable to find configuration file, deferring to environment variables.',
      getBaseConfigFileText()
    ].join('\n'))
...
/**
 * Gets base configuration file text
 */
function getBaseConfigFileText() {
  return [
