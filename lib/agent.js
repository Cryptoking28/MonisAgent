...
var util             = require('util')
  ...
  , CollectorAPI     = require('./collector/api.js')
  , ErrorTracer      = require('./error.js')
  , Metrics          = require('./metrics.js')
  , MetricNormalizer = require('./metrics/normalizer.js')
  , MetricMapper     = require('./metrics/mapper.js')
  , TraceAggregator  = require('./transaction/trace/aggregator.js')
...
Agent.prototype._addIntrinsicAttrsFromTransaction = function _addIntrinsicAttrsFromTransaction(transaction) {
  ...
  if (this.config.feature_flag.cat) {
    // TODO: cat-test
    // incoming app data with tripId
    // incoming app data without tripId
    // transaction with full name
    // transaction with partial name
    // referring path hash not included
    // referring path hash is a hash

    // referring path hash is 0
