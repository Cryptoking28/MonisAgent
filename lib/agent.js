...
function generateEventHarvestSupportMetrics(agent, harvestConfig) {
  ...
  if (analyticLimit) {
    ...
    analyticLimitMetric.incrementCallCount(analyticLimit)
  }
  ...
  if (customLimit) {
    ...
    customLimitMetric.incrementCallCount(customLimit)
  }
  ...
  if (errorLimit) {
    ...
    errorLimitMetric.incrementCallCount(errorLimit)
  }
  ...
  if (spanLimit) {
    ...
    spanLimitMetric.incrementCallCount(spanLimit)
  }
}
