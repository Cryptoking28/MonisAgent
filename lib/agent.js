...
Agent.prototype.forceHarvestAll = function forceHarvestAll(callback) {
  ...
  // TODO: There are 3 diff config flags
  // application_logging.enabled overrides the others
  // application_logging.forwarding.enabled - enables log forwarding
  // application_logging.metrics.enable toggles collecting metrics
  if (
