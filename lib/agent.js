...
Agent.prototype.start = function () {
  if (this.config.agent_enabled !== true) {
    return logger.warn("The Monis Agent Node.js agent is disabled by its configuration. Not starting!");
  }
...
Agent.prototype.submitErrorData = function () {
  ...
  this.metrics.getOrCreateMetric('Errors/allWeb').stats.incrementCallCount(this.errors.errorCount);
