...
class TraceContext {
   ...
   * @property {boolean} entryFound - Whether a Monis Agent tracestate string is found
   * @property {boolean} entryValid - Whether the Monis Agent tracestate string is valid
