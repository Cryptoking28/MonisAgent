...
Tracer.prototype.transactionProxy = function (handler) {
  ...
  var wrapped = function () {
    ...
    var returned = self.monitor(transaction, handler, this, arguments);
...
Tracer.prototype.segmentProxy = function (handler) {
  ...
  var wrapped = function () {
    ...
    if (!state) return self.monitor(null, handler, this, arguments);
    ...
    self.enter(state, describer);
    var returned = self.monitor(state.transaction.value, handler, this, arguments);
    self.exit(state, describer);
 ...
 */
Tracer.prototype.monitor = function (transaction, handler, context, args) {
  return this.agent.errors.monitor(transaction, handler, context, args);
};
