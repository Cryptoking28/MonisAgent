...
// Static variable holding list of uninstrumented modules for use in the future
var uninstrumented = []

// Log a helpful message about uninstrumented modules
//
// @param uninstrumented Array of uninstrumented modules
function logUninstrumented(uninstrumented) {
  if (uninstrumented.length > 0) {
    var message = 'The monisagent module must be the first module required.\n' +
                  'The following modules were required before monisagent and are not being instrumented:'
...
// Check for any instrumentable modules that have already been loaded. This does
