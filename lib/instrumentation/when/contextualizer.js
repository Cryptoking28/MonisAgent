 ...
 * @param {Transaction} transaction proper transaction to bind
 * @returns {void}
 */
 ...
 *
 * @returns {TraceSegment} segment by idx or parentIdx or the first one
 */
 ...
 *
 * @returns {Transaction} transaction from context
 */
 ...
 *
 * @param {TraceSegment} segment segment to assign to index
 * @returns {TraceSegment} same segment passed in
 */
