 ...
 * the Db class. All db methods are marked as opaque
 * in v4 because every command gets a connection from
 * pool and then sets a timeout to executed commands
 * in a queue. We want to obfuscate these segments
 *
 * @param {Object} params
 * @param {Shim} params.shim
 * @param {Db} params.Db
 * @param {Boolean} [params.opaque=false]
 */
