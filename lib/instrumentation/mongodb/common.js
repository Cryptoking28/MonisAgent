 ...
 * @param {string} methodName
 */
common.makeBulkDescFunc = function makeBulkDescFunc(shim, methodName) {
...
function getInstanceAttributeParameters(shim, obj) {
  if (obj.s && obj.s.topology) {
    ...
    const databaseName = obj.s.db && obj.s.db.databaseName || obj.s.namespace && obj.s.namespace.db || null
