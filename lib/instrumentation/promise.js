...
/* eslint sonarjs/cognitive-complexity: ["error", 101] -- TODO: https://issues.monisagent.com/browse/NEWRELIC-5252 */
...
Contextualizer.prototype.continue = function continueContext(prom) {
  ...
  return prom.then(
    ...
    function __NR_catchContext(err) {
      __NR_continueContext()
      throw err // Re-throwing promise rejection, this is not Monis Agent's error.
    }
  )
