...
//
// var monisagent = require('../..') // TODO: Change this to 'monisagent' when made external
//
...
//   // content: Buffer [ 97 ] }
//
//   shim.wrap(proto, 'consume', function wrapConsume(shim, consume) {
//     if (!shim.isFunction(consume)) {
//       return consume
//     }
//
//     return shim.record(function wrappedConsume(queue, consumer) {
//       var args = shim.argsToArray.apply(shim, arguments)
//       if (shim.isFunction(consumer)) {
//         args[1] = shim.bindSegment(
//           shim.recordMessageConsumer(consumer, makeRecordConsumer(queue))
//         )
//       }
//
//       return consume.apply(this, args)
//     }, function recordConsume() {
//       return {name: 'amqplib.Channel#consume', callback: shim.LAST}
//     })
//   })
// }
//
