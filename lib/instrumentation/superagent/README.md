...
This package is a dependency of the the [Node.js Agent](https://github.com/Cryptoking28/monisagent/blob/main/package.json#L191), and should not need to install it manually.
