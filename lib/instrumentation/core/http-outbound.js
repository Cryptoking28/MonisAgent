...
function handleResponse(segment, hostname, req, res) {
  ...
  segment.attributes.addAttribute(DESTINATIONS.SPAN_EVENT, 'http.statusCode', res.statusCode)
  segment.attributes.addAttribute(DESTINATIONS.SPAN_EVENT, 'http.statusText', res.statusMessage)
