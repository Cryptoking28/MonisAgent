  ...
  Object.defineProperty(context, '_matchedRoute', {
    ...
    set: (val) => {
      ...
      if (match) {
        ...
        //  - https://github.com/Cryptoking28/monisagent-koa/issues/32
        //  - https://github.com/Cryptoking28/monisagent-koa/issues/33
        if (currentSegment) {
...
function getLayerForTransactionName(context) {
  ...
  // See https://github.com/Cryptoking28/monisagent-koa/pull/29
  if (!context.matched) {
    return null
  }
