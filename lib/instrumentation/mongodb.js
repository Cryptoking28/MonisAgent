...
// https://discuss.monisagent.com/t/feature-idea-using-mongoose-cursors-memory-leaking-very-quickly/49270/14
//
...
function initialize(agent, mongodb, moduleName, shim) {
  ...
  function getInstanceAttributeParameters(obj) {
    if (obj.db && obj.db.serverConfig) {
      ...
      var databaseName = (
        obj.db.serverConfig.db || obj.db.serverConfig.dbInstance || {databaseName: null}
      ).databaseName
      return doCapture(obj.db.serverConfig, databaseName)
    }
