...
Logger.prototype.write = function write(level, args, extra) {
  ...
  if (this.reading) {
    ...
    // TODO: Remove this block once Node <6 is deprecated.
    const warning = new Error('Dropping log message, buffer would overflow.')
    warning.name = 'MonisAgentWarning'
    warning.code = 'NRWARN002'
