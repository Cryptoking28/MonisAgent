...
try {
  ...
  // shimmer.wrapMethod(Domain.prototype, 'Domain.prototype', 'enter', function (enter) {
  //   console.error('wrapping Domain.prototype.enter');
  //   return function () {
  //     console.trace('domain.enter');
  //     var returned = enter.apply(this, arguments);
  //     console.dir(domain._stack);
  //     return returned;
  //   };
  // });

  // shimmer.wrapMethod(Domain.prototype, 'Domain.prototype', 'exit', function (exit) {
  //   console.error('wrapping Domain.prototype.exit');
  //   return function () {
  //     console.trace('domain.exit');
  //     var returned = exit.apply(this, arguments);
  //     console.dir(domain._stack);
  //     return returned;
  //   };
  // });
...
var dominion = module.exports = {
  ...
  getState : function () {
    if (process.domain && process.domain[MARKER]) return process.domain[MARKER];
  },
   ...
   *
   * Monis Agent's contract with developers is to preserve existing semantics of
    ...
    if (domain && process._fatalException) {
      shimmer.wrapMethod(process, 'process', ['_fatalException'],
        ...
        return function wrapped(error) {
           ...
           */
          if (dominion.getState()) {
            agent.errors.add(dominion.getState().getTransaction(), error);
