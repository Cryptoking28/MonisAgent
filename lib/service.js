...
DataSender.prototype.send = function (method, uri, compress, params, timeoutInMillis) {
  ...
  var userAgent = util.format("MonisAgent-NodeAgent/%s (nodejs %s %s-%s)",
                              self.config.version,
...
function MonisAgentService(agent) {
  events.EventEmitter.call(this);
...
exports.createMonisAgentService = function (agent) {
  return new MonisAgentService(agent);
};
