...
function MonisAgentService(licenseKey, host, port) {
	if (!host) {
...
exports.createMonisAgentService = function(licenseKey, host, port) {
  return new MonisAgentService(licenseKey, host, port);
};
