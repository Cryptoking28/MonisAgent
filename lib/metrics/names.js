...
const POSTGRES = {
  PREFIX: 'Postgres',
  STATEMENT: `${DB.STATEMENT}/${this.POSTGRES.PREFIX}/`,
  OPERATION: `${DB.OPERATION}/${this.POSTGRES.PREFIX}/`,
  INSTANCE: `${DB.INSTANCE}/${this.POSTGRES.PREFIX}/`
}

const CASSANDRA = {
  PREFIX: 'Cassandra',
  OPERATION: `${DB.OPERATION}/${this.CASSANDRA.PREFIX}/`,
  STATEMENT: `${DB.STATEMENT}/${this.CASSANDRA.PREFIX}/`,
  INSTANCE: `${DB.INSTANCE}/${this.CASSANDRA.PREFIX}/`,
  ALL: DB.PREFIX + 'Cassandra/' + ALL
}

const EXPRESS = {
  PREFIX: 'Expressjs/',
  MIDDLEWARE: MIDDLEWARE.PREFIX + this.EXPRESS.PREFIX,
  ERROR_HANDLER: MIDDLEWARE.PREFIX + this.EXPRESS.PREFIX
}
...
const OTHER_TRANSACTION = {
  ...
  MESSAGE: `${this.OTHER_TRANSACTION.PREFIX}/Message`
}

const MESSAGE_TRANSACTION = {
  PREFIX: `${this.OTHER_TRANSACTION.PREFIX}/Message`,
  RESPONSE_TIME: `${this.OTHER_TRANSACTION.PREFIX}/Message`,
