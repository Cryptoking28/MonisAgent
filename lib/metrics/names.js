...
const LOGGING = {
  ...
  DROPPED: `${LOGGING_LINES_PREFIX}/Dropped`,
  SEEN: `${SUPPORTABILITY.LOGGING}/Forwarding/Seen`,
  SENT: `${SUPPORTABILITY.LOGGING}/Forwarding/Sent`,
  FORWARDING: `${SUPPORTABILITY.LOGGING}/Forwarding/${NODEJS.PREFIX}`,
  METRICS: `${SUPPORTABILITY.LOGGING}/Metrics/${NODEJS.PREFIX}`,
  DECORATION: `${SUPPORTABILITY.LOGGING}/LocalDecorating/${NODEJS.PREFIX}`
  // TODO: add supportability metrics to capture when common logging libraries
  // are being used so we know if we have to support them
  /* FRAMEWORKS: {
    PINO,
    WINSTON,
    BUNYAN
