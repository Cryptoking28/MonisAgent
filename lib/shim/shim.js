 ...
 *  })
 *  ```
 * @property {boolean|string|SegmentFunction} $segment
 ...
 *  Indicates whether the class being wrapped is es6. Our es5 wrapper depends on
 *  calling the constructor without `new`, so we have to differentiate.
 ...
 * attribute names, as parameters used to be blindly stored on router span attributes (see https://github.com/Cryptoking28/monisagent/issues/1574)
