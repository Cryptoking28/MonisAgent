...
/* eslint sonarjs/cognitive-complexity: ["error", 16] -- TODO: https://issues.monisagent.com/browse/NEWRELIC-5252 */
...
CollectorAPI.prototype.connect = function connect(callback) {
  ...
  function retry(error, response) {
    ...
    if (backoff.warn) {
      logger.warn('No connection has been established to Monis Agent after %d attempts.', attempts)
    }
