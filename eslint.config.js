...
const sharedConfig = require('@monisagent/eslint-config')
...
const monisagentConfigOverrides = {
  files: ['**/monisagent.js', '**/monisagent.mjs'],
  rules: {
    'header/header': 'off'
  }
}
...
module.exports = [
  ...
  sharedConfig.configs.baselineMonisAgentConfig,
  monisagentConfigOverrides,
  globalIgnores
]
