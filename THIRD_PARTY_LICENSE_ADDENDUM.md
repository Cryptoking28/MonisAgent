...
Developers Note:  The following license could not be autogenerated by the Monis Agent OSS cli tool and needs to be manually copied to the `THIRD_PARTY_NOTICES.md` after running the tool.
