...
tap.test('DynamoDB', (t) => {
  ...
  t.beforeEach(async () => {
    ...
    const monisagentLoc = utils.util.getMonisAgentLocation()
    const Shim = require(monisagentLoc + '/lib/shim/datastore-shim')
  ...
  // See: https://github.com/Cryptoking28/monisagent-aws-sdk/issues/160
