...
**Note**: You must have a Monis Agent account setup with license key.  Also you need to configure the [browser agent](https://docs.monisagent.com/docs/browser/browser-monitoring/installation/install-browser-monitoring-agent/).

The following command will start the example app and load the Monis Agent Next.js plugin.
