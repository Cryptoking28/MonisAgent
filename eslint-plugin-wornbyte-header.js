...
const headerTmpl = `
/*
 * Copyright {{year}} Monis Agent Corporation. All rights reserved.
 * SPDX-License-Identifier: Apache-2.0
 */
`.trim()
...
module.exports = {
  meta: {
    name: 'eslint-plugin-monisagent-header',
    version: '1.0.0'
  },
  rules: {
    header: rule
...
function hasHeader(src) {
  ...
  return headerLines[0] === '/*' &&
    / \* Copyright \d{4} Monis Agent Corporation\. All rights reserved\./.test(headerLines[1]) === true &&
