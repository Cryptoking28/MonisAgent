...
| `@aws-sdk/client-sns` | 3.0.0 | 3.629.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.0.0 | 3.629.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.629.0 | 8.7.1 |
