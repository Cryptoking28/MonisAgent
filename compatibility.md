...
| --- | --- | --- | --- |
| `@apollo/gateway` | 2.3.0 | 2.8.2 | `@monisagent/apollo-server-plugin@1.0.0` |
| `@apollo/server` | 4.0.0 | 4.10.4 | `@monisagent/apollo-server-plugin@2.1.0` |
| `@aws-sdk/client-bedrock-runtime` | 3.0.0 | 3.613.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.0.0 | 3.613.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.0.0 | 3.613.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.0.0 | 3.613.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.0.0 | 3.613.0 | 8.7.1 |
...
| `@langchain/core` | 0.1.17 | 0.2.15 | 11.13.0 |
| `@nestjs/cli` | 8.0.0 | 10.4.2 | 10.1.0 |
| `@prisma/client` | 5.0.0 | 5.16.2 | 11.0.0 |
| `@smithy/smithy-client` | 3.0.0 | 3.1.7 | 11.0.0 |
...
| `mysql2` | 2.0.0 | 3.10.2 | 1.32.0 |
| `next` | 13.0.0 | 14.2.4 | `@monisagent/next@0.7.0` |
| `openai` | 4.0.0 | 4.52.5 | 11.13.0 |
