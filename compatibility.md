...
| --- | --- | --- | --- |
| `@apollo/gateway` | 2.3.0 | 2.8.4 | `@monisagent/apollo-server-plugin@1.0.0` |
| `@apollo/server` | 4.0.0 | 4.11.0 | `@monisagent/apollo-server-plugin@2.1.0` |
| `@aws-sdk/client-bedrock-runtime` | 3.474.0 | 3.631.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.0.0 | 3.631.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.0.0 | 3.631.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.0.0 | 3.631.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.631.0 | 8.7.1 |
